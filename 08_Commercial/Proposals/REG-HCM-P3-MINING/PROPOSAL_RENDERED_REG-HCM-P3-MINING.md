...
<!-- Tender: REG-HCM-P3-MINING | Platform: Oracle HCM Cloud | Type: Implementation | Industry: Mining -->
<!-- Manifest: REG-HCM-P3-MINING-PSM-20260629-100759 -->
<!-- Rendered: 2026-06-30T07:23:43.155972+00:00 -->
<!-- Sections: M=41 O=1 -->
...
- 7. Oracle Partnership
- 8. B-BBEE Compliance Statement
- 9. Executive Summary
- 10. Understanding of Requirements
- 11. Proposed Solution Overview
- 12. Oracle Fusion HCM Capability
- 13. Oracle Fusion ERP Capability
- 14. Oracle OIC / Integration Capability
- 15. Scope of Work — Inclusions
- 16. Scope of Work — Exclusions
- 17. Deliverables
- 18. Dependencies
- 19. Implementation Methodology
- 20. Project Plan / Timeline
- 21. Project Governance
- 22. RAID Framework
- 23. Change Control Framework
- 24. Cutover / Go-Live Plan
- 25. Team Structure
- 26. Key Assumptions (Body Section)
- 27. Risk Register
- 28. Commercial Assumptions
- 29. Commercials / Pricing
- 30. Compliance Schedule
- 31. Company Registration
- 32. Tax Clearance
- 33. Directors' Resolution
- 34. B-BBEE Certificate
- 35. Public Liability Insurance
- 36. Oracle OPN Certificate
- 37. Client References
  - Appendix A — Complete Assumption Schedule
  - Appendix D — Certifications and Compliance
  - Appendix E — B-BBEE Certificate
...
<!-- GOVERNANCE -->
<!-- GOV: Never use old company profile; KB-approved content supersedes -->

### APPSolve Company Overview

APPSolve is a software technology support company that specialises in providing cutting-edge support techniques, resources, and models to deliver competitive offers that are difficult for competitors to match.

APPSolve was established in 2002 as an IT Technology Services and Support provider, focusing on consulting services, support, and development. Over more than 23 years, APPSolve has acquired some of the best IT Technology skills in South Africa. We operate from offices in Gauteng and the Western Cape.

APPSolve employs more than 50 Senior Consultants, each with 10 or more years' experience in the Enterprise Technology sphere. We have been especially valuable as a solution partner in the Public Sector, Telco, Agriculture, Financial Services, and Higher Education industries.

#### Our Approach

APPSolve's unique business model has a strong "trusted partner" focus, offering experienced business and IT resources to clients. This has been one of the main reasons for the company's continued growth. Our track record of satisfied customers and a team of motivated and highly skilled employees is our proud legacy.

One of APPSolve's core strengths is understanding our clients' expectations. We ensure that our clients receive the most value from their IT investment. Our proactive approach of making software function optimally has saved our clients a considerable amount of money, thus enabling growth. Our reputation is built on delivering on-time, within budget, and exceeding client expectations.

#### International Footprint

APPSolve has active and recent client engagements across the sub-Saharan African market, including Botswana, Zambia, Mozambique, Namibia, and Tanzania. APPSolve has also delivered projects in the USA, France, Abu Dhabi, and Pakistan.

#### Industries Served

APPSolve has delivered professional services across a broad range of industries:
...
### APPSolve Company History

APPSolve was established in 2002 as an IT Technology Services and Support provider, focusing on consulting services, support, and development.

The company was founded by Hein Blignaut, who developed APPSolve from an Oracle Applications DBA-focused company into an end-to-end technology services provider.

Over more than 23 years, APPSolve has acquired some of the best IT Technology skills in South Africa, growing to employ more than 50 Senior Consultants, each with 10 or more years' experience in the Enterprise Technology sphere.

#### Geographic Expansion

APPSolve initially operated from offices in Gauteng and the Western Cape. Over subsequent years, the company extended operations into the sub-Saharan African market, with active and recent client engagements in Botswana, Zambia, Mozambique, Namibia, and Tanzania. APPSolve has also delivered projects in the USA, France, Abu Dhabi, and Pakistan.

#### Awards and Recognition

APPSolve has been recognised by Oracle for innovation and partnership excellence:

- **Oracle Innovation Sustainability Award** — 2015 and 2016 (global award, for applications developed in Mozambique)
- **Oracle SaaS Partner of the Year (SADC Region)** — 2016
- **Oracle SaaS Partner of the Year (SADC Region) — New Entrant** — 2019
- **Oracle Business Impact Award — EMEA** — 2024
- **Oracle Business Impact Award — ECEMEA Region** — 2024

#### Oracle Partnership

APPSolve has been an Oracle Partner for over two decades. The company holds Oracle Level 1 Partner status with published expertise in:
...
- An authorised Oracle Value-Added Reseller — licensed to sell and distribute Oracle products
- A certified Oracle Cloud Excellence Implementer
- Specialised on Oracle Enterprise Linux

APPSolve's Oracle Level 1 Partner status entitles the company to sell and distribute Oracle licenses, provide clients with access to real-time global Oracle support, and implement solutions sustained by Oracle's global knowledge base.

## 3. Awards and Recognition

### APPSolve Awards and Recognition

APPSolve has been recognised by Oracle and the broader technology industry for innovation and service excellence.

#### Approved Awards Content

The following Oracle awards are confirmed and approved for unrestricted use in tender responses.

| Award | Year | Notes |
|---|---|---|
| Oracle Innovation Sustainability Award | 2015 | Global award — for applications developed in Mozambique |
| Oracle Innovation Sustainability Award | 2016 | Global award — repeat winner |
| Oracle SaaS Partner of the Year (SADC Region) | 2016 | Regional award |
| Oracle SaaS Partner of the Year — New Entrant (SADC Region) | 2019 | Regional award |
| Oracle Business Impact Award | 2024 | EMEA Region |
| Oracle Business Impact Award | 2024 | ECEMEA Region |

#### Success Story References — Pending URL Verification

The following published success stories have been referenced in tender submissions. The award table above is approved for unrestricted use. Verify each item's URL and reference permission before citing it in a live tender response.

- **Tiger Brands** — Host-to-Host banking optimisation *(Pending URL Verification)*
- **USAID Southern Africa** — Oracle implementation *(Pending URL Verification)*
- **UT Grain** — Oracle Database *(Pending URL Verification)*

*Verification checklist: confirm URL is still active; confirm permission to reference the client in 2026 tender responses is current; confirm UT Grain is still operating under that name.*

> **Human Review Required:** Verify award table is current before submission

## 4. Delivery Model


<!-- GOVERNANCE -->
<!-- GOV: Headcount: 'more than 50 Senior Consultants' ONLY -->

### APPSolve Delivery Model

APPSolve delivers technology services through several complementary service lines and a distinctive delivery philosophy.

#### Products and Services

APPSolve supplies, implements, and supports the following products and services:

**Professional Advisory Services**
APPSolve has several experienced business consultants. We offer Project Management, System Financial Management, and Business Process Improvement Services across all industries and system implementations.

**Projects**
APPSolve scopes, architects, designs, configures, implements, and optimises a broad and integrated range of products within the Oracle enterprise application software stack, including Java Enterprise Edition.

**Customer Development**
APPSolve has built a number of custom applications recognised both locally and internationally. Areas of business requiring more specialised functionality than standard ERP systems can offer include Host-to-Host banking, stock and warehouse receipt systems, fuel management, and agricultural management systems.

**Managed Services**
APPSolve offers long-term support through a specialised managed services model. APPSolve supports and manages applications and technology on behalf of clients — both on-site and remotely — with niche skills in functional, technical, and DBA support.

**Business Development**
APPSolve is an authorised value-added reseller of Oracle products and services. APPSolve's Oracle Level 1 Partner status entitles APPSolve to sell and distribute Oracle licenses and provide clients with access to real-time global Oracle support, sustained by Oracle's global knowledge base.

**Oracle Functional Services**
APPSolve's experienced Oracle Applications Functional Consultants design overall solutions and business processes, and configure Oracle Applications modules. Areas of expertise include Finance, Projects, HRMS, Payroll, and Supply Chain.

**Technical Services (Oracle and Custom)**
APPSolve's Applications Technical Developers have skills including XML Publisher, OBIEE, ADF, OAF, SOA, Workflow, BPEL, and BPM. The team develops end-to-end custom processes to complement ERP systems. APPSolve has over 23 years of system integration expertise.

**Oracle Applications DBA Services**
APPSolve maintains one of the largest locally based Oracle Applications DBA teams in South Africa. Services include:
- Database monitoring and uptime management
- Trace file and datapump export monitoring
- Datafile backup monitoring
- Performance monitoring and tuning
- Tablespace management and change management
- Linux OS and Oracle Virtual Machine support

**System Administration, Virtualisation, and Engineered Systems**
APPSolve provides specialist services in virtualisation, operating system, and Oracle Engineered System space — including Oracle Database Appliances, Oracle Enterprise Linux, and Oracle Virtual Machines.

#### How APPSolve Delivers

APPSolve's delivery philosophy rests on three principles:

1. **Senior resources only** — all consultants have 10+ years' experience; no junior resources placed on client environments
2. **Flexible billing** — Time and Materials, Fixed Price, or APPSolve's unique Monthly Recurring Invoice Model
3. **Trusted partner approach** — APPSolve works alongside clients rather than as a transactional supplier

##### Monthly Recurring Invoice Model

APPSolve's Monthly Recurring Invoice Model provides a flexible and predictable costing method. The service is measured on time spent but monthly costs remain stable. This model ensures it is in the best interest of both parties to continuously work towards a stable and optimised environment.

## 5. Geographic Presence

### APPSolve Geographic Presence

APPSolve operates from offices in Gauteng and the Western Cape (South Africa).

#### Sub-Saharan Africa — Active and Recent Engagements

APPSolve has active and recent client engagements across the following sub-Saharan African markets:

- **Botswana** — multiple active clients across public sector, financial services, and higher education
- **Zambia** — active client engagements including financial services and utilities sectors
- **Mozambique** — project delivery and Oracle award-recognised application development
- **Namibia** — active client engagements including telecommunications and public sector
- **Tanzania** — active client engagements including banking and revenue authority

#### International Markets — Project Delivery

APPSolve has delivered projects in the following international markets:

- **USA** — technology sector consulting engagements
- **France** — professional services consulting under master agreement
- **Abu Dhabi (UAE)** — technology consulting engagements
- **Pakistan** — financial services sector project delivery

#### Industries by Geography

APPSolve's customer base is spread across multiple industries with an international footprint:

| Industry | Notes |
|---|---|
| Public Sector | Strong presence in South Africa and sub-Saharan Africa |
| Telecommunications | Including Tier 1 telecommunications operators |
| Agriculture | Sub-Saharan markets |
| Financial Services | South Africa and international |
| Higher Education | South Africa |
| Manufacturing | South Africa and sub-Saharan Africa |

## 6. Key Differentiators


<!-- GOVERNANCE -->
<!-- GOV: Included when W1S1-009 mandatory (always in corporate block) -->

### APPSolve Key Differentiators

#### Why Work with APPSolve?

APPSolve's delivery model is built around seven core differentiators:

##### 1. Least Risk Option

APPSolve offers the least risk with regards to technology service requirements because:

- Deep experience deploying from both an application and industry perspective
- Proposed teams consist of experienced resources with cross-domain expertise
- Familiarity with enterprise Oracle and Acumatica environments and their unique intricacies

##### 2. Technical Expertise and Track Record

APPSolve has a team of leaders in ERP Systems and Integration. Our track record demonstrates successful management of complex sites and large environments — technically, functionally, and relationally. Our subject matter experts ensure practical solutions deployed without lengthy discovery periods.

##### 3. Service Delivery Management Team

APPSolve's experienced Service Delivery Managers handle the environment, resources, projects, and client relationships as a team. This team approach ensures no interruptions to service delivery. The team is always available.

##### 4. On-site Expertise Support

APPSolve's on-site team is backed by a pool of over 50 senior resources with more than 10 years' experience each. These resources are available should the need arise, providing depth beyond the primary team.

##### 5. Continuous Improvement Model

APPSolve continuously innovates and strives to use the latest technology to scale environments, drive consolidation, and automate. The Continuous Improvement Model consists of four stages — **Analyse, Plan, Implement, Measure** — applied across three pillars: **People, Processes, and Technology**.

This model ensures that operational effort decreases over time, freeing capacity for strategic value delivery.

##### 6. Hybrid Support Model

APPSolve's Hybrid Support Model is distinctive in the Southern African market. It provides a cost-effective way to manage a site through a blended model of on-site and remote support personnel.

Key benefits:
- More affordable rates through rate-blending
- Easier risk management
- Flexibility around resource and time management
- Remote Support Centre providing 24x7 monitoring capability with after-hours support services
- Same level of service at reduced cost

##### 7. Flexible and Predictable Costing

APPSolve offers three costing models:

| Model | Description |
|---|---|
| Time and Materials | Standard billing by time |
| Fixed Price | Agreed scope at fixed cost |
| Monthly Recurring Invoice | APPSolve's unique model — predictable monthly cost, flexible capacity |

The **Monthly Recurring Invoice Model** is APPSolve's most distinctive offering: a fixed monthly cost that provides flexibility to transfer capacity between months. Both parties are incentivised to maintain a stable, optimised environment.

## 7. Oracle Partnership


<!-- GOVERNANCE -->
<!-- GOV: Never cite 'Oracle Gold Partner' — expired August 2021. Level 1 Partner only. -->

### APPSolve Oracle Partnership

APPSolve has been an Oracle Partner for over two decades. Our reputation and good standing in the Oracle community can be leveraged to ensure that your company receives the best possible support to address any issues.

#### Partner Credentials

APPSolve holds **Oracle Level 1 Partner** status under Oracle's current partner model, with the following published expertise:
...
- **Oracle Value-Added Reseller** — authorised to sell and distribute Oracle licenses
- **Oracle Cloud Excellence Implementer** — certified
- **Oracle Enterprise Linux Specialist** — specialised competency

APPSolve's Oracle Level 1 Partner status entitles us to:

- Sell and distribute Oracle licenses
- Provide clients with access to real-time global Oracle support
- Implement solutions sustained by Oracle's global knowledge base
- Leverage Oracle's best practices to provide cost-effective solutions and service excellence
...
APPSolve is backed by Oracle, meaning our clients benefit from:

- Direct access to Oracle's global support network
- Real-time issue escalation to Oracle
- Oracle-certified and experienced consultants
- Alignment with Oracle's roadmap and best practices

> **Human Review Required:** Verify OPN Level 1 revalidation; never cite Oracle Gold Partner

## 8. B-BBEE Compliance Statement


<!-- GOVERNANCE -->
<!-- GOV: B-BBEE cert expires 2026-07-31 (OAR-C01/C02/A01); flag if submission after that date -->

<!-- PLACEHOLDER: B-BBEE Compliance Statement — no governed source asset declared -->

> **Action Required:** Verify B-BBEE cert expiry date; never cite status after 2026-07-31 without renewal

## 9. Executive Summary


<!-- GOVERNANCE -->
<!-- GOV: Never use Candidate_Content/ or Review_Required/ in any tender -->

<!-- AI-DRAFT REQUIRED: Executive Summary -->
<!-- Instruction: Mandatory human review; tailor to tender-specific win themes -->

> **AI-Draft Required:** This section requires AI-assisted drafting with mandatory human review.
>
> *Mandatory human review; tailor to tender-specific win themes*

_[AI-generated content to be inserted here — must be reviewed and approved before submission]_

## 10. Understanding of Requirements

<!-- AI-DRAFT REQUIRED: Understanding of Requirements -->
<!-- Instruction: Mandatory human review; drawn from tender RFP/RFQ document -->

> **AI-Draft Required:** This section requires AI-assisted drafting with mandatory human review.
>
> *Mandatory human review; drawn from tender RFP/RFQ document*

_[AI-generated content to be inserted here — must be reviewed and approved before submission]_

## 11. Proposed Solution Overview

<!-- PLACEHOLDER: Proposed Solution Overview — MERGE with no source assets -->

> **Action Required:** Review merged content for coherence across modules

## 12. Oracle Fusion HCM Capability


<!-- GOVERNANCE -->
<!-- GOV: Section 14.2 (W3S1-008) and Section 13.2 (W3S1-009 payroll section) NEVER in external submissions -->
...
**Capability Statement | APPSolve | Oracle Business Unit**
*Document ID: W3S1-002-ORA-TalentMgmt | Version: 1.2 Approved | Wave 3*

---

#### Section 1 — APPSolve Oracle HCM Practice — Talent Management

APPSolve is an **Oracle Level 1 Partner** with a published Oracle Fusion Cloud HCM Core expertise certification on the Oracle Partner Network (OPN). With over 23 years of Oracle consulting experience, APPSolve's Oracle HCM practice includes deep capability across the Oracle Fusion Talent Management suite — encompassing Talent Profiles, Goal Management, Performance Management, Talent Review, Career Development, and Succession Planning.

**APPSolve has experience implementing Oracle Fusion Talent Management capabilities including Talent Profiles, Goal Management, Performance Management, Career Development, and Succession Planning.** This experience is underpinned by confirmed live implementations for enterprise clients, delivered using Oracle's OUM methodology and Oracle Integration Cloud (OIC) as the standard integration layer.

Oracle Fusion Talent Management is implemented in the second phase of every APPSolve Oracle HCM engagement — after Oracle HCM Core (Global HR) has been established and stabilised. The HCM Core foundation (organisational structures, worker records, job profiles) is a mandatory prerequisite: Talent Management builds directly on it. APPSolve sequences the implementation this way to ensure that talent processes operate on an accurate, complete, and correctly structured people data foundation.

**Key practice credentials for this capability:**

| Credential | Detail |
|---|---|
| Oracle partner tier | Oracle Level 1 Partner |
| Published OPN expertise | Oracle Fusion Cloud HCM Core (certified — includes Talent Management) |
| Integration expertise | Oracle Integration (OIC) — published OPN expertise area |
| Company experience | Over 23 years of Oracle consulting |
| Talent Management reference | Hollywood Bets — Talent Management, Performance Management, Goal Management, Career Development, and Succession Planning — live July 2025 |
| Prerequisite statement | See W3S1-001 Oracle HCM Core — Global HR |

---

#### Section 2 — Oracle Fusion Talent Management Suite Overview

##### 2.1 Suite Positioning

Oracle Fusion Talent Management is a suite of integrated modules within Oracle Fusion Human Capital Management, designed to enable organisations to identify, develop, measure, and retain talent systematically. APPSolve implements the Talent Management suite as a cohesive capability — not as isolated modules — ensuring that talent data, performance outcomes, succession decisions, and development plans are connected and mutually reinforcing.

The modules within the Oracle Fusion Talent Management suite that APPSolve implements include:

| Module | Core purpose |
|---|---|
| **Talent Profiles** | Defines the skills, competencies, qualifications, and experience expected for each role and recorded for each worker |
| **Goal Management** | Enables corporate-to-individual goal cascading, SMART goal setting, and ongoing progress tracking |
| **Performance Management** | Structures performance review cycles — mid-year, year-end, and ongoing feedback |
| **Talent Review** | Provides manager and HR visibility of talent population across performance and potential dimensions |
| **Career Development** | Supports employee career planning, development objectives, and internal mobility |
| **Succession Planning** | Identifies successors for key roles and tracks readiness and development of the succession pipeline |

##### 2.2 Platform Foundation

The Oracle Fusion Talent Management suite operates on the same cloud-native SaaS infrastructure as Oracle HCM Core — receiving automatic quarterly feature releases, benefiting from Oracle's ongoing AI and platform investment, and operating within the same security, privacy, and audit framework. APPSolve manages talent module configuration and quarterly release assessment alongside the client's broader Oracle HCM estate.

##### 2.3 AI-Assisted Talent Capabilities

Oracle Fusion Talent Management incorporates AI-assisted features that APPSolve activates and configures as part of the talent module implementation:

- **AI skill recommendations** — Oracle's embedded AI analyses worker profiles, learning completions, and career goals to suggest relevant skill development priorities
- **Talent search and matching** — AI-powered search surfaces workers whose profiles most closely match a target role or opportunity
- **Performance calibration support** — AI-assisted tools flag potential rating bias patterns during calibration sessions, supporting more objective talent assessments

*Note: AI feature availability and specific capability is subject to Oracle's quarterly release schedule and the client's Oracle SaaS subscription tier. APPSolve advises clients on feature activation timing as part of release management services. All AI capabilities referenced here are Oracle Fusion HCM platform capabilities; they do not represent APPSolve-developed AI functionality.*

##### 2.4 HCM Core Dependency

All Oracle Fusion Talent Management modules depend on Oracle HCM Core being implemented first. The organisational model, job profiles, position hierarchy, and worker records created in the HCM Core phase are the foundation that Talent Management reads, extends, and enriches. APPSolve does not implement Talent Management as a standalone capability — it is always sequenced after, and dependent on, a stable and validated HCM Core environment.

*See W3S1-001 Oracle HCM Core — Global HR and Employee Lifecycle for the foundational capability statement.*

---

#### Section 3 — Talent Profiles and Job Profiles

##### 3.1 The Talent Profile Foundation

Talent profiles are the architectural foundation of the Oracle Fusion Talent Management suite. Every talent process — performance reviews, goal setting, succession planning, career development — references and contributes to the talent profile. APPSolve treats talent profile design as the most consequential configuration decision in a Talent Management engagement: a well-designed profile structure enables all subsequent talent processes to function accurately; a poorly designed one creates rework that propagates across every module.

APPSolve's approach: talent profile design is completed, workshopped, and signed off before any other talent module configuration begins.

##### 3.2 Person Profiles

APPSolve configures Oracle Fusion HCM person profiles to capture the skills, competencies, qualifications, certifications, experience, and accomplishments of each worker:

| Profile element | Description |
|---|---|
| Skills and competencies | Worker-declared and manager-validated skill and competency ratings against the client's competency framework |
| Qualifications and education | Degrees, diplomas, professional qualifications, and academic achievements |
| Certifications and licences | Professional registrations, trade certificates, safety certifications — with expiry tracking |
| Work experience | Internal and external experience history; key roles and responsibilities |
| Languages | Language proficiency ratings |
| Accomplishments | Awards, recognition, publications, project achievements |
| Risk and impact | Risk-of-loss and impact-of-loss indicators populated from talent review assessments |

Worker self-service enables employees to maintain and update their own profile data, with manager and HR visibility and validation controls. Profile completeness dashboards allow HR to track adoption and identify workers with incomplete talent records.

##### 3.3 Job Profiles

APPSolve configures job profiles to define the required skills, competencies, qualifications, and experience for each role in the organisation. Job profiles serve as the benchmark against which worker profiles are compared — enabling skill gap analysis, internal talent matching, recruiting requirement definition, and succession eligibility assessment.

**Job profile components APPSolve configures:**

| Component | Purpose |
|---|---|
| Required competencies and proficiency levels | Defines the competency expectations for the role |
| Required qualifications | Educational and professional qualification requirements |
| Required certifications | Mandatory licences, registrations, or safety certifications |
| Preferred skills | Skills that are advantageous but not mandatory |
| Job family and career stream alignment | Links the job profile into the career pathway architecture |

Job profiles are configured collaboratively with the client's HR and talent leadership during the Talent Design Workshop phase of the implementation.

##### 3.4 Profile Matching and Talent Search

With both person profiles and job profiles configured, Oracle Fusion HCM provides real-time talent search and matching:

- **Internal talent search** — HR and talent leaders can search for workers whose profiles match a target job profile or a specified set of skills
- **Gap analysis** — the system identifies the delta between a worker's current profile and the requirements of a target role, informing development plan priorities
- **Succession matching** — the succession planning module uses job profile requirements to assess readiness and suitability of succession candidates
...
APPSolve implements Oracle Fusion Goal Management to provide a structured, organisation-wide approach to goal setting, cascading, and tracking. The goal framework is designed in collaboration with the client's HR and business leadership to ensure it reflects the organisation's performance management philosophy and review calendar.

**Goal framework elements APPSolve configures:**

| Element | Configuration |
|---|---|
| Goal plan types | Corporate, BU, team, and individual goal plans — configured per review cycle |
| Goal libraries | Pre-approved goal templates that employees and managers select from, reducing effort and ensuring alignment |
| Goal cascading | Corporate strategic objectives cascade down to BU, team, and individual level |
| SMART goal structure | Configurable goal fields — specific, measurable, time-bound, with target dates and achievement tracking |
| Goal weights | Weighted goal plans where goals carry relative importance scores that feed the performance score calculation |
| Goal approval workflows | Manager or HR approval for goal additions, changes, and closures |

##### 4.2 Progress Tracking and Check-ins

APPSolve configures Oracle Fusion Goal Management to support ongoing progress tracking throughout the review cycle, not only at formal review points:

- **Progress updates** — employees update goal progress status and percentage completion on a self-service basis
- **Manager visibility** — managers see real-time goal status for all direct reports from their manager dashboard
- **Check-in conversations** — structured check-in records can be logged against each goal, creating an ongoing coaching record
- **Automated alerts** — notifications trigger for goals approaching target dates without progress updates

##### 4.3 Goal Sharing and Cross-Team Alignment

Where the client's operating model requires cross-functional goal alignment, APPSolve configures shared goal functionality — enabling a goal owned by one team to be visible to and tracked by related teams — supporting matrix-structured organisations and project-based environments.

##### 4.4 Goal and Performance Integration

APPSolve configures the integration between Goal Management and Performance Management so that goal plan completion and achievement ratings automatically populate the performance review form. This eliminates manual re-entry and ensures that the performance rating reflects actual goal outcomes — not a separate, parallel assessment.

---

#### Section 5 — Performance Management

##### 5.1 Performance Review Cycle Configuration

APPSolve implements Oracle Fusion Performance Management to structure and automate the client's performance review process. The review cycle configuration is one of the most closely customised aspects of any HCM implementation — APPSolve dedicates a full workshop session to mapping the client's existing performance process before designing the Oracle configuration.

**Review cycle elements APPSolve configures:**

| Element | Configuration |
|---|---|
| Review cycle types | Annual, mid-year, quarterly, probation, and ad hoc cycles — each independently configured |
| Performance document | The review form template — sections, questions, rating scales, goal plan sections, narrative fields |
| Rating scales | Configurable 3-, 4-, or 5-point scales with descriptors per rating level |
| Participant roles | Employee self-assessment, manager assessment, matrix manager, HR, and skip-level sections |
| Workflow | The sequence of steps — self-assessment → manager assessment → calibration → approval → acknowledgement |
| Section weighting | Relative weighting of competency, goal, and overall rating sections |
| Timeline | Configurable start dates, step deadlines, and escalation rules |

##### 5.2 Competency Assessment

APPSolve integrates the client's competency framework into the performance review form so that the review captures both goal achievement and behavioural demonstration:

- Competencies drawn directly from the job profile for the worker's current role
- Rating of each competency against the configured scale
- Narrative evidence fields for each competency rating
- Competency ratings feed the overall performance score according to the configured weighting

##### 5.3 360-Degree Feedback

360-degree feedback is a standard Oracle Fusion Performance Management capability that APPSolve configures as part of the Talent Management engagement. APPSolve configures Oracle Fusion's participant feedback functionality to solicit structured input from peers, direct reports, and stakeholders — providing a multi-source view of each worker's performance and behaviour that enriches the manager's assessment.

**Standard 360 configuration APPSolve delivers:**

- **Participant selection** — the feedback requester (employee or manager) nominates raters; HR or the manager approves the participant list
- **Questionnaire design** — competency-based questionnaire aligned to the client's performance model; APPSolve configures the questions and rating scales in the Performance Design Workshop
- **Attribution model** — feedback may be configured as attributed (rater name visible) or anonymous (aggregated), depending on the client's governance preference
- **Aggregated results** — 360 feedback responses are presented to the manager and employee in aggregated form within the performance review form
- **Integration with review** — the 360 result feeds directly into the performance document alongside the manager assessment and self-assessment

**Configuration decisions confirmed in the Performance Design Workshop:** number of rater types; minimum and maximum participants per rater category; attribution vs anonymity; questionnaire structure; feedback window timing within the review cycle.

*Note: Advanced customer-specific workflow extensions, bespoke review processes, or non-standard 360 architectures that cannot be accommodated within Oracle standard functionality may require separate scoping.*

##### 5.4 Performance Calibration

APPSolve configures Oracle Fusion's talent calibration functionality to support the performance calibration process:

- **Calibration dashboards** — HR and talent leaders see the full population on a configurable matrix (typically performance vs potential — the 9-box)
- **Live adjustments** — managers and HR can adjust ratings during the calibration session from within the Oracle UI, with changes reflected in the worker's performance record
- **Distribution visibility** — rating distribution by department, grade, or business unit is displayed in real time, supporting normative calibration
- **Audit trail** — all calibration adjustments are recorded with the reviewer identity and timestamp

##### 5.5 Performance and Compensation Integration

Where Oracle Fusion Workforce Compensation (W3S1-005) is in scope, APPSolve configures the integration between Performance Management and Compensation so that the performance rating automatically populates the compensation planning worksheet. This enables compensation managers to allocate salary increases, bonuses, and equity awards within approved budgets — informed by performance outcome.

---

#### Section 6 — Talent Review and Succession Planning

##### 6.1 Talent Review

APPSolve implements Oracle Fusion Talent Review to give HR leaders and senior managers a structured, data-driven view of the talent population — enabling informed decisions about development, deployment, retention, and succession.

**Talent review configuration APPSolve delivers:**

| Component | Description |
|---|---|
| 9-box matrix | Performance vs potential matrix — APPSolve configures the axes, thresholds, and quadrant labels to the client's model |
| Population scope | Configurable scope — the review may cover the full organisation, a specific business unit, a grade band, or a leadership population |
| Talent indicators | Risk of loss, impact of loss, mobility preference, promotability rating — all configured and visible on the talent card |
| Talent notes | Private HR and manager notes attached to each worker's talent record, visible to authorised reviewers |
| Action plans | Post-review action items linked to the worker record — feeding development plans and succession updates |

##### 6.2 Succession Planning

APPSolve implements Oracle Fusion Succession Planning to enable the client to identify successors for key roles and manage the readiness and development of the succession pipeline.

**Succession planning capability APPSolve configures:**

| Capability | Description |
|---|---|
| Critical role identification | Roles designated as critical are flagged; succession plan depth is measured against each |
| Succession candidate pools | Nominated successors ranked by readiness level (Ready Now, Ready 1–2 Years, Ready 3+ Years) |
| Candidate profile visibility | The succession planner sees the nominee's talent card, performance history, and development plan in one view |
| Bench strength reporting | Dashboards show bench depth per critical role, by business unit, and across the organisation |
| Succession gap alerts | Roles with insufficient succession depth are highlighted for HR action |
| Incumbent comparison | Candidate profiles can be compared directly against the incumbent's and the job profile's requirements |

##### 6.3 Succession and Talent Review Integration

APPSolve configures the Talent Review and Succession Planning modules as an integrated workflow: talent review assessments (performance, potential, risk, mobility) directly inform succession candidacy decisions. A worker assessed as high-potential and ready for advancement in the talent review is surfaced automatically as a succession candidate for relevant roles, reducing administrative effort and ensuring that succession decisions are grounded in current, validated talent data.
...
APPSolve implements Oracle Fusion Career Development to support employees in understanding their career options, planning their development, and taking ownership of their growth within the organisation. Career Development integrates with Talent Profiles, Goal Management, and Learning Cloud (where in scope) to create a connected talent development experience.

**Career pathway configuration APPSolve delivers:**

| Component | Description |
|---|---|
| Career pathways | Configurable career paths showing typical progressions from current role to target roles — lateral and vertical |
| Progression requirements | Skills, competencies, qualifications, and experience required at each career stage — drawn from job profiles |
| Career ladder and lattice | Linear (ladder) and cross-functional (lattice) pathways configured to reflect the client's talent strategy |
| Role exploration | Employees can explore available roles within the organisation, view requirements, and assess their readiness |

##### 7.2 Development Plans

APPSolve configures Oracle Fusion development plans to connect the skills gap identified in the talent profile to structured development actions:

- **Development goals** — linked to the employee's talent profile gaps and career pathway requirements
- **Learning activities** — formal training, on-the-job development, mentoring, and stretch assignments recorded as development actions
- **Learning Cloud integration** — where Oracle Learning Cloud is in scope, development plan actions link directly to learning programmes (see W3S1-004)
- **Manager collaboration** — development plans are co-owned by the employee and manager; both can add, edit, and review development actions
- **Progress tracking** — development goal completion is tracked against target dates and visible to HR

##### 7.3 Internal Opportunity Marketplace

APPSolve has experience implementing Oracle Opportunity Marketplace capabilities as part of broader Oracle Talent Management programmes. The Oracle Fusion Opportunity Marketplace enables employees to discover and express interest in open roles, project gigs, stretch assignments, and mentoring opportunities within the organisation — supporting internal mobility and talent retention.

**Opportunity Marketplace capabilities APPSolve implements:**

- **Role and opportunity discovery** — employees receive personalised suggestions for internal positions and assignments based on their talent profile, skills, and career interests
- **Opportunity posting** — managers and HR can post open opportunities; employees express interest and are surfaced to opportunity owners
- **Talent mobility visibility** — HR and talent leaders have real-time visibility of internal mobility interest and talent movement across the organisation
- **Recruiting integration** — the Opportunity Marketplace integrates with Oracle Recruiting Cloud (W3S1-003), distinguishing internal expressions of interest from external applications in a unified talent pipeline
- **Skills-based matching** — AI-assisted skills matching surfaces relevant opportunities based on the employee's current and aspirational skill profile

*Implementation evidence: APPSolve has experience implementing Oracle Opportunity Marketplace capabilities at enterprise clients. Do not imply universal deployment across all Oracle HCM clients.*

##### 7.4 Mentoring

Oracle Fusion Talent Management includes mentoring functionality that supports formal mentoring programmes within the career development ecosystem. Where activated, Oracle Fusion mentoring enables:

- **Mentor-mentee matching** — employees can find and request mentors based on skills, experience, and interests; or HR can facilitate matching
- **Programme tracking** — mentoring relationships, meeting logs, and development outcomes are tracked within the Oracle HCM environment
- **Relationship management** — structured mentoring journeys with goal-setting and progress visibility for both mentor and mentee

*This capability is presented as an Oracle Fusion Talent Management platform capability. APPSolve configures and activates this functionality where it is within the agreed project scope. No specific implementation reference is attached to this capability at this stage — it is cited as Oracle platform functionality that APPSolve is able to implement.*

---

#### Section 8 — APPSolve Delivery Capability — Talent Management

##### 8.1 Implementation Capability

APPSolve's Oracle HCM delivery team has certified Oracle consultants with functional expertise across the Oracle Fusion Talent Management suite. APPSolve has experience implementing Oracle Fusion Talent Management capabilities including Talent Profiles, Goal Management, Performance Management, Career Development, and Succession Planning — as evidenced by the Hollywood Bets July 2025 go-live.

**Talent Management delivery team capability:**

| Role | Capability |
|---|---|
| Principal HCM Consultant | Talent Management solution architecture; talent design workshops; calibration configuration advisory |
| Senior Functional Consultant | Module configuration across all Talent suite components; performance document design; goal framework configuration |
| Senior Technical Consultant | OIC integration (performance-to-compensation; talent-to-analytics); OTBI reporting; HCM Extracts |
| Project Manager | OUM project governance; Talent phase planning; stakeholder and HR change management |

##### 8.2 Configuration Capability

APPSolve's configuration capability across the Talent Management suite:

- **Talent profiles:** Person and job profile content sections; competency frameworks; certification tracking; profile gap analysis
- **Goal Management:** Goal plan types; goal libraries; SMART structures; cascading configuration; approval workflows; performance integration
- **Performance Management:** Performance document templates; rating scales; competency integration; workflow sequencing; calibration setup; compensation integration
- **Talent Review:** 9-box matrix; talent indicator configuration; calibration UI; action planning integration
- **Succession Planning:** Critical role designation; succession candidate pools; readiness tracking; bench strength dashboards; gap alerting
- **Career Development:** Career pathways; development plans; learning integration; internal opportunity marketplace

##### 8.3 Delivery Sequencing

APPSolve delivers the Talent Management suite in the second phase of the Oracle HCM engagement:

| Phase | Dependency | Content |
|---|---|---|
| Phase 1 — HCM Core | None | Organisational model; worker records; absence management; self-service; journeys |
| Phase 2 — Talent Management | Phase 1 complete | Talent profiles; goal framework; performance cycle; talent review; succession; career development |
| Phase 3+ — Recruiting / Learning / Compensation | Phase 1 complete; Phase 2 for some integrations | Dependent on contracted scope |

**This sequencing is non-negotiable.** Talent Management configuration references job profiles, organisational hierarchies, and worker records from HCM Core. Beginning Talent Management configuration before HCM Core is stable and validated introduces rework that disrupts both phases.

##### 8.4 Talent Design Workshops

APPSolve conducts structured Talent Design Workshops during the Journey Workshop phase, covering:

- **Talent profile design** — person profile content sections; job profile structure; competency framework alignment
- **Performance cycle design** — review cycle types; document structure; rating scale; workflow sequence; calibration approach
- **Goal framework design** — goal plan types; cascading model; SMART structure; integration with performance rating
- **Succession design** — critical role definition; candidate pool structure; readiness nomenclature; bench strength reporting requirements

Workshop outputs are documented in the Configuration Decision Log — the reference document that drives the module build.

##### 8.5 Post-Go-Live and Managed Services

APPSolve provides Talent Management managed services post-go-live:

- Ongoing performance cycle administration: opening, closing, and archiving review cycles
- Goal plan maintenance: new cycle configuration; library updates
- Talent review facilitation support: dashboard configuration for new review rounds
- Succession pool updates: readiness reassessment; new critical role additions
- Quarterly release management: Oracle feature assessment for Talent modules; activation advisory
- Reporting: OTBI talent dashboard maintenance; succession gap reports; performance distribution reports

---

#### Section 9 — Reference Implementations

##### 9.1 Hollywood Bets — Oracle Fusion Talent Management Reference

**Client:** Hollywood Bets
**Industry:** Gaming and Entertainment
**Solution:** Oracle Fusion HCM — including Talent Management, Performance Management, Goal Management, Career Development, and Succession Planning
**Go-live:** July 2025
**User count:** 7,000 users
**Status:** Live — post-go-live support active

Hollywood Bets is APPSolve's primary Oracle Fusion HCM reference implementation, encompassing the full talent suite. APPSolve has experience implementing Oracle Fusion Talent Management capabilities at Hollywood Bets, including Talent Profiles, Goal Management, Performance Management, Career Development, and Succession Planning — all live as part of the July 2025 go-live.

**Talent Management scope at Hollywood Bets:**

| Module | Status |
|---|---|
| Oracle Fusion Talent Management (Talent Profiles) | Live — July 2025 |
| Oracle Fusion Goal Management | Live — July 2025 |
| Oracle Fusion Performance Management | Live — July 2025 |
| Oracle Fusion Career Development | Live — July 2025 |
| Oracle Fusion Succession Planning | Live — July 2025 |
...
##### 9.2 Additional Oracle HCM Implementations

APPSolve has delivered Oracle Fusion HCM implementations, including talent management capabilities, across enterprise clients in retail, mining, and professional services sectors. Specific reference details are available on request, subject to client consent and reference letter availability.

##### 9.3 Mr Price Group — Oracle HCM Support

**Client:** Mr Price Group
**Industry:** Retail
**APPSolve role:** APPSolve implemented Oracle Learning Cloud for Mr Price Group and provides ongoing support services across the client's broader Oracle HCM landscape.
**Scope note:** Mr Price is an implementation reference for Oracle HCM Learning Cloud only. APPSolve's broader Oracle HCM role at Mr Price is ongoing support — APPSolve did not implement all Oracle HCM modules at Mr Price. When citing Mr Price in this context, reference the Learning Cloud implementation and the broader support relationship separately.

---

#### Section 10 — Integration Architecture

##### 10.1 Oracle Integration Cloud — Standard Integration Layer

Oracle Integration Cloud (OIC) is the mandatory, standard integration layer in every APPSolve Oracle Fusion HCM implementation, including engagements where Talent Management is in scope. OIC connects Oracle Fusion HCM to the client's payroll system, analytics environment, learning platform, and enterprise systems.

##### 10.2 HCM Core Integration (Mandatory)

The Talent Management suite operates within the same Oracle Fusion HCM instance as HCM Core — they are not separate systems requiring an interface. However, the Talent Management configuration depends on data structures created in HCM Core:

| HCM Core element | Talent Management dependency |
|---|---|
| Job profiles | Job profile requirements populate the benchmark against which talent profiles are assessed |
| Organisational hierarchy | Determines goal cascading paths; performance review routing; calibration scope |
| Worker records | Person records are the subject of every talent process |
| Position management | Succession planning identifies successors for positions |

##### 10.3 Performance to Compensation Integration

Where Oracle Fusion Workforce Compensation (W3S1-005) is in scope, APPSolve configures the integration between Performance Management and Compensation Planning:

- Performance ratings from closed review cycles are written to the compensation worksheet
- Compensation managers see performance ratings alongside salary, grade, and range information
- Pay decisions are informed by performance outcome and normalised across the population

This integration is configured by APPSolve as part of the Compensation engagement (W3S1-005) — not independently within the Talent Management scope.

##### 10.4 Talent to Learning Integration

Where Oracle Learning Cloud (W3S1-004) is in scope, APPSolve configures the integration between Career Development and Learning:

- Development plan actions are linked to learning programmes in Oracle Learning Cloud
- Learning completions update skill records in the talent profile
- Course completions can trigger development goal progress updates

##### 10.5 Reporting and Analytics

APPSolve configures Oracle Fusion HCM's embedded reporting for the Talent Management suite:

| Tool | Talent reporting use |
|---|---|
| OTBI | Performance distribution by BU/grade/manager; succession bench depth; goal completion rates; profile completeness |
| Delivered dashboards | Talent Overview, Performance Summary, Succession Pipeline — activated and personalised |
| HCM Analytics | Advanced talent workforce analytics where licensed |

---

#### Section 11 — Implementation Approach

##### 11.1 Talent Phase Sequencing

APPSolve delivers Talent Management in the second phase of the Oracle HCM engagement, after HCM Core is live and stable. The Talent phase follows the same OUM-structured delivery sequence as HCM Core:

| Step | Talent Management activity |
|---|---|
| **Talent Design Workshop** | Profile design; performance document design; goal framework design; succession model design |
| **Configuration Decision Log** | All Talent design decisions documented and signed off before build |
| **Talent Build (CRP 1)** | Full Talent configuration delivered; HR team walks through the configured talent process end-to-end |
| **Talent CRP 2** | Corrections from CRP 1 implemented; second walkthrough with stakeholders |
| **Integration Testing** | Performance-to-compensation link; talent-to-learning link; OTBI reports |
| **Talent UAT** | Client HR and talent team test full talent cycle: goal-setting → mid-year → year-end → calibration → succession update |
| **Talent Go-Live** | Talent modules activated in production; full performance cycle launched |
| **Hypercare** | Full APPSolve team support through the first complete performance cycle |

##### 11.2 Performance Cycle Timing

APPSolve plans the Talent Management go-live around the client's performance calendar. If the client's annual review cycle begins in Q1, the Talent go-live must be completed before the cycle opens. APPSolve confirms the performance calendar in the Talent Design Workshop and back-plans the project timeline accordingly.

**Rule:** Do not go live with Performance Management if the configured review cycle cannot complete at least one full cycle before the next configuration change is required. APPSolve confirms cycle timing with the client before any configuration is committed.

##### 11.3 Change Management for Talent Adoption

Talent Management represents a significant change to the employee and manager experience — more so than most other HCM modules. APPSolve's Talent change management approach:

- **Manager training** — dedicated manager sessions on goal setting, performance assessment, and the calibration process
- **Employee communication** — structured communication plan for goal-setting launch and performance cycle opening
- **Train-the-trainer** — HR super-users are trained to support managers and employees through the first cycle
- **Quick reference guides** — APPSolve produces one-page guides for the most common employee and manager actions in each module

##### 11.4 Testing

**CRP focus for Talent Management:**
APPSolve tests the end-to-end talent cycle in CRP — from profile creation through goal-setting, mid-year check-in, year-end assessment, calibration, succession nomination, and development plan creation. The CRP test script is designed to walk through a complete talent lifecycle, not individual module screens.

**UAT for Talent Management:**
APPSolve provides role-based UAT scripts for employee, manager, HR administrator, talent reviewer, and succession planner roles. UAT sign-off requires completion of a full talent cycle by client testers in the UAT environment.
...
| Risk ID | Risk | Likelihood | Impact | Mitigation |
|---|---|---|---|---|
| R-W2-001 | Talent profile architecture not agreed before build begins, causing rework across all talent modules | High | High | APPSolve mandates Talent Design Workshop and Configuration Decision Log sign-off before any Talent module configuration starts |
| R-W2-002 | Goal framework not aligned across the organisation — departments use inconsistent goal structures — undermining performance data comparability | Medium | High | Goal framework design is completed in a cross-functional workshop; HR sign-off required on the goal plan structure before configuration |
| R-W2-003 | HCM Core phase not fully complete and stable when Talent phase begins — causing rework on organisational model and job profiles during Talent build | Medium | High | APPSolve includes a formal HCM Core stability gate: Talent configuration does not begin until HCM Core CRP 2 sign-off is received |
| R-W2-004 | Client's performance calendar changes after Talent configuration has been committed — requiring rework on review cycle timelines | Low | Medium | Performance calendar confirmed in Talent Design Workshop and locked in the Configuration Decision Log; any changes after sign-off are treated as change requests |
| R-W2-005 | Talent review and calibration processes not modelled and tested in UAT — problems discovered in the first live calibration round | Medium | Medium | APPSolve includes a full calibration simulation in UAT — HR and talent leaders run a mock calibration session in the UAT environment before sign-off |

---

#### Section 13 — Assumptions Register

| Assumption ID | Assumption |
|---|---|
| A-W2-001 | Oracle HCM Core (W3S1-001 scope) is implemented, live, and stable before Talent Management configuration begins. Talent Management does not proceed in parallel with a structurally incomplete HCM Core. |
| A-W2-002 | Standard Oracle performance review forms satisfy the client's performance management requirements. Bespoke form design, custom sections, or non-standard workflows are out of scope unless separately agreed. |
| A-W2-003 | One performance review cycle type is configured initially. Additional cycle types (probation, quarterly, ad hoc) are out of scope unless separately agreed. |
| A-W2-004 | The client's goal framework structure — goal plan types, cascading model, and goal library content — is provided by the client's HR leadership in advance of configuration. APPSolve configures; the client provides the content. |
| A-W2-005 | Standard Oracle Fusion 360-degree feedback is included within the Talent Management scope. Advanced bespoke extensions, custom workflow architectures, or non-standard 360 processes that cannot be met by Oracle standard functionality are out of scope unless separately agreed. |
| A-W2-006 | Historical performance data migration from prior systems is out of scope. Oracle Fusion Talent Management is configured for forward-looking cycles only. |
| A-W2-007 | Succession pool management, talent review facilitation, and calibration sessions are conducted by the client's HR team, supported by APPSolve during hypercare. APPSolve configures the system; the client runs the talent processes. |
| A-W2-008 | Career pathway structures and job family architecture are aligned to the job profile configuration completed in HCM Core. Career Development configuration does not redesign the job architecture — it extends it. |

---

#### Section A — Source Mapping Table
...
| Over 23 years of Oracle consulting | ORACLE_FACT_BASELINE Section 13 | — | Approved fact |
| 50+ Senior Consultants | ORACLE_FACT_BASELINE Section 13 | — | Removed — BU Lead CROSS-1 2026-06-13 |
| OIC mandatory in all Fusion implementations | ORACLE_FACT_BASELINE Section 7 | HIST-007 | Confirmed delivery model |
| OUM methodology | HIST-007 Assumptions section; HIST-015 approach | HIST-007, HIST-015 | Confirmed delivery model |
| HCM Core is mandatory prerequisite for Talent Management | HIST-007 Phase 3.3.1 → 3.3.2 sequence; HIST-015 Phase 3.3.1 → 3.3.7 sequence | HIST-007, HIST-015 | Confirmed methodology |
| Preferred wording: "APPSolve has experience implementing Oracle Fusion Talent Management capabilities including…" | BU Lead authorisation W3S1-002 2026-06-12 | — | Approved wording — use verbatim |
| Talent profiles as the foundation of all talent processes | HIST-007 Phase 3.3.2: "personal profiles and requirement profiles form the foundation of knowing and growing talent"; HIST-015 Phase 3.3.7 (same wording — independent corroboration) | HIST-007, HIST-015 | Implemented — dual-source corroboration |
| Goal Management: goal cascade, SMART structure, progress tracking | HIST-015 Phase 3.3.8: "formal measurement and planning of talent growth"; ORACLE_FACT_BASELINE Section 4.1 (module confirmed) | HIST-015, HIST-006 | Methodology + platform capability |
| Performance Management: review cycles, rating scales, calibration | HIST-015 Phase 3.3.8: "formal measurement and planning of talent growth"; ORACLE_FACT_BASELINE Section 4.1 (module confirmed) | HIST-015, HIST-006 | Methodology + platform capability |
| Succession Planning: candidate pools, bench strength, readiness | HIST-015 Phase 3.3.9: "plan the use and movement of talent"; ORACLE_FACT_BASELINE Section 4.1 (module confirmed) | HIST-015, HIST-006 | Methodology + platform capability |
| Career Development: pathways, development plans — Hollywood Bets live July 2025 | ORACLE_FACT_BASELINE Section 19; OI-W1-001 CLOSED by BU Lead 2026-06-12 | HIST-007, HIST-006 | Confirmed delivery — HB live July 2025 |
| Oracle Opportunity Marketplace: implemented capability | OI-W2-002 CLOSED by BU Lead 2026-06-12; ORACLE_FACT_BASELINE Section 21.3 (Mr Price implementation evidence); approved wording: "APPSolve has experience implementing Oracle Opportunity Marketplace capabilities as part of broader Oracle Talent Management programmes" | — | Implemented — Mr Price Group evidence (OI-W2-002 CLOSED) |
| 360-degree feedback: standard Talent Management capability | OI-W2-001 CLOSED by BU Lead 2026-06-12 — repositioned as standard; bespoke extensions separately scoped | HIST-006 | Standard platform capability — included in scope |
| Mentoring: Oracle platform capability, no current implementation reference | OI-W2-003 CLOSED by BU Lead 2026-06-12 — retain as platform capability; no client reference attached | HIST-006 | Platform capability — no implementation reference at this stage |
| Talent Review: 9-box, calibration dashboards, talent indicators | ORACLE_FACT_BASELINE Section 4.1 (Talent Review confirmed); HIST-006 (module context, reframed) | HIST-006 | Platform capability (reframed) |
| AI talent capabilities (talent search, profile matching, calibration support) | ORACLE_FACT_BASELINE Section 4.1 (AI-Based Skills); HIST-006 (reframed); BU Lead OI-W1-004 CLOSED | HIST-006 | Platform capability — Oracle AI; not APPSolve-developed |
| Hollywood Bets go-live July 2025, 7,000 users | ORACLE_FACT_BASELINE Section 19 (updated OI-W1-001 CLOSED) | HIST-007 | Confirmed implementation reference |
| Hollywood Bets: Talent Management, Performance Management, Goal Management, Career Development, Succession Planning — all live July 2025 | ORACLE_FACT_BASELINE Section 19 (updated OI-W1-001 CLOSED by BU Lead 2026-06-12) | HIST-007 | Confirmed scope — BU Lead authorised |
| Sector framing: retail, mining, professional services | ORACLE_FACT_BASELINE Section 21.1; C-W3-001 CLOSED by BU Lead 2026-06-12 | — | Standing governance rule |
| Mr Price: Learning Cloud = implementation; broader HCM = support | ORACLE_FACT_BASELINE Section 21.2; C-W3-002 CLOSED by BU Lead 2026-06-12 | — | Standing governance rule |
| Performance-to-compensation integration | ORACLE_FACT_BASELINE Section 4.1 (Workforce Compensation confirmed); reframed | HIST-006 | Platform capability (cross-module) |
| Talent-to-learning integration | ORACLE_FACT_BASELINE Section 4.1 (Learning Cloud confirmed); reframed | HIST-006 | Platform capability (cross-module) |
| Hypercare: 3 months full team; critical care thereafter | HIST-007 Support phase | HIST-007 | Confirmed delivery model |

---

#### Section B — Governance Self-Review

##### B.1 Prohibited Wording Check

| Prohibited phrase | Appears in draft? | Action taken |
|---|---|---|
| "Oracle Gold Partner" | No | Not used — "Oracle Level 1 Partner" throughout |
| "80 Senior Consultants" or "100+ consultants" | No | "50+ Senior Consultants" also removed — BU Lead CROSS-1 2026-06-13 |
| "CCBA" (client name) | No | Not referenced anywhere in draft |
| "SAA" as client, reference, or implementation evidence | No | SAA not named — modules sourced from ORACLE_FACT_BASELINE module list (Section 4.1) |
| "Afrocentric" (client name) | No | Delivery methodology used without naming |
| "aviation" as HCM sector | No | Sectors: retail, mining, professional services only (C-W3-001) |
| "APPSolve has implemented all Talent Management modules across its customer base" | No | Preferred wording used: "APPSolve has experience implementing…" |
| "APPSolve-developed AI" or "APPSolve AI" | No | AI referenced as Oracle Fusion HCM platform capability throughout |
| Unsupported project counts | No | No project count claims |
| Unsupported country counts | No | No country count claims |
...
|---|---|
| All capabilities framed as APPSolve implementing/configuring — not Oracle providing | ✅ Verified throughout |
| Preferred wording used for general Talent implementation claim | ✅ Section 1, Section 8.1, Section 9.1 |
| Hollywood Bets cited for all 5 confirmed Talent modules (OI-W1-001 CLOSED) | ✅ Section 9.1 module table |
| HCM Core stated as mandatory prerequisite throughout | ✅ Sections 2.4, 8.3, 11.1, A-W2-001 |
| OIC described as mandatory standard | ✅ Section 10.1 |
| Mr Price Learning Cloud = implementation; broader HCM = support | ✅ Section 9.3 |
| Afrocentric not named | ✅ Phase descriptions used without naming |
| CCBA not named | ✅ Not referenced |
| SAA not named | ✅ Not referenced; module list sourced from ORACLE_FACT_BASELINE |
| Aviation not claimed | ✅ Sectors: retail, mining, professional services only |
| AI section: Oracle platform capability framing; disclaimer retained | ✅ Section 2.3 |
| 360 feedback repositioned as standard Talent capability (OI-W2-001 CLOSED) | ✅ Section 5.3 — standard capability; bespoke extensions only separately scoped |
| Opportunity Marketplace: implemented capability with Mr Price evidence (OI-W2-002 CLOSED) | ✅ Section 7.3 — approved wording used; no over-claim; distinction maintained |
| Mentoring: platform capability framing; no implementation reference (OI-W2-003 CLOSED) | ✅ Section 7.4 — clearly stated as platform capability |
| Calibration described as configuration feature — client runs the process | ✅ Sections 5.4, A-W2-007 |

##### B.3 Source Traceability Check

| Check | Result |
|---|---|
| Every factual claim has a source in Section A | ✅ All claims traced |
| ORACLE_FACT_BASELINE approved phrases used verbatim | ✅ BU Lead preferred wording used verbatim in Sections 1, 8.1, 9.1 |
| Afrocentric outdated stats suppressed | ✅ No stats extracted from HIST-015 |
| Talent module scope for HB uses OI-W1-001 CLOSED authorisation | ✅ Section A traces to OI-W1-001 BU Lead decision |
| Platform capability claims (Career Development, Talent Review, AI) traced to ORACLE_FACT_BASELINE Section 4.1 | ✅ All traced |
| Career Development updated to Confirmed Delivery (HB live July 2025) | ✅ Section A — B-004 applied 2026-06-13 |

##### B.4 Open Items — ALL CLOSED

| Item ID | Resolution | Closed by | Date |
|---|---|---|---|
| OI-W2-001 | APPROVED. 360-degree feedback repositioned as standard Oracle Talent Management capability. Standard configuration is in scope. Bespoke extensions out of scope unless separately agreed. Section 5.3 rewritten; A-W2-005 updated; PT-W2-005 removed. | BU Lead | 2026-06-12 |
| OI-W2-002 | APPROVED. Oracle Opportunity Marketplace described as implemented capability. Implementation evidence: Mr Price Group. Approved wording applied verbatim in Section 7.3. No universal deployment implied. Source Mapping Table updated. | BU Lead | 2026-06-12 |
| OI-W2-003 | APPROVED — retain as platform capability. No implementation reference attached at this stage. Section 7.4 updated with explicit platform capability statement. | BU Lead | 2026-06-12 |

---

#### Section C — Extraction Return Report

##### Status
**W3S1-002 v1.2 Approved — COMPLETE. Approved by BU Lead 2026-06-13. All amendments applied. Copied to `06_Capabilities/Oracle/Oracle_HCM/`.**

##### Deliverables Produced

| Deliverable | Status | Location |
|---|---|---|
| W3S1-002 Approved Capability Statement | ✅ Complete | Sections 1–13 |
| Source Mapping Table | ✅ Complete | Section A |
| Risk Register (5 risks) | ✅ Complete | Section 12 |
| Assumptions Register (8 assumptions) | ✅ Complete | Section 13 |
| Governance Self-Review | ✅ Complete | Section B |
| Extraction Return Report | ✅ Complete | Section C |

##### Source Usage Summary

| Source | Usage | Tier |
|---|---|---|
| HIST-007 Hollywood Bets V5.0 | Primary — phase sequencing (3.3.1 → 3.3.2), talent profile wording, go-live reference, delivery model | Implementation Evidence |
| HIST-015 Afrocentric V4.0 | Corroborating — Phases 3.3.7, 3.3.8, 3.3.9 (Goal/Performance/Succession framing); methodology and assumptions | Delivery Methodology |
| HIST-006 SAA HCM RFP | Corroborating — module confirmation for Career Development, Talent Review, AI Skills, Opportunity Marketplace (all reframed as platform capability; SAA not named) | Platform Capability Evidence |
| ORACLE_FACT_BASELINE | Authoritative — all company stats, module confirmations, HB go-live data, approved wording, standing governance rules | Governing authority |
| CCBA (HIST-014) | Not used | Restricted |

##### Changes from v1.0 to v1.1

| Change | Section | Trigger |
|---|---|---|
| 360-degree feedback repositioned as standard Talent capability — detailed standard config table added | 5.3 | OI-W2-001 CLOSED |
| A-W2-005 updated: standard 360 in scope; bespoke extensions separately scoped | 13 | OI-W2-001 CLOSED |
| PT-W2-005 removed (all OIs now closed; no open-item pre-tender check required) | 17.2 | OI-W2-001, OI-W2-002, OI-W2-003 CLOSED |
| Opportunity Marketplace updated to implemented capability with approved wording and Mr Price evidence | 7.3 | OI-W2-002 CLOSED |
| Mentoring updated to explicit platform capability statement; no implementation reference | 7.4 | OI-W2-003 CLOSED |
| Source Mapping Table: 3 new rows for OI-W2-001, OI-W2-002, OI-W2-003 | Section A | All OI items CLOSED |
| Section B: framing checks updated; B.4 open items → closed items | Section B | All OI items CLOSED |
...
|---|---|---|
| "50+ Senior Consultants" removed from Section 1 prose and credential table | 1 | BU Lead CROSS-1 2026-06-13 |
| SAP Payroll artifact row removed from Source Mapping Table | Section A | B-003 |
| Career Development row updated: Classification changed to Confirmed delivery — HB live July 2025 | Section A | B-004 |
| Source mapping and prohibited wording entries updated | Section A, Section B | CROSS-1 |
| Version updated to 1.2 Approved; approved_for_reuse set to Yes | Frontmatter, 17.1 | B-005 |
...
| Field | Value |
|---|---|
| Document ID | W3S1-002-ORA-TalentMgmt |
| Title | Oracle Fusion Talent Management Suite — Capability Statement |
| Version | 1.2 Approved |
| Status | Approved — BU Lead approved 2026-06-13; all amendments applied (B-003, B-004, B-005, CROSS-1) |
| approved_for_reuse | Yes — BU Lead approved 2026-06-13 |
| Approved by | Hein Blignaut (BU Lead) |
| Approval date | 2026-06-13 |
...
| Check ID | Check | Timing |
|---|---|---|
| PT-W2-001 | Confirm Hollywood Bets account manager has confirmed HB as a referenceable client before citing HB in any live tender | Pre-tender |
| PT-W2-002 | Confirm OPN revalidation — Oracle Level 1 Partner status and Oracle Fusion Cloud HCM Core published expertise current as at tender submission date | Pre-tender |
| PT-W2-003 | Confirm BEE Level 3 certificate current and not expired (RS-19451, expires 2026-07-31). Do not cite BEE status in any tender after expiry | Pre-tender |
| PT-W2-004 | Confirm that W3S1-001 (HCM Core) is either already in scope for the tender or that Talent Management is being proposed as an extension to an existing Oracle HCM Core implementation — do not propose Talent Management as a standalone capability without a live HCM Core foundation | Pre-tender |
| PT-W2-005 | Confirm that no bespoke 360-degree feedback workflows are required beyond Oracle standard functionality before quoting 360 as fully in-scope with no additional commercial impact | Pre-tender |

---

*W3S1-002-ORA-TalentMgmt v1.2 Approved — 2026-06-13 — Hein Blignaut (BU Lead) — approved_for_reuse: Yes*
...
**APPSolve Framing Rule Check**

Spot-check of implementation claims confirms APPSolve framing throughout:
- "APPSolve configures and implements Recruiting Cloud..." (Section 2)
- "APPSolve implements Oracle Fusion Recruiting Cloud's candidate experience capabilities..." (Section 5)
- "APPSolve configures Oracle Fusion Recruiting Cloud's offer management capabilities..." (Section 7)
All claims attribute capability to APPSolve, not Oracle. ✅ PASS
...
### Oracle Fusion Learning Cloud

**Capability Statement | APPSolve | Oracle Business Unit**
*Document ID: W3S1-004-ORA-LearningCloud | Version: 1.1 Approved | Wave 3*

---

#### Section 1: Statement of Capability

APPSolve implements Oracle Fusion Learning Cloud as part of Oracle Fusion HCM programmes, enabling organisations to train, develop, and upskill employees through a modern, AI-enabled learning management system natively integrated with Oracle Fusion HCM.

APPSolve has implemented Oracle Fusion Learning Cloud for Mr Price Group, one of South Africa's largest retail groups, and provides ongoing support across the client's broader Oracle HCM landscape. Mr Price Group represents APPSolve's referenceable Oracle Fusion Learning Cloud implementation.

APPSolve's Oracle Learning Cloud delivery experience spans the retail sector. APPSolve supports clients across Retail, Mining, and Professional Services industries.

Compliance Training assignment and Certification Tracking are confirmed APPSolve implementation deliverables, configured as part of every Oracle Fusion Learning Cloud engagement. Oracle Fusion Learning Cloud also includes AI-driven learning recommendations and personalised learning journeys. APPSolve configures and enables these capabilities as part of Oracle Fusion Learning Cloud implementations.

A clear capability boundary applies throughout this document: Oracle Fusion Learning Cloud delivers course management, learning assignments, completion tracking, and certification status monitoring. Advanced learning dashboards and analytics are delivered through Oracle HCM Analytics — a complementary Oracle product. This distinction is maintained throughout Sections 9 and 12.

---

#### Section 2: Oracle Fusion Learning Cloud — Module Overview

Oracle Fusion Learning Cloud is Oracle's next-generation learning management system, forming part of the Oracle Fusion Cloud HCM Suite. APPSolve configures and implements Oracle Fusion Learning Cloud to enable organisations to create, manage, and track learning programmes, ensuring employees have the skills and knowledge required to support business performance.

The platform delivers five primary value outcomes that APPSolve configures as part of every Oracle Fusion Learning Cloud implementation:

| Value Outcome | Description |
|---|---|
| **AI-Powered and Personalised Learning** | Oracle Fusion Learning Cloud uses AI and machine learning to recommend courses based on an employee's role, skills, and career goals. APPSolve configures and enables these capabilities as part of Learning Cloud implementations. |
| **Continuous Learning and Upskilling** | Supports on-the-job training, self-paced courses, instructor-led training (ILT), virtual classrooms, and social learning. Enables employees to stay current with new skills, certifications, and compliance requirements. |
| **Employee Engagement and Knowledge Retention** | Encourages learning through gamification, peer collaboration, and mobile-friendly content. Interactive formats including videos, quizzes, and discussions support knowledge retention. |
| **Compliance and Certification Management** | Automates compliance tracking and certification renewal processes. Ensures employees complete mandatory training and meet regulatory requirements. APPSolve configures Compliance Training and Certification Tracking as standard implementation deliverables. |
| **Seamless Integration with Oracle Fusion HCM** | Natively connects with Oracle Talent Management, Career Development, Performance Management, and Oracle Core HR. Supports integration with third-party content providers and learning platforms where required. |

---

#### Section 3: Learning Administration and Course Catalog Management

##### 3.1 Learning Administration Framework

APPSolve establishes the learning administration framework as a core implementation deliverable. This framework defines the structural elements within which client learning administrators manage courses, assign training, and track completion independently after go-live.

| Framework Element | APPSolve Configuration Approach |
|---|---|
| **Learning Administration governance** | APPSolve designs the learning administration structure — courses, offerings, and activities — in collaboration with client HR and L&D teams during the Scope and Design phase |
| **User roles and access** | Learning Administrator, Manager, and Learner roles configured with appropriate access to course management, assignment, and reporting functions |
| **Global learning portal** | One learning portal configured as a global function across all territories within implementation scope |
| **Skills transfer to administrators** | APPSolve trains client learning administrators to own and manage the course catalog, enrolments, and learning assignments post go-live. Client independence is a core delivery objective. |

##### 3.2 Course Catalog and Content Management

| Capability | Detail |
|---|---|
| **Centralised course catalog** | APPSolve configures a comprehensive catalog of formal and informal learning content — courses, videos, documents, web links, and structured activities |
| **Supported content formats** | SCORM, AICC, PDF, videos, assessments, and weblinks. All learning content must be provided by the client in one of these Oracle-supported formats |
| **Content authoring** | Content cannot be created directly within Oracle Fusion Learning Cloud. Client content is uploaded to the configured catalog. APPSolve does not produce learning content; content creation is a client responsibility |
| **Catalog population** | Populating the Learning Catalog (Courses, Offerings, and Activities) and learner enrolments must be performed by client learning administrators after go-live. APPSolve configures the catalog structure; the client populates it. |
| **Historical data upload** | Upload of existing completion records is limited to a maximum of 2 years of data for active employees only, in the Oracle-supported import format |

---

#### Section 4: Learning Assignments and Compliance Training

##### 4.1 Learning Assignments

APPSolve configures Oracle Fusion Learning Cloud's assignment capabilities to enable structured delivery of mandatory, recommended, and role-based learning across the workforce.

| Assignment Type | Configuration Approach |
|---|---|
| **Mandatory assignments** | Assignments configured as required learning for defined employee groups (by role, department, location, or job grade). Automated enrolment and deadline tracking. |
| **Recommended assignments** | Learning suggested to employees based on role, skills profile, or career development plan. Integrated with Oracle Talent Profile where configured. |
| **Manager-assigned learning** | Managers assign learning to direct reports through the manager self-service portal, with task tracking and completion visibility |
| **Group and population assignments** | Bulk assignment to defined employee populations using Oracle HCM role-based rules and HR hierarchy |

##### 4.2 Compliance Training

Compliance Training is a confirmed APPSolve implementation capability, configured as a standard deliverable in Oracle Fusion Learning Cloud implementations.

| Compliance Capability | Description |
|---|---|
| **Mandatory compliance courses** | Configurable mandatory course assignments for regulatory, policy, and safety training requirements. APPSolve configures enforcement rules, deadline windows, and escalation behaviours. |
| **Automated enrolment** | Employees are automatically enrolled in required compliance training based on configured criteria (role, grade, location, regulatory obligation) |
| **Completion tracking** | Course completion status tracked in real time at individual, team, and organisational level. Non-completion alerts generated for managers and administrators |
| **Regulatory training management** | Supports multi-jurisdictional compliance requirements where a single implementation serves employees across different regulatory environments |
| **SETA and ATR reporting** | Legislative reporting (SETA, ATR, WSP) for South African compliance requirements is supported by means of a structured data extract that can be maintained and updated by client HR and skills development administrators |

---

#### Section 5: Learning Paths and Certifications

##### 5.1 Learning Paths and Structured Development Programmes

APPSolve configures structured learning paths and specialisations within Oracle Fusion Learning Cloud to guide employee development across defined skill or role trajectories.

| Capability | Description |
|---|---|
| **Learning paths / specialisations** | Structured sequences of courses and activities that guide employees through a defined development programme — for example, a leadership pipeline, technical skills track, or onboarding journey |
| **Prerequisite rules** | Learning paths configured with sequencing rules — a learner must complete prerequisite content before proceeding to the next stage |
| **AI-driven personalised learning paths** | Oracle Fusion Learning Cloud uses AI to recommend learning paths based on employee skills, role, career interests, and skill gaps identified in talent profiles and performance reviews. APPSolve configures and enables this capability as part of every Learning Cloud implementation. |
| **Career development integration** | Learning paths integrated with Oracle Career Development and Talent Profile modules, ensuring skill attainment is recorded in the employee's talent record |

##### 5.2 Certification Management

Certification Tracking is a confirmed APPSolve implementation capability and a standard configuration deliverable in every Oracle Fusion Learning Cloud engagement.

| Certification Capability | Description |
|---|---|
| **Certification creation and management** | APPSolve configures certifications with defined completion criteria, expiry rules, and renewal requirements. Certifications may be internal (Oracle Learning Cloud managed) or external (uploaded completion records) |
| **Expiry and renewal tracking** | Automated monitoring of certification expiry dates. Alerts generated to employees, managers, and administrators in advance of expiry windows |
| **Certification status visibility** | Learner certification status visible in the employee self-service portal, manager dashboard, and learning administrator console |
| **Compliance certification enforcement** | Mandatory certifications with regulatory or safety implications configured as compliance assignments — linked to Section 4.2 Compliance Training controls |
| **Audit trail** | Complete audit trail of certification attainment, expiry, renewal, and status changes maintained within Oracle Fusion Learning Cloud |

---

#### Section 6: Self-Service Learning and Mobile Access

##### 6.1 Employee Self-Service Learning

APPSolve configures Oracle Fusion Learning Cloud's self-service capabilities to enable employees and managers to manage learning independently without requiring HR administration for routine enrolment and progress tracking.

| Self-Service Capability | Description |
|---|---|
| **Course browsing and enrolment** | Employees browse the learning catalog, enrol in available courses, complete e-learning modules, and withdraw from non-mandatory learning through a self-service portal |
| **Learning progress tracking** | Employees view their own learning history, completion status, outstanding assignments, and certification records through the learner portal |
| **Application tracking** | Employees track the status of learning enrolment requests and approvals in real time |
| **Manager self-service** | Managers view the learning status of direct reports, approve learning enrolment requests, and assign training through the manager self-service portal |
| **Notifications and reminders** | Automated notifications for upcoming deadlines, new assignments, and completion confirmations — configurable at the employee, manager, and administrator level |

##### 6.2 Mobile Learning and Offline Access

Oracle Fusion Learning Cloud provides a mobile application that enables employees to access learning content from any device, at any time.

| Mobile Capability | Detail |
|---|---|
| **Mobile application** | Oracle Fusion Cloud Learning supports mobile access via the Oracle HCM mobile app. Employees can browse, enrol, and complete learning on mobile devices. |
| **Offline learning** | Employees can download content (videos, PDFs) to their mobile devices and complete it offline. Content is synchronised upon reconnection. |
| **Offline limitations** | Certain interactive elements — including evaluations, assessments, and some SCORM content — may require online access for submission. Offline capability applies primarily to consumable content. |
| **Responsive design** | Oracle Learning Cloud is accessible through a browser on any device. No separate mobile configuration is required for browser-based access. |

---

#### Section 7: Social and Collaborative Learning

Oracle Fusion Learning Cloud supports social and collaborative learning capabilities, enabling organisations to extend learning beyond formal structured content into peer-driven knowledge sharing.

APPSolve positions social and collaborative learning as an Oracle Fusion Learning Cloud platform capability supported by APPSolve implementation services.

| Social Learning Capability | Description |
|---|---|
| **Learning communities** | Oracle Fusion Learning Cloud supports community-based learning where employees can participate in peer discussions, share knowledge, and engage in collaborative content. |
| **Knowledge sharing** | Employees and subject matter experts can contribute user-generated content within defined community structures, extending the reach of formal learning content |
| **Peer-to-peer learning** | Supported through discussion forums and community participation tools embedded within the learning platform |
| **Gamification** | Oracle Fusion Learning Cloud supports gamification elements — including points, badges, and leaderboards — to encourage engagement with learning content and improve knowledge retention |

*APPSolve note: Social and collaborative learning is an Oracle Fusion Learning Cloud platform capability. No confirmed implementation evidence exists for any named APPSolve reference client for this specific feature set. APPSolve supports the configuration of these capabilities as part of Learning Cloud implementations where the client chooses to activate them.*

---

#### Section 8: Skills Development and Talent Profile Integration

##### 8.1 Learning and Skills Integration

Oracle Fusion Learning Cloud integrates natively with the Oracle Fusion HCM Talent Profile, enabling a continuous connection between learning activity and the skills and competency record of each employee. APPSolve configures this integration as part of Learning Cloud implementations where Oracle Talent Management (W3S1-002) is also in scope.

| Integration Point | Description |
|---|---|
| **Talent Profile update on completion** | Learning outcomes and completed training are automatically recorded in the employee's Oracle Fusion Talent Profile, updating their skills and competency records |
| **Skill gap identification** | AI-powered capabilities identify skill gaps in employee profiles and surface learning recommendations to close those gaps. APPSolve enables this capability through Talent Profile and Learning Cloud configuration. |
| **Performance Management linkage** | Oracle Learning Cloud integrates with Oracle Performance Management — enabling managers to recommend learning based on performance review outcomes and development plan objectives |
| **Career Development linkage** | Employees working toward defined career goals receive learning recommendations aligned to the skills required for target roles |
| **Succession Planning linkage** | Learning programmes for identified successors can be assigned as part of succession development plans, with completion tracked in the Talent Profile |

##### 8.2 AI-Enabled Skills Development

Oracle Fusion Learning Cloud uses AI and machine learning to connect employee skill profiles with relevant learning content, creating a continuous skills development loop across the Oracle Fusion HCM platform.

| AI Capability | Description | Framing |
|---|---|---|
| **AI learning recommendations** | Oracle AI analyses employee skills, role requirements, and career interests to recommend relevant courses and learning paths | Platform capability — APPSolve configures and enables |
| **Personalised learning journeys** | Employees receive customised learning journey recommendations based on their unique profile, career goals, and identified development needs | Platform capability — APPSolve configures and enables |
| **Skill gap surfacing** | AI highlights skill gap areas and connects them to available learning content within the catalog | Platform capability — depends on Talent Profile depth of configuration |

*APPSolve implements and configures the Oracle Fusion HCM foundation that makes AI-driven skills development possible. The quality of AI recommendations is a function of the richness of the job profile, competency framework, and talent profile data established during implementation.*

---

#### Section 9: Learning Analytics — Capability Scope and Boundaries

A clear distinction must be maintained between Oracle Fusion Learning Cloud tracking capabilities and Oracle HCM Analytics (OAX) advanced analytics. This distinction is reflected in every APPSolve Learning Cloud delivery and is embedded in the standard implementation assumptions (Section 15).

##### 9.1 Oracle Fusion Learning Cloud — Built-In Tracking

The following tracking capabilities are available within Oracle Fusion Learning Cloud as part of the standard implementation scope:

| Tracking Capability | Description |
|---|---|
| **Enrolment tracking** | Real-time visibility of learner enrolment status across all assignments and self-enrolled courses |
| **Completion tracking** | Course completion rates at individual, team, and population level |
| **Assessment results** | Learner assessment scores and outcomes recorded within the learning record |
| **Certification status** | Current, expiring, and lapsed certification status visible at the individual learner and population level |
| **Learner progress** | Stage-by-stage progress through structured learning paths and mandatory compliance programmes |
| **Assignment compliance status** | Percentage completion of mandatory training assignments across defined employee groups — used for regulatory reporting extracts |

**Standard implementation assumption (confirmed across multiple APPSolve delivery engagements):** Oracle Fusion Learning Cloud does not include pre-built Learning Reports or Dashboards as part of the standard implementation scope. The tracking capabilities above are accessible through administrator consoles and learner portals, not through formal report interfaces.

##### 9.2 Oracle HCM Analytics — Advanced Learning Analytics

Advanced learning analytics — including executive dashboards, trend analysis, skills intelligence, and cross-module reporting — are delivered through Oracle HCM Analytics (OAX), which is a separately licensed and separately implemented Oracle product.

| OAX Learning Analytics Capability | Description |
|---|---|
| **Learning dashboards** | Pre-built OAX dashboards covering learning completion rates, compliance metrics, skills development progress, and training ROI |
| **Skills intelligence** | Advanced analytics connecting learning activity to skills attainment across the workforce |
| **Trend analysis** | Historical and predictive analysis of learning engagement, completion patterns, and skill gap closure over time |
| **Executive analytics** | Senior leadership reporting on workforce learning investment and capability development outcomes |
| **Cross-module analytics** | Connecting learning data with performance, talent, and workforce composition data for holistic people analytics |

Clients requiring advanced learning dashboards and analytics should reference the APPSolve Oracle HCM Analytics and Workforce Intelligence capability statement (W3S1-006). APPSolve supports end-to-end Oracle HCM Analytics implementations where advanced learning reporting is a delivery requirement.

*Approved positioning: "Advanced learning analytics and dashboarding capabilities are typically delivered through Oracle HCM Analytics rather than Oracle Fusion Learning Cloud itself."*

---

#### Section 10: APPSolve Delivery Capability

##### 10.1 Oracle Learning Cloud Practice

APPSolve's Oracle Business Unit includes HCM-certified consultants with implementation experience in Oracle Fusion Learning Cloud. APPSolve holds Oracle Level 1 Partner status.

APPSolve has implemented Oracle Fusion Learning Cloud for Mr Price Group, a leading South African retail organisation, and provides ongoing support across the client's broader Oracle HCM landscape. APPSolve's Learning Cloud experience spans the retail sector, with implementations covering Learning Administration framework design, Compliance Training configuration, Certification Management, and Learning Path structuring.

##### 10.2 Learning Cloud Delivery Approach

APPSolve applies a structured, framework-first approach to Oracle Fusion Learning Cloud implementations. The learning administration framework — encompassing catalog structure, role configuration, assignment rules, and compliance controls — is established and tested before any content population begins.

| Delivery Principle | Description |
|---|---|
| **Framework before content** | APPSolve configures the complete learning administration framework (catalog structure, roles, assignment rules, compliance controls) before any course content is uploaded. The framework must be stable before content loading begins. |
| **Client ownership of content** | Learning content is a client responsibility. APPSolve designs the framework and provides guidance; the client learning administrators own and maintain the catalog post go-live. |
| **Skills transfer focus** | APPSolve trains client learning administrators to manage the full Oracle Fusion Learning Cloud environment independently after go-live — including course catalog management, assignment creation, compliance monitoring, and certification management. |
| **Compliance integration** | Compliance Training requirements are gathered and mapped during the Scope and Design phase. Configuration of mandatory assignments, enforcement rules, and SETA extract mechanisms is a standard delivery component. |
| **Analytics boundary management** | APPSolve clearly defines the boundary between Oracle Learning Cloud tracking and Oracle HCM Analytics at project initiation, ensuring client expectations are set correctly before implementation begins. |

##### 10.3 Resource and Delivery Model

| Resource type | Role |
|---|---|
| HCM Principal Consultant | Design authority; learning framework governance; client engagement leadership |
| HCM Senior Functional Consultant | Project implementation lead; Learning Cloud configuration and testing |
| HCM Senior Functional / Technical Consultant | OIC integration; data migration (HDL templates for learning records); SETA extract build |
| Project Manager | Delivery governance; timeline management; risk and issue escalation |

Implementation is conducted remotely with on-site presence for key workshops where required. APPSolve's hybrid delivery model is applied as standard.

---

#### Section 11: Implementation References

##### 11.1 Mr Price Group — Oracle Fusion Learning Cloud (Primary Reference)

| Attribute | Detail |
|---|---|
| **Client** | Mr Price Group |
| **Industry** | Retail |
| **Product** | Oracle Fusion HCM Learning Cloud |
| **APPSolve role** | Implemented Oracle Fusion Learning Cloud; provides ongoing support across the client's broader Oracle HCM landscape |
| **Governance boundary** | Mr Price Learning Cloud = APPSolve implementation. Mr Price broader Oracle HCM estate = APPSolve support. These are distinct engagements and must not be conflated. |
| **Reference status** | Referenceable — contact details available via APPSolve account management. Pre-tender contact confirmation required. |

*Note: Mr Price Group is cited as an Oracle Fusion Learning Cloud implementation reference only. Mr Price's broader Oracle HCM estate is supported by APPSolve, not implemented by APPSolve. References to Mr Price in the context of full Oracle HCM implementation are not permitted.*

##### 11.2 Additional Oracle Learning Cloud Implementation Evidence (Internal)

APPSolve's Oracle Fusion Learning Cloud implementation experience extends beyond Mr Price Group across multiple Oracle Fusion HCM programmes. This experience provides depth of delivery knowledge across Learning Administration, Compliance Training, Certification Management, and Learning Path configuration. Reference clients for these implementations are not currently approved for public or tender citation. Internal evidence available to support internal capability assessment.

---

#### Section 12: Integration Architecture

Oracle Integration Cloud (OIC) is APPSolve's standard integration layer in every Oracle Fusion HCM implementation, including Oracle Fusion Learning Cloud. This applies without exception.

##### 12.1 Standard Learning Cloud Integration Points

| Integration | Method | Description |
|---|---|---|
| **Oracle Fusion Core HR** | Native Oracle integration | Learning assignments and completion records linked to employee records in Core HR. Learner populations defined by HR hierarchy, role, and grade from Core HR. |
| **Oracle Talent Management** | Native Oracle integration | Learning outcomes recorded in Oracle Fusion Talent Profile. Skill gap identification connects Talent Management to Learning Cloud recommendations. |
| **Oracle Performance Management** | Native Oracle integration | Performance review outcomes can trigger learning recommendations. Development plan objectives linked to learning path assignments. |
| **Oracle Career Development** | Native Oracle integration | Career goals in Oracle Career Development drive learning path recommendations. Learning completion supports career readiness tracking. |
| **Oracle Onboarding** | Native Oracle integration | Learning assignments for new hires integrated with Oracle Onboarding workflows. Mandatory onboarding training tracked through Oracle Learning Cloud where configured. |
| **SETA / WSP / ATR reporting** | OIC / HCM Extracts | South African skills development legislative reporting delivered through structured data extracts. APPSolve configures the extract mechanism; client administrators manage ongoing reporting. |
| **Third-party content providers** | OIC / REST APIs | APPSolve can configure Oracle Fusion Learning Cloud integrations with supported third-party learning content providers and learning platforms (such as LinkedIn Learning, Coursera, and equivalent platforms) where required. Scope and provider-specific integration requirements confirmed during Scope and Design phase. |
| **External LMS platforms** | REST APIs / OIC | Where clients operate an existing LMS (e.g., Moodle) alongside Oracle Learning Cloud, APPSolve can configure integration to align completion records, reporting extracts, and user data between platforms. |

##### 12.2 REST API and Data Loader Support

Oracle Fusion HCM provides comprehensive RESTful APIs and HCM Data Loader (HDL) capabilities for learning administration:

- **HDL templates** — APPSolve configures HDL templates for bulk loading and editing of learning records (course completions, certifications, enrolments)
- **HCM Spreadsheet Data Loader (HSDL)** — supports mass import of learning assignments and historical completion records
- **Learning reports export** — learning activity data can be exported for offline analysis and legislative reporting

---

#### Section 13: Implementation Approach

##### 13.1 Learning Cloud within the Oracle Fusion HCM Programme

Oracle Fusion Learning Cloud is implemented as a structured delivery phase within the broader Oracle Fusion HCM programme. Learning typically follows Core HCM and Recruiting in the implementation sequence, ensuring that the employee population and job profile structure are in place before Learning configuration begins.

| Phase | Content | Learning Cloud Dependency |
|---|---|---|
| Phase 1 | Core HCM — Global HR, Absence Management, Self-Service | Foundation — employee records, job structure, HR hierarchy required by Learning |
| Phase 2 | Talent Management / Recruiting | Talent Profile and competency framework required for skills-driven learning recommendations |
| **Phase 3** | **Oracle Fusion Learning Cloud** | **Requires Phase 1 (employee population, roles); Phase 2 (Talent Profile, competency framework) for full AI recommendation capability** |
| Phase 4 | Workforce Compensation, Help Desk | Parallel or subsequent to Learning |

##### 13.2 OUM Delivery Phases — Learning Cloud

APPSolve applies the Oracle Unified Methodology (OUM) across all Oracle Fusion HCM implementations, including Learning Cloud:

| OUM Phase | Learning Cloud Activities |
|---|---|
| **Mobilize** | Project charter; Learning Cloud scope confirmation; framework design workbooks; stakeholder alignment on content ownership and compliance requirements |
| **Scope and Design** | Learning administration framework design; compliance training inventory; certification requirements mapping; SETA/WSP/ATR extract design; content format review; integration architecture confirmation |
| **Prototype** | CRP1 — learning administration framework walk-through; compliance assignment testing; CRP2 — refined configuration including catalog structure, assignment rules, certification controls, and mobile access |
| **Build** | Full configuration build; HDL templates for historical data load; OIC integration build (content providers, SETA extract, external LMS where in scope); training material development; skills transfer sessions with learning administrators |
| **Deploy** | Production build; data verification (historical completions — up to 2 years, active employees only); UAT; administrator training; go-live support |
| **Post Go-Live** | Hyper-care (full team approximately 3 months); catalog population support; administrator independence confirmation; steady-state handover |
...
| Risk ID | Risk | Likelihood | Impact | Mitigation |
|---|---|---|---|---|
| R-W3-004-001 | Learning Catalog population not ready at go-live — client learning administrators have not completed course uploads and enrolment configuration, delaying productive use of the system | Medium | High | Catalog population responsibility confirmed with client at project initiation. APPSolve configures the framework structure; client populates content. Milestone checkpoint for catalog readiness included in the deployment gate review. |
| R-W3-004-002 | Client analytics expectations misaligned — client expects built-in Learning Reports or Dashboards as part of Oracle Learning Cloud and is surprised by the absence of OOB reporting | Medium | Medium | Analytics boundary (OLC tracking vs OAX dashboards) established at project kick-off. Analytics expectation confirmed in project charter and implementation assumptions register. Clients requiring advanced dashboards are directed to Oracle HCM Analytics (W3S1-006). |
| R-W3-004-003 | Content format incompatibility — client's existing learning content is not in SCORM, AICC, PDF, video, or weblink format, requiring content conversion before upload | Medium | Medium | Content format review conducted during Scope and Design phase. Client content inventory assessed against Oracle-supported formats. Content conversion is a client responsibility. |
| R-W3-004-004 | SETA/WSP/ATR extract complexity — South African legislative reporting requirements are more complex than standard data extract configuration, requiring additional design and testing | Medium | Medium | SETA extract is designed as a structured component within the Learning Cloud implementation scope. APPSolve configures the extract mechanism; client administrators are trained to operate and maintain it. Additional complexity is flagged as a risk during Scope and Design. |
| R-W3-004-005 | Third-party content provider integration scope underestimated — each provider has different API requirements and entitlement models, extending integration design and build effort | Low | Medium | Content provider integrations are scoped separately. APPSolve confirms provider API documentation and entitlement model before integration design begins. Provider integrations not included in base implementation scope without explicit agreement. |
...
| Assumption ID | Assumption | Risk if incorrect |
|---|---|---|
| A-W4-001 | Learning is configured as a global function — one learning portal serves all in-scope territories | If territories require separate portals, scope increases materially |
| A-W4-002 | Learning scope covers internal employees only — external training for partners, customers, or third parties is excluded from implementation scope | External learning requires additional licensing and a different implementation approach |
| A-W4-003 | All learning content is supplied by the client in Oracle-supported formats: SCORM, AICC, PDF, videos, assessments, and weblinks | Content in unsupported formats requires conversion before upload — client responsibility |
| A-W4-004 | Historical completion data upload is limited to a maximum of 2 years of data for active employees only | Historical data beyond 2 years or for inactive employees is out of scope; additional data migration requires separate agreement |
| A-W4-005 | SETA, ATR, and WSP legislative reporting is supported through a data extract approach; Oracle Fusion Learning Cloud does not provide purpose-built SETA/ATR/WSP reports | Extract-based approach confirmed as per APPSolve standard implementation methodology |
| A-W4-006 | Oracle Fusion Learning Cloud does not include pre-built Learning Reports or Dashboards as part of the standard implementation scope | Clients requiring learning dashboards and analytics require Oracle HCM Analytics (OAX) — separately licensed and implemented |
| A-W4-007 | Populating the Learning Catalog (Courses, Offerings, and Activities) and learner enrolments is the responsibility of client learning administrators after go-live | Delay in catalog population by the client delays productive use of the system |
| A-W4-008 | A maximum of 5 assessments and evaluation surveys are configured within the implementation scope; additional assessments require separate scoping | Larger assessment libraries are a scope increase |
| A-W4-009 | Third-party content provider integrations (LinkedIn Learning, Coursera, Udemy, or equivalent) are not included in the base implementation scope and require separate scoping and agreement | Content provider integrations add to integration design and build effort |
| A-W4-010 | All reports, dashboards, and extracts developed during the implementation are applicable globally across all territories within the implementation scope | Territory-specific reporting variants are a scope increase |
...
| Field | Value |
|---|---|
| **Document ID** | W3S1-004-ORA-LearningCloud |
| **Version** | 1.1 Approved |
| **Created** | 2026-06-12 |
| **Created by** | Claude (AI — Wave 3 W3S1-004 extraction) |
| **Status** | Approved — BU Lead approved 2026-06-13; all amendments applied (H-001, CROSS-1) |
| **Approved for reuse** | Yes — BU Lead approved 2026-06-13 |
| **Approved by** | Hein Blignaut (BU Lead) |
| **Approval date** | 2026-06-13 |
| **Open items at submission** | None — all 5 OI items (OI-W4-001 through OI-W4-005) CLOSED by BU Lead 2026-06-12 |
| **BU Lead** | Hein Blignaut |
...
| Section | Content type | Primary source | Governance classification |
|---|---|---|---|
| Section 1 | Implementation evidence | ORACLE_FACT_BASELINE Section 19 (Mr Price — Learning Cloud confirmed) | Tier 1 — Referenceable |
| Section 1 | AI capability framing | BU Lead OI-W4-002 approved wording | Governance-approved statement |
| Section 2 | Module overview | HIST-006 (SAA, sentences 193–205) | Tier 3 — Platform Capability; reframed as APPSolve capability |
| Section 3.1 | Learning administration | HIST-006 (sentences 636, 752–753); HIST-015 (Phase 1.3 assumptions) | Tier 3 — Platform Capability / Methodology |
| Section 3.2 | Course catalog | HIST-006 (sentences 425–428); HIST-015 (sentences 321–331) | Tier 3 — Platform Capability |
| Section 4.1 | Learning assignments | HIST-006 (sentence 431) | Tier 3 — Platform Capability |
| Section 4.2 | Compliance training | HIST-006 (sentences 199, 202–203, 212); BU Lead OI-W4-002 (confirmed implementation deliverable) | Tier 1 confirmed implementation capability |
| Section 4.2 | SETA/ATR/WSP | HIST-006 (sentence 746); HIST-015 (methodology) | Delivery methodology |
| Section 5.1 | Learning paths | HIST-006 (sentences 197, 206–207, 430) | Tier 3 — Platform Capability |
| Section 5.1 | AI learning paths | BU Lead OI-W4-002 approved wording | Governance-approved statement; platform capability |
| Section 5.2 | Certifications | HIST-006 (sentences 202–203, 213, 432, 499); BU Lead OI-W4-002 (confirmed implementation deliverable) | Tier 1 confirmed implementation capability |
| Section 6.1 | Self-service learning | HIST-006 (sentences 480, 490) | Tier 3 — Platform Capability |
| Section 6.2 | Mobile learning | HIST-006 (sentences 209, 438–441) | Tier 3 — Platform Capability |
| Section 7 | Social learning | HIST-006 (sentences 210–211); BU Lead OI-W4-003 approved wording | Tier 3 — Platform Capability only |
| Section 8.1 | Skills and talent integration | HIST-006 (sentences 155, 157–158, 434) | Tier 3 — Platform Capability |
| Section 8.2 | AI skills development | HIST-006 (sentences 196–197, 206–207); BU Lead OI-W4-002 | Platform capability; APPSolve configures and enables |
| Section 9.1 | Learning tracking (OLC) | HIST-006 (sentences 436); BU Lead OI-W4-004 | Standard implementation capability |
| Section 9.1 | Analytics caveat | HIST-006 (sentence 748); HIST-015 (sentence 326); BU Lead OI-W4-004 | Standing delivery assumption — confirmed in 2 APPSolve proposals |
| Section 9.2 | HCM Analytics (OAX) | HIST-006 (sentences 214–215, 218–220); BU Lead OI-W4-004 | Cross-reference to W3S1-006 |
| Section 10 | Delivery capability | ORACLE_FACT_BASELINE Section 19 (Mr Price); HIST-015 (methodology corroboration — unnamed) | Tier 1 / Tier 3 |
| Section 11.1 | Mr Price reference | ORACLE_FACT_BASELINE Section 19; HIST-016 (SABS ETS general HCM corroboration) | Tier 1 — Referenceable |
| Section 12 | OIC integration | ORACLE_FACT_BASELINE Section 7 (mandatory); HIST-006 (sentences 216–217) | Mandatory standard |
| Section 12 | Content providers | HIST-006 (sentences 205, 217); BU Lead OI-W4-005 approved wording | Platform capability with APPSolve enablement |
| Section 12 | SETA extract / External LMS | HIST-006 (sentence 746); HIST-007 Annexure 1 (Moodle/OIC pattern) | Delivery methodology |
| Section 13 | Implementation approach | ORACLE_FACT_BASELINE Section 17 (OUM); HIST-015 (Phase 1.3 structure and assumptions) | Delivery methodology |
| Section 14 | Risk register | SVR-W3S1-004 risk analysis | Internal governance |
| Section 15 | Assumptions register | HIST-006 (sentences 744–753); HIST-015 (sentences 321–331) | Source-validated across 2 APPSolve delivery documents |

**Prohibited sources — confirmed excluded:**
- CCBA (HIST-014) — prohibited; not used
- SAA — not named as client or reference; platform capability source only (reframed)
- Hollywood Bets — NOT cited for Learning Cloud; excluded per OI-W4-001 (CLOSED: NO)
- DFA — not named; internal evidence only (Rule 21.4); never referenced in output
- Redpath Mining — Learning Cloud NOT confirmed in active scope; excluded per BU Lead instruction and OI-W4-001 resolution
- Aviation sector — not referenced anywhere in this document (Rule 21.1)
...
| **21.1 Approved sectors** | Retail (Mr Price — confirmed), Mining (internal evidence only, not cited as named sector in this document), Professional Services (supported sector) | ✅ PASS |
| **21.1 SAA source rule** | SAA content used as platform capability narrative only; SAA not named as client, reference, or implementation in any section | ✅ PASS |
| **21.2 Implementation vs Support distinction** | Mr Price: Learning Cloud = implementation; Mr Price broader HCM = support (Section 11.1 explicitly states this distinction and prohibits conflation) | ✅ PASS |
| **21.3 Opportunity Marketplace** | Not referenced in Learning Cloud context | ✅ PASS |
| **21.4 DFA — never named** | DFA not named anywhere in the document; internal evidence only; used to validate implementation breadth without client identification | ✅ PASS |
| **21.5 Redpath — not used** | Redpath Learning Cloud not confirmed in scope; excluded per BU Lead instruction | ✅ PASS |
| **CCBA — never named** | CCBA not referenced anywhere in the document | ✅ PASS |
| **Hollywood Bets — not cited for Learning Cloud** | Hollywood Bets excluded from Learning Cloud references per OI-W4-001 (CLOSED: NO). Hollywood Bets not mentioned in any context in this document. | ✅ PASS |

**ORACLE_FACT_BASELINE Section 15 — Prohibited Wording Check**

| Prohibited item | Check |
|---|---|
| "Oracle Gold Partner" / "Gold Level" | Absent — "Oracle Level 1 Partner" used in Section 10.1 | ✅ |
| "110 Senior Consultants" / "100+ consultants" | Absent — "50+ Senior Consultants" also removed per BU Lead CROSS-1 2026-06-13 | ✅ |
| "over 22 years" | Absent — not cited in this document | ✅ |
| "BEE Level 2" | Absent — BEE not cited in this capability statement | ✅ |
| "Oracle Learning Cloud does X" (Oracle framing) | Absent — all claims framed as APPSolve implementing/configuring X using Oracle Fusion Learning Cloud, or explicitly marked as Oracle platform capability | ✅ |
| AI recommendations as confirmed implemented client capability | Absent — AI capabilities framed as "APPSolve configures and enables" / platform capability throughout Sections 1, 5.1, 8.2 | ✅ |
| Learning Communities as confirmed APPSolve implementation | Section 7 explicitly notes: "APPSolve supports the configuration of these capabilities... where the client chooses to activate them" — not cited as confirmed delivery | ✅ |
| Analytics overstatement | Section 9 clearly separates OLC tracking from OAX analytics; caveat included in Section 9.1 and Assumptions A-W4-006 | ✅ |
| Mr Price cited for full HCM implementation | Absent — Section 11.1 explicitly states "Mr Price Learning Cloud = APPSolve implementation; broader HCM estate = APPSolve support" | ✅ |
| Unsupported client counts or module counts | Absent | ✅ |

**OIC Mandatory Rule Check**

OIC referenced in Section 12 as the standard integration layer across all Oracle Fusion HCM implementations. ✅ PASS

**OI Items Closed — Final Confirmation**

| OI Item | Decision | Application |
|---|---|---|
| OI-W4-001 Hollywood Bets Learning Cloud | CLOSED (NO) | Hollywood Bets excluded from all Learning Cloud references; not mentioned in document |
| OI-W4-002 AI Learning Recommendations | CLOSED — platform capability with APPSolve enablement | Applied in Sections 1, 5.1, 8.2 using approved wording |
| OI-W4-003 Learning Communities | CLOSED — platform capability only | Section 7 includes social learning with explicit platform-only caveat |
| OI-W4-004 Learning Analytics | CLOSED — OLC tracking vs OAX analytics distinction required | Section 9 separates OLC tracking (Section 9.1) from OAX analytics (Section 9.2) with caveat and cross-reference to W3S1-006 |
| OI-W4-005 Content Provider Integrations | CLOSED — platform capability with APPSolve enablement | Section 12.1 uses approved wording from OI-W4-005 |
...
| Field | Value |
|---|---|
| **Extraction ID** | W3S1-004 |
| **Document title** | Oracle Fusion Learning Cloud — Capability Statement |
| **Version** | 1.1 Approved |
| **Date** | 2026-06-13 |
| **Sources used** | HIST-006 (Tier 3 — platform capability); HIST-015 (Tier 3 — methodology); HIST-016 (Tier 3 — reference corroboration); ORACLE_FACT_BASELINE Section 19 (Tier 1 — Mr Price confirmed implementation) |
| **Sections delivered** | 15 content sections (Sections 1–15) + Section 17 + Appendices A, B, C |
| **Open items at submission** | 0 — all 5 BU Lead decisions (OI-W4-001 through OI-W4-005) CLOSED before extraction |
| **Governance violations** | None |
| **Prohibited sources used** | None — CCBA excluded; SAA used as platform capability source only (not named); DFA not named; Redpath excluded; Hollywood Bets excluded for Learning Cloud per OI-W4-001 (NO) |
| **Key governance boundary** | Hollywood Bets is NOT a Learning Cloud reference in this document. Mr Price Group is the sole referenceable implementation. This must not be changed without new source documentation and explicit BU Lead approval to update ORACLE_FACT_BASELINE Section 19. |
| **Pre-tender checks (standing)** | PT-W4-001: Confirm Mr Price reference contact details are current before citing in specific tender; PT-W4-002: Confirm BEE certificate current (expires 2026-07-31); PT-W4-003: Confirm OPN annual revalidation current; PT-W4-004: Clarify whether client requires Oracle HCM Analytics for learning dashboards — this is a separate scope item not included in Oracle Learning Cloud |
| **Changes v1.0 to v1.1** | H-001 / CROSS-1: "APPSolve employs 50+ Senior Consultants and" removed from Section 10.1. Version updated to 1.1 Approved. approved_for_reuse set to Yes. Approved by BU Lead 2026-06-13. |

---

*W3S1-004-ORA-LearningCloud v1.1 Approved — 2026-06-13 — Hein Blignaut (BU Lead) — approved_for_reuse: Yes*

### Oracle Fusion Workforce Compensation Cloud

**Capability Statement | APPSolve | Oracle Business Unit**
*Document ID: W3S1-005-ORA-WorkforceCompensation | Version: 1.1 Approved | Wave 3*

---

#### Section 1: Statement of Capability

APPSolve implements Oracle Fusion Workforce Compensation Cloud as part of Oracle Fusion HCM programmes, enabling organisations to design, manage, and execute compensation strategies across the workforce — from annual merit and bonus cycles to manager-led review processes, total compensation statements, and integration with Oracle Performance Management.

APPSolve's Oracle Workforce Compensation delivery experience spans the Mining sector. APPSolve is currently implementing Oracle Workforce Compensation capabilities for a mining-sector client. Internal implementation experience across multiple Oracle HCM programmes confirms APPSolve's delivered capability in configuring and enabling the full Oracle Fusion Workforce Compensation module.

Compensation Planning, Merit Increase Management, Compensation Approval Workflows, and Compensation Budgeting are confirmed APPSolve implementation and configuration deliverables within every Oracle Fusion Workforce Compensation engagement.

A clear capability boundary applies throughout this document: Oracle Fusion Workforce Compensation Cloud delivers plan configuration, cycle management, approval workflows, budget tracking, and plan-level analytics. Advanced compensation dashboards, cross-module analytics, and executive workforce intelligence are delivered through Oracle HCM Analytics — a separately licensed and implemented Oracle product. This distinction is maintained in Section 9.

---

#### Section 2: Oracle Fusion Workforce Compensation Cloud — Module Overview

Oracle Fusion Workforce Compensation Cloud is Oracle's cloud-based compensation management solution, forming part of the Oracle Fusion Cloud HCM Suite. APPSolve configures and implements Oracle Fusion Workforce Compensation Cloud to enable organisations to manage compensation processes — including salary adjustments, merit increases, bonuses, variable pay, and long-term incentives — through structured, workflow-driven review cycles aligned to business objectives and budgetary controls.

The platform delivers five primary value outcomes that APPSolve configures as part of every Oracle Fusion Workforce Compensation implementation:

| Value Outcome | Description |
|---|---|
| **Strategic Compensation Alignment** | Align compensation strategies with organisational goals, ensuring financial incentives drive performance and business success. APPSolve configures compensation plan structures that reflect the client's compensation philosophy and performance culture. |
| **Structured Compensation Cycles** | Manage annual and ad hoc compensation review cycles — merit, bonus, variable pay, and promotion — through configurable worksheets, approval workflows, and budget controls |
| **Data-Driven Decision Making** | Provide managers and HR with real-time visibility of compensation budgets, allocation rates, and team distribution to support informed decisions during review cycles |
| **Pay Equity and Fairness** | Monitor pay equity across roles, grades, departments, and demographics to ensure internal fairness and support compliance with equitable pay principles |
| **Seamless HCM Integration** | Natively connects with Oracle Core HR, Performance Management, Goal Management, Talent Management, and Benefits — ensuring compensation decisions align with talent, performance, and career data |

---

#### Section 3: Compensation Plans and Programs

##### 3.1 Compensation Plan Types

APPSolve configures Oracle Fusion Workforce Compensation plan structures to reflect each client's compensation model. Oracle Fusion Workforce Compensation supports multiple plan types within a unified administration framework:

| Plan Type | Description | APPSolve delivery |
|---|---|---|
| **Salary Plans** | Merit-based salary adjustment plans — configurable by grade, band, performance rating, and position. Manages base pay increases, salary range compliance, and budget constraints | Standard implementation deliverable |
| **Bonus Plans** | Variable cash bonus programmes linked to individual, team, or organisational performance outcomes. Configurable eligibility, payout formulae, and budget pools | Standard implementation deliverable |
| **Long-Term Incentive Plans** | Extended incentive structures — including equity-based plans where applicable to the client's reward strategy | Platform capability — applicable to client compensation structure |
| **Individual Compensation Plans (ICPs)** | Standalone compensation elements managed outside formal review cycles — allowances, one-off payments, special recognition, or ad hoc adjustments | Standard implementation deliverable for clients with ICP requirements |
| **Variable Pay Plans** | Non-base pay compensation linked to performance metrics or business results — commissions, incentive pay, gainsharing | Standard implementation deliverable where applicable |

##### 3.2 Plan Configuration

APPSolve designs and configures the compensation plan framework in collaboration with the client HR and Reward teams during the Scope and Design phase. Key configuration elements include:

| Configuration element | Description |
|---|---|
| **Compensation components** | Define the elements within each plan — base salary, salary ranges, bonus targets, multipliers, and cap rules |
| **Eligibility rules** | Configure eligibility criteria by grade, job, department, location, employment type, and performance rating |
| **Budget configuration** | Set compensation budgets at segment level — department, division, grade band, or business unit — with real-time budget consumption tracking during the review cycle |
| **Rounding rules and minimum/maximum controls** | Enforce salary range compliance, compa-ratio guidelines, and market positioning during manager worksheets |
| **Currency and localisation** | Multi-currency support for organisations operating across multiple countries or payroll jurisdictions |

---

#### Section 4: Compensation Budgeting and Modelling

##### 4.1 Compensation Budget Management

APPSolve configures Oracle Fusion Workforce Compensation's budget management capabilities to give HR and Finance visibility of compensation spend from planning through to approval and payment.

| Budget Capability | Description |
|---|---|
| **Budget pools** | Configure budget pools at the plan, segment, or organisational level. Budgets may be expressed as percentages of eligible salary or as fixed monetary amounts |
| **Real-time budget tracking** | Managers view available budget, amounts allocated, and remaining balance in real time during the review cycle |
| **Budget alerts** | Configurable alerts when allocations exceed defined thresholds — supports early escalation before budget overruns occur |
| **Hierarchical budget roll-up** | Individual manager worksheet allocations aggregate upward through the management hierarchy, providing HR and Finance with an organisational view of compensation commitment |
| **Budget lock and approval gates** | Compensation cycle progression gates tied to budget approval workflows — ensures budget sign-off before manager worksheets open |

##### 4.2 What-If Modelling and Scenario Planning

Oracle Fusion Workforce Compensation provides modelling capabilities that support scenario testing before compensation decisions are finalised.

| Modelling Capability | Description |
|---|---|
| **What-if scenarios** | Model different compensation scenarios — for example, a 4% merit pool vs a 5% pool — and assess their impact on total payroll cost, budget consumption, and grade distribution before committing to a cycle |
| **Forecasting** | Project compensation spend across future periods based on planned headcount, current salary structures, and anticipated cycle parameters |
| **Compa-ratio and position-in-range analysis** | Assess distribution of employee pay relative to salary range midpoints, supporting market alignment and pay equity management |

---

#### Section 5: Compensation Review and Approval Workflows

##### 5.1 Manager Compensation Worksheets

APPSolve configures Oracle Fusion Workforce Compensation's worksheet functionality to enable managers to review and adjust compensation for their teams within a structured, controlled cycle.

| Worksheet Capability | Description |
|---|---|
| **Manager self-service worksheets** | Managers review their team's compensation details — current salary, performance rating, recommended increase, and budget allocation — in a single worksheet view |
| **Recommended compensation** | System-generated recommended increases based on configured merit matrices, performance ratings, compa-ratio guidelines, and budget rules |
| **Manager override** | Managers can adjust system recommendations within configured tolerances — subject to approval workflow |
| **Supporting data visibility** | Managers view relevant context: performance ratings, goal achievement, tenure, last increase date, and compa-ratio — within the worksheet |
| **Batch worksheet actions** | Managers can accept all recommendations or apply percentage adjustments to selected groups rather than managing employee by employee |
| **Worksheet submission** | Managers submit completed worksheets for approval, triggering the configured approval chain |

##### 5.2 Approval Workflows

| Workflow Capability | Description |
|---|---|
| **Multi-level approval chains** | Configurable approval hierarchies — direct manager, skip-level manager, HR Business Partner, Finance, and executive sign-off levels. APPSolve configures the approval chain to reflect the client's governance model |
| **Approval notifications** | Automated notifications to approvers when worksheets are submitted; escalation notifications for overdue approvals |
| **Conditional approval routing** | Route approvals to additional levels when specific conditions are met — for example, increases above a defined percentage threshold, promotions, or exceptions to salary range |
| **Audit trail** | Complete, auditable record of all compensation decisions — original recommendation, manager adjustment, approval history, timestamps, and approver notes |
| **Rejection and revision workflow** | Approvers can reject worksheets with comments; managers receive notifications and can revise before resubmitting |

---

#### Section 6: Merit-Based and Performance-Driven Compensation

##### 6.1 Merit Increase Management

Compensation Planning and Merit Increase Management are confirmed APPSolve implementation deliverables. APPSolve configures the merit matrix and performance linkage that drives compensation recommendations during annual and mid-year review cycles.

| Merit Capability | Description |
|---|---|
| **Merit matrix configuration** | APPSolve configures merit matrices linking performance ratings to recommended salary increase percentages, adjusted by compa-ratio and position in grade. Multiple matrices may be configured by employee category, grade band, or business unit |
| **Performance rating ingestion** | Performance ratings from Oracle Performance Management are automatically available in the compensation worksheet, eliminating manual data re-entry and ensuring decisions reflect current performance outcomes |
| **Eligibility control** | Employees who do not meet eligibility criteria — probationary, on performance plans, recently joined — are automatically excluded from merit increases per configured rules |
| **Merit increase modelling** | HR can model the aggregate cost of different merit matrix configurations before opening the cycle to managers |

##### 6.2 Pay-for-Performance Framework

| Capability | Description |
|---|---|
| **Performance-based recommendations** | Oracle Fusion Workforce Compensation generates compensation recommendations that directly reflect employee performance ratings, goal achievement scores, and competency assessments from Oracle Performance Management |
| **Differentiated compensation outcomes** | High performers receive meaningfully differentiated compensation recommendations relative to average and below-average performers, reinforcing the organisation's pay-for-performance culture |
| **Variable pay linkage** | Bonus and variable pay targets configured in alignment with performance outcomes, ensuring total compensation reflects individual and team contribution |

##### 6.3 Promotion and Pay Band Management

| Capability | Description |
|---|---|
| **Promotion compensation adjustments** | Salary adjustments associated with promotions processed within the compensation cycle or as standalone transactions |
| **Grade band compliance** | Salary range minimum, midpoint, and maximum controls enforced at the worksheet level — system alerts when proposed salaries fall outside configured range |
| **Market data integration** | Where clients provide market salary data, APPSolve can configure Oracle Workforce Compensation to display market reference points alongside internal pay, supporting market competitiveness analysis during reviews |

---

#### Section 7: Total Compensation Statements

APPSolve configures Oracle Fusion Workforce Compensation's Total Compensation Statement capability to provide employees with a comprehensive view of the full value of their employment package beyond base salary.

| Total Compensation Capability | Description |
|---|---|
| **Statement configuration** | APPSolve configures total compensation statement templates that combine cash and non-cash elements — base salary, bonuses, company contributions to retirement and medical aid, allowances, leave value, and any other elements the client wishes to present |
| **Employee self-service access** | Employees access their total compensation statement through the Oracle HCM self-service portal on any device, at any time |
| **Historical statement visibility** | Employees can view current and prior period total compensation statements, supporting transparency and reducing HR query volumes about historical pay packages |
| **Non-cash element visualisation** | Non-cash rewards — retirement fund contributions, medical aid employer contributions, company vehicle value — expressed in monetary terms so employees understand the full value of their package |
| **Engagement and retention support** | Compensation transparency through total compensation statements supports employee engagement and is a key tool for retention conversations during performance and development reviews |

---

#### Section 8: Employee and Manager Self-Service

##### 8.1 Employee Self-Service — Compensation

Oracle Fusion Workforce Compensation provides employees with self-service access to their compensation information, reducing HR administration and improving employee experience.

| Employee Self-Service Capability | Description |
|---|---|
| **Current compensation visibility** | Employees view their current base salary, salary grade, and position within their pay band |
| **Compensation history** | Historical salary changes, bonus awards, and increment records accessible in the employee self-service portal |
| **Total compensation statement** | Employees access current and historical total compensation statements (see Section 7) |
| **Bonus and incentive history** | History of variable pay awards accessible to the employee |
| **Mobile access** | Compensation self-service available through the Oracle HCM mobile application |

##### 8.2 Manager Self-Service — Compensation

| Manager Self-Service Capability | Description |
|---|---|
| **Team compensation view** | Managers view the compensation position of their direct reports — current salary, grade, compa-ratio, last increase date, and performance rating — from a single dashboard |
| **Worksheet management** | Managers access, complete, and submit compensation worksheets through the manager self-service portal |
| **Approval task management** | Managers acting as approvers receive and action compensation approval tasks through the Oracle Worklist or manager dashboard |
| **Budget visibility** | Managers view remaining budget for their team during the active compensation cycle |

---

#### Section 9: Compensation Analytics and Reporting — Capability Scope and Boundaries

A clear distinction must be maintained between Oracle Fusion Workforce Compensation built-in tracking and reporting capabilities and Oracle HCM Analytics (OAX) advanced analytics. This distinction is maintained in every APPSolve Oracle Workforce Compensation delivery.

##### 9.1 Oracle Fusion Workforce Compensation — Built-In Tracking and Analytics

The following capabilities are available within Oracle Fusion Workforce Compensation as part of the standard implementation scope:

| Built-In Capability | Description |
|---|---|
| **Compensation cycle status tracking** | Real-time visibility of cycle progress — worksheets submitted, pending, approved, and outstanding — at manager, HR, and organisational level |
| **Budget consumption tracking** | Budget allocated vs available by segment, department, or plan pool — available in real time during the active cycle |
| **Compa-ratio and position-in-range reporting** | Distribution of employee pay relative to salary range midpoints — available within the compensation worksheet and standard plan analytics |
| **Approval status tracking** | Status of approval workflows — submitted, approved, escalated, pending — with drill-down to individual employee level |
| **Merit distribution analysis** | Distribution of merit increase recommendations by performance rating, grade, or department — available within the cycle to support calibration |
| **Pay equity monitoring** | Comparative analysis of compensation levels across roles, grades, departments, and demographics to support pay equity assessment during review cycles |
| **Workforce compensation reports** | Standard delivered reports for compensation cycle outcomes — increase summaries, budget reconciliation, approval history — available through Oracle Transactional Business Intelligence (OTBI) |

**Standard implementation note:** Oracle Fusion Workforce Compensation includes standard reporting through OTBI and cycle-level analytics within the plan administration interface. These capabilities provide the visibility required to manage a compensation cycle from planning through to approval.

##### 9.2 Oracle HCM Analytics — Advanced Compensation Analytics

Advanced compensation analytics — including executive dashboards, multi-period trend analysis, cross-module people intelligence, and predictive analytics — are delivered through Oracle HCM Analytics (OAX), which is a separately licensed and separately implemented Oracle product.

| OAX Compensation Analytics Capability | Description |
|---|---|
| **Pre-built compensation dashboards** | Executive dashboards covering compensation spend, merit distribution, pay equity trends, retention risk by pay band, and total reward cost |
| **Multi-period trend analysis** | Year-on-year compensation spend trends, merit pool utilisation, and headcount cost evolution |
| **Cross-module analytics** | Connecting compensation data with performance outcomes, attrition risk, talent mobility, and workforce composition for holistic people analytics |
| **Predictive analytics** | Predictive models for retention risk, compensation market competitiveness, and pay equity gap closure |
| **Drill-down and slice-and-dice** | Ad hoc analysis of compensation data across any combination of dimensions — grade, tenure, performance, location, department |

Clients requiring advanced compensation dashboards and analytics should reference the APPSolve Oracle HCM Analytics and Workforce Intelligence capability statement (W3S1-006). APPSolve supports end-to-end Oracle HCM Analytics implementations where advanced compensation reporting is a delivery requirement.

*Approved positioning: "Advanced compensation analytics and dashboarding capabilities are typically delivered through Oracle HCM Analytics rather than Oracle Fusion Workforce Compensation itself."*

---

#### Section 10: APPSolve Delivery Capability

##### 10.1 Oracle Workforce Compensation Practice

APPSolve's Oracle Business Unit includes HCM-certified consultants with implementation experience in Oracle Fusion Workforce Compensation Cloud. APPSolve holds Oracle Level 1 Partner status.

APPSolve is currently implementing Oracle Workforce Compensation capabilities for a mining-sector client, confirming active delivery experience in compensation plan configuration, merit cycle management, and compensation approval workflow design. Internal delivery experience across multiple Oracle HCM programmes validates APPSolve's compensation configuration and implementation capability across the Mining sector.

##### 10.2 Compensation Delivery Approach

APPSolve applies a structured, design-first approach to Oracle Fusion Workforce Compensation implementations. The compensation plan architecture — encompassing plan types, budget structures, eligibility rules, approval workflows, and merit matrices — is designed and validated before configuration begins.

| Delivery Principle | Description |
|---|---|
| **Compensation philosophy alignment** | APPSolve engages HR and Reward leadership early in the project to understand the client's compensation philosophy, existing cycle calendar, and organisational governance before designing plan structures |
| **Plan design before build** | Compensation plan architecture is documented, reviewed, and signed off by the client before configuration begins. Changes to the plan design after configuration starts increase delivery risk and timeline. |
| **Merit matrix design** | APPSolve facilitates merit matrix design workshops with HR and Reward teams, ensuring the matrix reflects the client's performance culture and budget parameters |
| **Approval workflow governance** | Approval chain design is confirmed with HR, Finance, and business stakeholders during Scope and Design. Approval hierarchies must reflect the current organisational structure and delegation of authority |
| **Budget model configuration** | Budget model — percentage of eligible salary vs fixed pools — is confirmed with Finance before implementation. APPSolve configures the budget structure to integrate with the client's existing financial planning and reporting framework |
| **Skills transfer focus** | APPSolve trains client Reward, HR, and system administrator teams to own and manage annual compensation cycles independently after go-live, including worksheet opening, cycle monitoring, approval management, and year-end close |

##### 10.3 Resource and Delivery Model

| Resource Type | Role |
|---|---|
| HCM Principal Consultant | Design authority; compensation plan governance; client engagement leadership |
| HCM Senior Functional Consultant | Compensation configuration; plan build; testing; UAT support |
| HCM Technical Consultant | OTBI compensation reports; HDL data templates; OIC integration (if applicable) |
| Project Manager | Delivery governance; timeline management; stakeholder coordination |

Implementation is conducted remotely with on-site presence for compensation design workshops and UAT where required. APPSolve's hybrid delivery model is applied as standard.

---

#### Section 11: Implementation References

##### 11.1 Current Oracle Workforce Compensation Implementation — Mining Sector

| Attribute | Detail |
|---|---|
| **Industry** | Mining |
| **Product** | Oracle Fusion Workforce Compensation Cloud |
| **APPSolve role** | Currently implementing Oracle Workforce Compensation as part of a broader Oracle Fusion HCM programme |
| **Status** | Active implementation — not yet live |
| **Citation rule** | May be cited as active pipeline evidence only. Must not be cited as a completed implementation. Client name must not be disclosed. |
| **Approved framing** | *"APPSolve is currently implementing Oracle Workforce Compensation capabilities for a mining-sector client."* |

##### 11.2 APPSolve Oracle Workforce Compensation Delivery Experience — Internal

APPSolve's Oracle Fusion Workforce Compensation implementation experience extends across multiple Oracle HCM programmes, spanning the Mining sector. This experience provides depth of delivery knowledge across compensation plan design, merit matrix configuration, approval workflow governance, and total compensation statement delivery. Reference clients for these implementations are not currently approved for public or tender citation. Internal evidence available to support internal capability assessment.

---

#### Section 12: Integration Architecture

Oracle Integration Cloud (OIC) is APPSolve's standard integration layer in every Oracle Fusion HCM implementation, including Oracle Fusion Workforce Compensation Cloud. This applies without exception.

##### 12.1 Standard Workforce Compensation Integration Points

| Integration | Method | Description |
|---|---|---|
| **Oracle Fusion Core HR** | Native Oracle integration | Employee records, grade, position, salary basis, and organisational hierarchy from Core HR feed directly into Workforce Compensation plans and worksheets. Employee eligibility is determined from Core HR data. |
| **Oracle Performance Management** | Native Oracle integration | Performance ratings from completed performance review cycles are automatically available in the compensation worksheet. APPSolve configures the linkage during both module implementations. |
| **Oracle Goal Management** | Native Oracle integration | Goal achievement scores available as supporting data in compensation worksheets, supporting goal-aligned merit decisions |
| **Oracle Talent Management** | Native Oracle integration | Talent profile data — potential ratings, succession readiness, risk of loss — available in the compensation worksheet as context for differentiated compensation decisions |
| **Oracle Benefits** | Native Oracle integration | Compensation changes trigger benefit eligibility re-evaluation where salary band is a benefit eligibility criterion |
| **Oracle Payroll / Third-Party Payroll** | OIC / HCM Extracts | Approved compensation changes flow to Oracle Payroll (where deployed) or to the third-party payroll system via OIC or HCM Extracts. APPSolve configures the payroll interface as a standard integration component where payroll is in scope. |
| **Finance / Cost Centre Integration** | OIC | Compensation budget commitments and actual payments flow to the client's financial planning system (Oracle Fusion Finance or third-party) via OIC where required |
| **SETA / Salary Cost Planning** | HCM Extracts / OIC | Salary cost data extractable for SETA reporting, WSP/ATR submissions, and financial payroll cost planning |

##### 12.2 HCM Data Loader and REST API Support

Oracle Fusion HCM provides comprehensive data import and API capabilities for Workforce Compensation administration:

- **HDL templates** — APPSolve configures HDL templates for bulk loading of employee salary data, compensation grade steps, and salary structure configurations
- **REST APIs** — Oracle Workforce Compensation exposes REST APIs for integration with third-party HR systems, HRIS reporting tools, and custom portal applications
- **OTBI and HCM Extracts** — Standard reporting and extract tools available for compensation cycle data, salary history, and pay equity analysis

---

#### Section 13: Implementation Approach

##### 13.1 Workforce Compensation within the Oracle Fusion HCM Programme

Oracle Fusion Workforce Compensation is implemented following Oracle Core HR and, where applicable, after Oracle Performance Management — because merit matrices and performance-linked compensation recommendations require the performance framework to be in place.

| Phase | Content | Workforce Compensation Dependency |
|---|---|---|
| Phase 1 | Core HCM — Global HR, Absence Management, Self-Service | Foundation — employee records, grade structure, salary basis, and HR hierarchy required by Compensation |
| Phase 2 | Talent Management, Goal Management, Performance Management | Performance ratings and goal achievement scores required for merit matrix and pay-for-performance configuration |
| **Phase 3 / 4** | **Oracle Fusion Workforce Compensation** | **Requires Phase 1 (employee data, grades, salary basis) and Phase 2 (performance ratings) for full merit and performance-linked configuration** |
| Phase 4+ | Recruiting, Learning, Help Desk, HCM Analytics | Parallel or subsequent |

##### 13.2 OUM Delivery Phases — Workforce Compensation

APPSolve applies the Oracle Unified Methodology (OUM) across all Oracle Fusion HCM implementations, including Workforce Compensation:

| OUM Phase | Workforce Compensation Activities |
|---|---|
| **Mobilize** | Project charter; compensation scope confirmation; compensation philosophy workshops; plan type and eligibility inventory; cycle calendar confirmation |
| **Scope and Design** | Compensation plan architecture design; budget model design; merit matrix design; eligibility rule specification; approval workflow design; integration requirements (payroll, Finance); OTBI report specification |
| **Prototype** | CRP1 — Plan configuration walk-through with Reward/HR team; CRP2 — Refined configuration including end-to-end cycle simulation with sample data; worksheet review; approval workflow testing |
| **Build** | Full plan build; budget configuration; approval workflow build; OTBI report build; integration build (payroll/Finance via OIC where applicable); training material development; administrator skills transfer sessions |
| **Deploy** | Production plan build; data verification (salary basis, grade, eligibility); UAT including a simulated compensation cycle; administrator and manager training; go-live support |
| **Post Go-Live** | Hyper-care (full team approximately 3 months); first live cycle support (APPSolve supports the client through the first full compensation cycle end-to-end); steady-state handover |

*Note: APPSolve's standard practice is to support the client through their first live compensation cycle after go-live. Compensation cycle execution is a critical operational event; the first live cycle carries heightened risk and benefits from consultant guidance on budget management, worksheet monitoring, approval escalation, and year-end close procedures.*
...
| Risk ID | Risk | Likelihood | Impact | Mitigation |
|---|---|---|---|---|
| R-W3-005-001 | Compensation plan design not completed before build — client HR and Reward teams are unable to make plan design decisions during Scope and Design phase, delaying configuration start | Medium | High | Plan design workshop facilitated by APPSolve during Scope and Design. Clear sign-off gate on plan design before configuration begins. Early engagement of Reward/Finance stakeholders during project mobilisation. |
| R-W3-005-002 | Performance rating data not available at compensation cycle time — if Performance Management is not implemented or not yet completed a cycle, merit matrix recommendations cannot be generated | Medium | Medium | Confirm Performance Management go-live timeline relative to Compensation cycle calendar during Scope and Design. Where Performance Management is not yet live, configure a manual performance rating input mechanism for the first cycle. |
| R-W3-005-003 | Client compensation analytics expectations exceed Oracle Fusion Workforce Compensation built-in capability — client expects pre-built executive dashboards that are not included in OWC and require Oracle HCM Analytics (OAX) | Medium | Medium | Analytics boundary established at project initiation. Clients requiring advanced dashboards directed to Oracle HCM Analytics (W3S1-006). |
| R-W3-005-004 | First live compensation cycle support — compensation cycles are high-stakes operational events; errors in budget configuration, worksheet distribution, or approval routing discovered during the live cycle cause business disruption and employee trust issues | High | High | APPSolve supports the client through the first live cycle as a standard hyper-care deliverable. Pre-cycle testing checklist: budget verification, eligibility check, worksheet population test, approval routing test, manager notification test. |
| R-W3-005-005 | Payroll integration timing — approved compensation changes must reach the payroll system before the payroll processing cutoff date; delays in the approval workflow can miss payroll cutoffs | Medium | High | Payroll integration design includes defined approval close-down dates aligned to the payroll calendar. Automated escalation for outstanding approvals approaching the payroll cutoff. |
...
| Assumption ID | Assumption | Risk if incorrect |
|---|---|---|
| A-W5-001 | Workforce Compensation is configured as a global function — one compensation framework serves all in-scope territories with common business rules | If territories require separate compensation frameworks with different rules, scope increases materially |
| A-W5-002 | The client's compensation plan structure (plan types, eligibility rules, budget model, merit matrix) will be confirmed in writing before configuration begins | Unresolved plan design decisions after build start cause rework |
| A-W5-003 | Performance ratings from Oracle Performance Management are available in the system before the compensation cycle opens. Where not available, a manual input mechanism must be agreed during Scope and Design | Without performance ratings, merit matrix recommendations cannot be generated |
| A-W5-004 | No data take-on is required for Workforce Compensation — the current salary structure and grade configuration from Oracle Core HR provides the foundation | Historical compensation data migration requires separate scoping and effort |
| A-W5-005 | The framework will be enabled and configured by APPSolve; the development and maintenance of individual compensation plans and annual cycles after go-live is the responsibility of the client's HR and Reward administrators | Client dependency on APPSolve for ongoing cycle management increases operating cost |
| A-W5-006 | Total compensation statement design (elements to include, layout, branding) will be confirmed by the client during Scope and Design | Unconfirmed statement design delays configuration and testing |
| A-W5-007 | A maximum of 3 OTBI compensation reports are included in the standard implementation scope; additional custom reports require separate scoping | Larger reporting libraries increase build and testing effort |
| A-W5-008 | Payroll integration (OIC-based or HCM Extracts) is a separate integration deliverable; the method and scope is confirmed during Scope and Design | Where payroll integration method is undetermined at project start, integration design effort cannot be estimated |
| A-W5-009 | Market salary data incorporation (where required) will be provided by the client in a format compatible with Oracle Fusion HCM import templates | Non-standard formats require additional data transformation work |
| A-W5-010 | APPSolve will support the client through the first live compensation cycle as part of the hyper-care period — this is a standard delivery component and is included in the implementation scope | Exclusion of first-cycle support from scope creates high delivery risk for the client's inaugural compensation event |
...
| Field | Value |
|---|---|
| **Document ID** | W3S1-005-ORA-WorkforceCompensation |
| **Version** | 1.1 Approved |
| **Created** | 2026-06-13 |
| **Created by** | Claude (AI — Wave 3 W3S1-005 extraction) |
| **Status** | Approved — BU Lead approved 2026-06-13; all amendments applied (G-001, G-002, G-003, CROSS-1) |
| **Approved for reuse** | Yes — BU Lead approved 2026-06-13 |
| **Approved by** | Hein Blignaut (BU Lead) |
| **Approval date** | 2026-06-13 |
| **Open items at submission** | None — all 5 OI items (OI-W5-001 through OI-W5-005) CLOSED before extraction |
| **BU Lead** | Hein Blignaut |
...
| Section | Content type | Primary source | Governance classification |
|---|---|---|---|
| Section 1 | Implementation evidence | ORACLE_FACT_BASELINE Section 19 (DFA — Workforce Compensation confirmed, Rule 21.4); ORACLE_FACT_BASELINE Section 21.5 (Redpath — active scope) | Tier 2 internal (DFA); Active pipeline (Redpath) |
| Section 2 | Module overview | HIST-006 (SAA, paragraphs 181–188) | Tier 3 — Platform Capability; reframed as APPSolve capability |
| Section 3.1 | Plan types | HIST-006 (SAA, paragraphs 195–199) | Tier 3 — Platform Capability |
| Section 3.2 | Plan configuration | HIST-006 (SAA, paragraphs 199–204) | Tier 3 — Platform Capability |
| Section 4.1 | Budget management | HIST-006 (SAA, paragraphs 202–204, 876) | Tier 3 — Platform Capability |
| Section 4.2 | What-if modelling | HIST-006 (SAA, paragraphs 203–204, 877) | Tier 3 — Platform Capability |
| Section 5.1 | Manager worksheets | HIST-006 (SAA, paragraphs 207–209) | Tier 3 — Platform Capability |
| Section 5.2 | Approval workflows | HIST-006 (SAA, paragraphs 208–209) | Tier 3 — Platform Capability |
| Section 6.1 | Merit increase | HIST-006 (SAA, paragraphs 216–218) | Tier 3 — Platform Capability; BU Lead confirmed APPSolve delivery |
| Section 6.2 | Pay-for-performance | HIST-006 (SAA, paragraphs 217–218) | Tier 3 — Platform Capability |
| Section 6.3 | Promotion / pay band | HIST-006 (SAA, paragraph 225) | Tier 3 — Platform Capability |
| Section 7 | Total Compensation Statements | HIST-006 (SAA, paragraphs 210–213) | Tier 3 — Platform Capability |
| Section 8.1 | Employee self-service | HIST-006 (SAA, paragraphs 234–235) | Tier 3 — Platform Capability |
| Section 8.2 | Manager self-service | HIST-006 (SAA, paragraphs 207–209) | Tier 3 — Platform Capability |
| Section 9.1 | OWC built-in analytics | HIST-006 (SAA, paragraphs 229–231) | Tier 3 — Platform Capability; OWC/OAX boundary applied |
| Section 9.2 | HCM Analytics (OAX) | HIST-006 (SAA, paragraphs 884–888) | Cross-reference to W3S1-006 |
| Section 10 | Delivery capability | ORACLE_FACT_BASELINE; HIST-015 (methodology) | Internal evidence; methodology |
| Section 11.1 | Mining-sector pipeline reference | ORACLE_FACT_BASELINE Section 21.5; OI-W5-002 BU Lead decision | Active pipeline — approved framing applied |
| Section 11.2 | Internal delivery experience | ORACLE_FACT_BASELINE Section 19 (DFA, Rule 21.4) | Rule 21.4 — never named |
| Section 12 | OIC integration | ORACLE_FACT_BASELINE Section 7 (mandatory); HIST-006 (SAA, paragraph 221) | Mandatory standard |
| Section 13 | Implementation approach | ORACLE_FACT_BASELINE Section 17 (OUM); HIST-015 (Phase 1.5 sequencing) | Delivery methodology |
| Section 14 | Risk register | SVR-W3S1-005 risk analysis | Internal governance |
| Section 15 | Assumptions register | HIST-015 (paragraphs 525–528); HIST-006 (SAA, delivery context) | Source-validated across 2 APPSolve delivery documents |

**Prohibited sources — confirmed excluded:**
- CCBA (HIST-014) — PROHIBITED; not used for any content (extraction support only during SVR)
- SAA — not named as client or reference; platform capability source only (reframed)
- Hollywood Bets — NOT cited for Workforce Compensation; excluded — Compensation absent from HB BOM
- DFA — not named; internal corroboration only (Rule 21.4); never referenced in output
- Redpath Mining — cited using approved pipeline framing only; not named; no completed implementation claim
- Aviation sector — not referenced anywhere in this document (Rule 21.1)
...
|---|---|---|
| **21.1 Aviation PROHIBITED** | No aviation, airline, SAA, or South African Airways references as client or reference — confirmed absent | ✅ PASS |
| **21.1 Approved sectors** | Mining (pipeline reference — not named); Retail (internal delivery — not named); Professional Services (supported sector not cited in this document) | ✅ PASS |
...
| **21.2 Implementation vs Support distinction** | No support-only claims presented as implementation. Pipeline framing used for Redpath (active, not live). Internal evidence framing used for DFA (implemented — not named). | ✅ PASS |
| **21.3 Opportunity Marketplace** | Not referenced in Workforce Compensation context | ✅ PASS |
| **21.4 DFA — never named** | DFA not named anywhere in the document. Internal delivery experience referenced only in aggregate (Section 11.2) without client identification. | ✅ PASS |
| **21.5 Redpath — not used as completed implementation** | Redpath not named; cited only as "a mining-sector client" currently implementing; "not yet live" framing explicitly used in Section 11.1 citation rules | ✅ PASS |
| **CCBA — never named** | CCBA not referenced anywhere in the document | ✅ PASS |
| **Hollywood Bets — not cited for Workforce Compensation** | Hollywood Bets excluded from all Workforce Compensation references. HB BOM confirmed absent of Workforce Compensation Cloud Service. HB not mentioned in any context in this document. | ✅ PASS |
...
| "over 22 years" | Absent — not cited in this document | ✅ |
| "BEE Level 2" | Absent — BEE not cited in this capability statement | ✅ |
| "Oracle does X" (Oracle framing) | Absent — all claims framed as APPSolve implementing/configuring/enabling X using Oracle Fusion Workforce Compensation Cloud | ✅ |
| Analytics overstatement — OWC dashboards | Section 9 clearly separates OWC built-in tracking from OAX advanced analytics; standard advisory note included | ✅ |
| Redpath Mining as completed implementation | Section 11.1 explicitly states "Active implementation — not yet live"; approved framing "currently implementing" used | ✅ |
| Hollywood Bets as Workforce Compensation reference | Absent | ✅ |
| "Retail and Mining sectors" | Absent — amended to "Mining sector" per BU Lead G-001 2026-06-13 | ✅ |
...
| OI Item | Decision | Application |
|---|---|---|
| OI-W5-001 Reference hierarchy | CLOSED (NO referenceable client) | Section 11 uses pipeline framing (Redpath) and internal delivery breadth framing; no named Tier 1 reference |
| OI-W5-002 Redpath pipeline citation | CLOSED (APPROVED) | Section 1 and Section 11.1 use approved framing: "currently implementing Oracle Workforce Compensation for a mining-sector client" |
| OI-W5-003 DFA Compensation scope | CLOSED (CONFIRMED) | ORACLE_FACT_BASELINE Section 19 updated; DFA internal corroboration referenced in Section 11.2 without naming |
| OI-W5-004 Analytics boundary | CLOSED — Conservative separation applied | Section 9 separates OWC built-in (Section 9.1) from OAX analytics (Section 9.2); cross-reference to W3S1-006 |
| OI-W5-005 Afrocentric status | CLOSED — Methodology use only | Afrocentric used for delivery assumptions (Section 15) and implementation approach (Section 13); not cited as implementation evidence |
...
| Field | Value |
|---|---|
| **Extraction ID** | W3S1-005 |
| **Document title** | Oracle Fusion Workforce Compensation Cloud — Capability Statement |
| **Version** | 1.1 Approved |
| **Date** | 2026-06-13 |
| **Sources used** | HIST-006 (Tier 3 — platform capability); HIST-015 (Tier 3 — methodology and assumptions); ORACLE_FACT_BASELINE Section 19 (DFA — Tier 2 internal, Rule 21.4; Redpath — active pipeline, Rule 21.5) |
| **Sections delivered** | 15 content sections (Sections 1–15) + Section 17 + Appendices A, B, C |
| **Open items at submission** | 0 — all 5 BU Lead decisions (OI-W5-001 through OI-W5-005) CLOSED before or during extraction |
| **Governance violations** | None |
| **Prohibited sources used** | None — CCBA excluded (SVR use only); SAA used as platform capability source only (not named); DFA not named; Redpath not named; Hollywood Bets excluded from Workforce Compensation entirely |
| **Key governance boundary** | No named Tier 1 referenceable client for Workforce Compensation. Redpath Mining approved as anonymous mining-sector pipeline citation only. This must not be changed without new source documentation and explicit BU Lead approval. If Redpath goes live and is approved as referenceable, Section 11 should be updated to promote them to Tier 1. |
| **ORACLE_FACT_BASELINE updates** | Section 19 DFA row updated (Workforce Compensation added — OI-W5-003); Section 21.4 approved fact updated |
| **Pre-tender checks (standing)** | PT-W5-001: W3S1-005 has no publicly referenceable Tier 1 Workforce Compensation implementation. This document may be used for capability narrative only. Do not make implementation claims beyond the approved Redpath pipeline framing without BU Lead approval. In competitive tenders requiring named implementation evidence for Workforce Compensation, flag to BU Lead before submission. PT-W5-002: Confirm Redpath Mining pipeline reference is still active and using the standard framing before citing; PT-W5-003: Confirm OPN annual revalidation current; PT-W5-004: Confirm BEE certificate current (expires 2026-07-31) |
| **Changes v1.0 to v1.1** | G-001: Section 1 and Section 10.1 "Retail and Mining sectors" amended to "Mining sector" per BU Lead 2026-06-13. G-002 / CROSS-1: "APPSolve employs 50+ Senior Consultants and" removed from Section 10.1. G-003: PT-W5-001 pre-tender check strengthened. Version updated to 1.1 Approved. approved_for_reuse set to Yes. Approved by BU Lead 2026-06-13. |

---

*W3S1-005-ORA-WorkforceCompensation v1.1 Approved — 2026-06-13 — Hein Blignaut (BU Lead) — approved_for_reuse: Yes*
...
### Oracle AI-Based Skills Intelligence

**Capability Statement | APPSolve | Oracle Business Unit**
*Document ID: W4-AI-002-ORA-AISkills | Version: 1.0 | Wave 4 | Approved 2026-06-14*

---

#### Section 1: Statement of Capability

APPSolve configures and implements Oracle AI-Based Skills Intelligence within Oracle Fusion HCM — Oracle's embedded artificial intelligence framework for dynamic skills profile management, AI-powered talent matching, and data-driven career development.

Oracle AI Skills is a standard capability within the Oracle HCM Cloud platform, enabling organisations to build and maintain dynamic, continuously updated skills taxonomies for every employee. APPSolve delivers AI Skills as an integrated component of Oracle Fusion HCM Talent Management implementations.

> **Confirmed implementation:** Oracle AI-Based Skills was confirmed as a delivered component of the Hollywood Bets Oracle Fusion HCM Phase 4 (Talent Management) implementation (BU Lead decision 2026-06-14).

| Capability Area | Coverage | APPSolve Positioning |
|---|---|---|
| **Dynamic Skills Profiles** | AI-generated and maintained employee skills profiles — inferred from job history, performance, learning, and role data | **Confirmed delivery capability** — AI skills profile configuration within Oracle HCM |
| **Skills Gap Analysis** | Automated identification of skills gaps against role requirements and career targets | **Confirmed delivery capability** — organisation-wide skills gap visibility |
| **AI-Powered Job Recommendations** | Oracle AI suggests internal opportunities, gigs, and career pathways based on skills profiles | **Confirmed delivery capability** — talent marketplace recommendations within HCM |
| **Skills Taxonomy Management** | Configuration of skills libraries, proficiency levels, and role-to-skill mappings | **Confirmed delivery capability** — APPSolve configures Oracle's skills taxonomy to client requirements |
| **Manager Talent Intelligence** | Aggregated team skills view for managers — identify team-level gaps, succession risks, and development priorities | **Confirmed delivery capability** — manager analytics within Oracle Talent framework |
| **Learning Integration** | AI Skills aligned with Oracle Learning Cloud (W3S1-004) for personalised learning pathway recommendations | **Confirmed delivery capability** — native integration within Oracle HCM suite |

---

#### Section 2: Product Architecture

##### 2.1 Oracle AI Skills Integration within Fusion HCM

Oracle AI Skills operates as a native intelligence layer within Oracle Fusion HCM. It requires no separate middleware or external AI platform.

```
Oracle Fusion HCM Data Sources
  ├── Global HR — job histories, roles, assignments (W3S1-001)
  ├── Performance Management — goals, ratings, competencies (W3S1-002)
  ├── Learning Cloud — completed courses, certificates (W3S1-004)
  ├── Recruiting — job profiles, requisition requirements (W3S1-003)
  └── Talent Review — potential/performance calibration (W3S1-002)
         │
         ▼
Oracle AI Skills Engine (embedded)
  ├── Skills inference — derive skills from activity data
  ├── Skills taxonomy — Oracle global skills library + client configuration
  ├── Gap analysis — role vs. actual skills comparison
  └── Recommendation engine — career paths, opportunities, learning
         │
         ▼
Oracle HCM Employee Experience
  ├── Employee: My Skills profile, career recommendations, learning suggestions
  ├── Manager: Team skills dashboard, talent risk identification
  └── HR: Organisation-wide skills analytics, workforce planning inputs
```

##### 2.2 Relationship to Oracle Talent Management Suite (W3S1-002)

Oracle AI Skills is a sub-module within the Oracle Talent Management Suite. W3S1-002 covers the broader Talent Management Suite (Performance, Goals, Talent Review, Career Development). W4-AI-002 specifically addresses the AI intelligence layer within that suite — extractable as a standalone capability where AI-specific tender requirements arise.
...
|---|---|---|---|---|
| Hollywood Bets V5.0 Accepted Proposal | HIST-007 | Tier 1 Confirmed Delivery | Phase 4 Talent Management — AI Skills confirmed as deliverable (BU Lead 2026-06-14) | Account manager approval at each tender submission |
| ORACLE_FACT_BASELINE Section 4.1 | Internal reference | Platform capability confirmation | "AI-Based Skills | SAA Section 2 | confirmed module" | Internal governance reference only — not an evidence source in its own right |
| SAA Oracle Fusion HCM RFP Response | HIST-006 | Tier 2 Platform Capability (internal only) | Section 2 — AI-Based Skills listed as module | **SAA NEVER NAMED — Rule 21.1 (Aviation PROHIBITED)** |
...
| **Primary Evidence** | Hollywood Bets Phase 4 Talent Management — AI Skills confirmed as deliverable (BU Lead decision 2026-06-14; HIST-007) |
| **Corroborative Evidence** | HIST-006 (SAA — internal only); ORACLE_FACT_BASELINE Section 4.1 |
...
| **Sector** | Retail / Gaming (Hollywood Bets); applicable across all Oracle HCM sectors |
...
> "APPSolve configures and implements Oracle AI-Based Skills Intelligence within Oracle Fusion HCM, enabling organisations to build dynamic employee skills profiles, identify skills gaps, and provide AI-powered career development recommendations."

> "APPSolve has delivered Oracle AI Skills as an integrated component of Oracle Fusion HCM Talent Management implementations, providing organisations with organisation-wide skills visibility and AI-driven talent development capabilities."

> "Oracle's embedded AI skills intelligence, configured by APPSolve, enables organisations to move from static, manually maintained skills records to dynamically inferred, AI-maintained skills profiles that improve talent decisions, succession planning, and learning investment."

##### Prohibited Wording

- Do NOT reference SAA as a client, example, or implementation (Rule 21.1)
- Do NOT reference CCBA as a client or example (HIST-014)
- Do NOT reference DFA as a client or example (Rule 21.4)
- Do NOT describe Oracle AI Skills as a standalone AI product separate from Oracle HCM — it is embedded within the Oracle HCM Cloud platform
- Do NOT conflate Oracle AI Skills with Oracle Digital Assistant (ODA) — AI Skills manages skills intelligence; ODA is a conversational chatbot
- Do NOT conflate Oracle AI Skills with Oracle Grow — Grow is a talent marketplace/gig platform; AI Skills is the intelligence layer that powers recommendations
- Do NOT describe APPSolve as an AI developer or AI platform vendor — APPSolve configures Oracle's embedded AI capabilities within Oracle HCM implementations
...
- [ ] **PT-W4A2-001:** Hollywood Bets account manager approval obtained for this specific tender submission
- [ ] **PT-W4A2-002:** Client is NOT aviation sector — if aviation, Rule 21.1 applies
- [ ] **PT-W4A2-003:** Confirm tender scope aligns with AI Skills (not general AI or ODA) — this statement covers embedded Oracle HCM AI intelligence only
- [ ] **PT-W4A2-004:** Confirm HB Phase 4 AI Skills deliverables match the use cases being claimed (skills profiles, gap analysis, recommendations)
- [ ] **PT-W4A2-005:** BEE certificate validity confirmed (expires 2026-07-31)
...
|---|---|---|---|
| **Hollywood Bets** | Referenceable — pending account manager approval | Named reference for Oracle AI Skills (BU Lead confirmed AI Skills in HB Phase 4 scope) | Account manager approval required at each tender. No signed letter in KB. |
| SAA | NEVER NAMED | Internal corroboration only | **Rule 21.1 — Aviation PROHIBITED permanently** |
...
|---|---|---|
| **Oracle AI Skills** | THIS STATEMENT | AI intelligence layer within Oracle HCM — dynamic skills profiles, gap analysis, career recommendations |
| **Oracle Talent Management (W3S1-002)** | Parent suite | AI Skills is a sub-module of Oracle Talent. W3S1-002 is the parent capability statement. Use AI Skills statement when AI-specific tender questions arise. |
| **Oracle Digital Assistant (W4-AI-001)** | Different product | ODA is conversational chatbot UI. AI Skills is intelligent data. Do NOT conflate. |
| **Oracle Grow** | Related but distinct | Oracle Grow is a talent marketplace/gig platform. AI Skills provides the intelligence that powers Grow recommendations. Do NOT conflate the platforms. |
| **Oracle Learning Cloud (W3S1-004)** | Integration | AI Skills recommends learning courses. Learning Cloud delivers them. They are integrated but distinct. |
| **Oracle Workforce Compensation (W3S1-005)** | Related | Skills data can inform compensation benchmarking. Do NOT conflate AI Skills with Compensation. |
...
| **BU Lead Decision** | W4-AI-002 Oracle AI Skills — Confirmed delivery (HB Phase 4); eligible for Wave 4 extraction (BU Lead decision 2026-06-14) |
...
| **Next Action** | Approved 2026-06-14. Apply pre-tender validation checks (PT-W4A2-001 through PT-W4A2-005) before use in any tender. |
| **Promotion Requirement** | BU Lead set approved_for_reuse: Yes (Hein Blignaut, 2026-06-14). Wave 4 promotion complete. |

---

*W4-AI-002-ORA-AISkills.md v1.0 — Approved 2026-06-14 by Hein Blignaut (BU Lead). approved_for_reuse: Yes.*
...
<!-- GOVERNANCE -->
<!-- GOV: AM-W4E3-001 ACTIVE — KPMG must NOT be named; anonymous reference only until signed letter registered -->

### Oracle Fusion Cloud Capability Statement

#### Section 1 — Oracle Fusion Platform Overview

Oracle Fusion is a suite of enterprise business applications designed to streamline and modernise enterprise processes. It integrates financial management, human capital management, supply chain, procurement, customer relationship management, and governance functions into a unified, cloud-native platform.

**Key platform characteristics:**

| Characteristic | Description |
|---|---|
| Modular Architecture | Organisations implement individual applications or the full suite, scaling as requirements evolve |
| Cloud-Native (SaaS) | Platform delivered over the internet, eliminating on-premises hardware requirements |
| Integrated Suite | Works seamlessly across all Fusion modules and with existing Oracle investments (EBS, PeopleSoft, JD Edwards) |
| Advanced Analytics | Embedded business intelligence and real-time analytics across all modules |
| User Experience | Role-based dashboards, personalised views, and mobile access for all devices |
| Global Capabilities | Multi-currency, multi-language, and multi-GAAP support for multinational operations |
| Security and Compliance | Built-in security controls, data encryption, and regulatory compliance tooling |

*Source: TMPL-001 lines 112–141; PayInc HCM lines 80–89 — identical text across both proposals confirms stable platform description*

**Oracle Fusion core component overview:**

| Module | Scope |
|---|---|
| Oracle Fusion Financials | General ledger, accounts payable, accounts receivable, fixed assets, cash management |
| Oracle Fusion Human Capital Management (HCM) | Payroll interface, talent management, workforce management, HR analytics |
| Oracle Fusion Supply Chain Management (SCM) | Procurement, inventory management, order management, product lifecycle management |
| Oracle Fusion Customer Relationship Management (CRM) | Sales automation, marketing, service, social media engagement |
| Oracle Fusion Governance, Risk and Compliance (GRC) | Risk management, policy enforcement, regulatory compliance |

*Source: TMPL-001 lines 124–141; PayInc HCM lines 91–107*

---

#### Section 2 — APPSolve Oracle Fusion Partnership

##### Partnership Status

APPSolve is an **Oracle Level 1 Principal Partner**, the highest partnership tier in Oracle's current partner programme.

> **Governance rule:** The phrase "Oracle Gold Partner" and "Gold Level" are PROHIBITED. Oracle's Gold tier expired August 2021. All partnership references use "Level 1 Partner" or "Level 1 Principal Partner" only.

*Source: RedPath Mining RFI line 253 — "We are a Level 1 Principal Partner" (current, March 2026)*

APPSolve is also a certified **Oracle Cloud Excellence Implementer**.

*Source: TMPL-001 line 267*

##### Oracle Awards

APPSolve has received the following Oracle-recognised awards:

| Award | Year | Region |
|---|---|---|
| Oracle Innovation Sustainability Award | 2015 | Global |
| Oracle Innovation Sustainability Award | 2016 | Global |
| Oracle SaaS Partner of the Year | 2016 | SADC Region |
| Oracle SaaS Partner of the Year — New Entrant | 2019 | SADC Region |
| Oracle Business Impact Award | 2024 | EMEA Region |
| Oracle Business Impact Award | 2024 | ECEMEA Region |

*Source: W1S1-003 (approved awards register); TMPL-001 lines 248–252; RedPath Mining RFI (2024 awards)*

##### Oracle Integration Cloud as Standard

In every Oracle Fusion implementation APPSolve has delivered, Oracle Integration Cloud (OIC) has been implemented as the standard integration platform for all inbound and outbound interfaces between Oracle SaaS and third-party systems.
...
*Source: RedPath Mining RFI line 195 — authoritative general claim (March 2026, most current source)*

##### Consulting Team

APPSolve maintains a team of **50+ consultants** across Oracle Fusion functional, technical, and integration disciplines, each with 10 or more years of enterprise technology experience.

> **Governance rule:** The figures "110 Senior Consultants", "over 100 consultants" are PROHIBITED. Use "50+" only.

*Source: RedPath Mining RFI (approved wording); ORACLE_FACT_BASELINE.md Section 6*

---

#### Section 3 — Oracle Fusion HCM

APPSolve is a specialist Oracle Fusion HCM implementer with multi-module, multi-sector, and multi-country delivery experience.

##### 3.1 Global Human Resources (Core HR)

Oracle Fusion Global HR centralises employee data and provides lifecycle management tools covering hiring, onboarding, job changes, transfers, and terminations. The module supports:

- Single employee master record spanning personal, position, compensation, and history data
- Real-time visual organisation charts with position management and reporting lines
- Configurable workflow approvals aligned to supervisor hierarchy
- Multi-country, multi-currency, multi-legislation employee management

**Benefits:**
- A single source of truth for all workforce data
- Elimination of duplicate administrative effort and data inconsistencies
- Foundation for all dependent HCM modules

*Source: SAA HCM RFP Section 2 (Global HR module); PayInc HCM lines 127–130, 160–164*

##### 3.2 AI-Based Dynamic Skills

Oracle Fusion AI Skills enables organisations to build and maintain a dynamic skills inventory across the workforce. The module uses AI to recommend skill development paths and align workforce capability to business objectives.

**Key features:**
- AI-driven skills profiling and gap identification
- Integration with Talent Management, Learning Cloud, and Recruiting for end-to-end workforce planning
- Dynamic skills libraries aligned to current and future role requirements

*Source: SAA HCM RFP (AI Skills module); PayInc HCM lines 130–134*

##### 3.3 Absence Management

Oracle Fusion Absence Management provides a comprehensive solution for managing all types of employee leave and absence, including:

- Configurable absence plans aligned to company policy and legislative requirements
- Employee self-service leave requests with automated approval workflows
- Integration with time management, payroll, and workforce planning for seamless absence processing
- Absence liability reporting and analytics

*Source: SAA HCM RFP (Absence Management module); PayInc HCM lines 135–139*

##### 3.4 Benefits Administration

Oracle Fusion Benefits supports the full benefits lifecycle from plan configuration through enrolment to administration. The module enables:

- Flexible plan design across medical, retirement, insurance, and voluntary benefits
- Self-service enrolment for employees with guided eligibility rules
- Integration with payroll for automated deduction processing
- Regulatory compliance and year-end reporting

*Source: SAA HCM RFP (Benefits module); PayInc HCM lines 140–144*

##### 3.5 Oracle Journeys

Oracle Journeys provides guided, personalised digital workflows for employee lifecycle events — onboarding, offboarding, role changes, and wellbeing programmes. The module:

- Assembles task lists, content, and actions across HR, IT, Facilities, and Finance
- Delivers guided experiences via desktop and mobile
- Supports custom journeys aligned to company-specific events

*Source: SAA HCM RFP (Journeys module); PayInc HCM lines 145–149*

##### 3.6 Payroll Interface

Oracle Fusion Payroll Interface provides the certified integration layer between Oracle HCM and third-party payroll systems. APPSolve has extensive experience delivering this integration across multiple clients.

**Outbound payload (HCM → Payroll):**
Locations, Positions, Jobs, Grades, Employee Master, Assignment, Salary, Leave Balances, Expenses, Overtime, Salary Increase, Bonus, Addresses, Phone Number, Tax Information, Terminations

**Return payload (Payroll → HCM):**
Payslip, IRP5, IT3A, Cost2Company Balances (for Compensation module display)

**Third-party payroll systems integrated:**
- SAP Payroll
- Deel Local Payroll
- Other third-party systems via OIC

> "APPSolve has implemented an Integration between Oracle HCM and SAP Payroll many times."

*Source: Hollywood Bets V5.0 (payroll interface field list confirmed in project scope); SAA HCM RFP line 890 (SAP Payroll statement); PayInc HCM lines 150–154*

##### 3.7 Workforce Directory Management

Oracle Fusion Workforce Directory provides employees and managers with an enterprise-grade, searchable directory of people, skills, roles, and organisational structure. Features include:

- Real-time people search with role and skills filters
- Organisational hierarchy visualisation
- Integration with Global HR for live data accuracy

*Source: SAA HCM RFP (Workforce Directory module); PayInc HCM lines 155–159*

##### 3.8 Workforce Modelling and Predictions

Oracle Fusion Workforce Modelling enables HR leaders to model and evaluate workforce restructuring scenarios, headcount changes, and organisational redesign before committing to changes. The module:

- Supports drag-and-drop organisational modelling in a sandbox environment
- Provides cost and headcount impact analysis per scenario
- Integrates with Global HR for live data and with Finance for budgetary alignment

*Source: SAA HCM RFP (Workforce Modelling module); PayInc HCM lines 160–164*

##### 3.9 Work Life Solutions

Oracle Fusion Work Life Solutions provides tools that support employee wellbeing, work-life balance, and engagement, including:

- Wellbeing tracking and goal setting
- Volunteering and charitable contribution management
- Integration with HR and absence systems for holistic employee experience

*Source: SAA HCM RFP (Work Life module); PayInc HCM lines 165–168*

##### 3.10 Oracle Transactional Business Intelligence (OTBI)

Oracle OTBI is the embedded real-time reporting and analytics tool within Oracle Fusion. Key capabilities:

- On-demand analytics with real-time data from live HR modules
- Pre-built HR reports and dashboards (headcount, turnover, compensation benchmarking)
- Ad-hoc report builder for business users without requiring IT intervention
- Data security inherits Oracle HCM role-based access controls

*Source: SAA HCM RFP (OTBI module); PayInc HCM lines 172–177*

##### 3.11 Transparent Data Encryption (TDE)

Oracle Transparent Data Encryption encrypts sensitive HR and payroll data at rest, protecting against unauthorised access at the storage layer. TDE:

- Is transparent to applications and users — no application changes required
- Encrypts data without affecting system performance
- Supports compliance with GDPR, POPIA, and other data protection regulations

*Source: SAA HCM RFP (TDE module); PayInc HCM lines 177–179*

##### 3.12 Workforce Compensation

Oracle Fusion Workforce Compensation supports merit, bonus, and equity compensation cycle management:

- Configurable compensation plans and budgets by manager, grade, or business unit
- Manager self-service compensation worksheets with guidelines and alerts
- Integration with payroll for compensation change propagation
- Total compensation statement generation

*Source: SAA HCM RFP (Workforce Compensation module)*

##### 3.13 Oracle Recruiting Cloud

Oracle Fusion Recruiting Cloud is a next-generation applicant tracking system (ATS) that supports the full talent acquisition lifecycle:

**Key features:**
- AI-powered candidate sourcing, screening, and ranking
- Branded career sites with external job posting integration
- Interview management with structured evaluation guides
- Onboarding integration — seamless candidate-to-employee transition
- Integration with Oracle Global HR, Payroll, and Workforce Management

APPSolve delivered the full Oracle Recruiting Cloud implementation for Hollywood Bets as part of its HCM transformation programme.

*Source: Hollywood Bets V5.0 (Recruiting scope confirmed); SAA HCM RFP (Recruiting module); PayInc HCM lines 184–229*

##### 3.14 Talent Management

Oracle Fusion Talent Management provides an integrated, AI-driven talent development platform covering:

- **Goal Management:** Aligns individual goals with business objectives; supports OKR-style and traditional goal frameworks
- **Performance Management:** Structured review cycles with manager and peer feedback
- **Talent Review and Succession Management:** 9-box talent assessment and succession pipeline planning
- **Career Development:** Personalised career paths, mentoring, and development plans
- AI-driven recommendations for career moves and skill development opportunities

APPSolve implemented the full Talent Management suite for Hollywood Bets including Goal Management, Performance Management, Talent Review, and Succession.

*Source: Hollywood Bets V5.0 (confirmed scope); SAA HCM RFP (Talent Management module); PayInc HCM lines 242–282*

##### 3.15 Oracle Learning Cloud

Oracle Fusion Learning Cloud is a next-generation Learning Management System (LMS) supporting formal, social, and blended learning:

- AI-personalised learning recommendations aligned to role and skills gaps
- Instructor-led, virtual, and self-paced learning support
- Integration with Oracle Talent Management and Career Development for learning-led development paths
- SETA / WSP-ATR compliance support via third-party integration (e.g., Moodle via OIC for SETA reporting)

*Source: SAA HCM RFP (Learning Cloud module); Hollywood Bets V5.0 Annexure 1 (WSP/ATR Moodle integration); PayInc HCM lines 297–341*

##### 3.16 HCM Analytics

Oracle Fusion HCM Analytics (formerly Oracle HCM Analytics Warehouse / OTBI Enterprise) delivers pre-built, cloud-based analytics extending the core HCM reporting capability:

- Pre-built dashboards for workforce composition, talent acquisition, diversity and inclusion, and employee retention
- Cross-domain analytics linking HCM data with Finance, CRM, and SCM data for holistic insights
- KPI libraries tailored for HR use cases
- Role-based security inheriting from Oracle HCM access controls

*Source: SAA HCM RFP (HCM Analytics module); PayInc HCM lines 344–377*

##### 3.17 Time and Labor / Workforce Scheduling

Oracle Fusion Time and Labor enables employees and managers to capture, approve, and process time entries against work schedules, projects, and absence policies. The module integrates with Payroll, Projects, and Absence Management for straight-through processing.

Oracle Fusion Workforce Scheduling provides advanced scheduling tools for shift-based workforces including automated schedule generation, compliance checking, and employee self-service schedule visibility.

*Source: SAA HCM RFP (Time and Labor and Workforce Scheduling modules)*

##### 3.18 HR Help Desk / Oracle Digital Assistant

Oracle HR Help Desk provides a unified case management and knowledge platform for employee HR queries. APPSolve has implemented HR Help Desk with:

- Chatbot and SMS channels for employee query submission
- Four-level routing and escalation structure (Tier 0 self-service → Tier 1 help desk → Tier 2 HR specialist → Tier 3 management escalation)
- Integration with Global HR for context-aware responses

*Source: Hollywood Bets V5.0 Annexure 2 (HR Help Desk scope and routing structure)*

---

#### Section 4 — Oracle Fusion ERP / Financials

Oracle Fusion Enterprise Resource Planning (ERP) is designed to manage and automate a wide range of financial and operational business processes. It is a comprehensive, cloud-based solution that integrates financial management, procurement, project management, and supply chain into a single platform.

**Oracle Fusion ERP benefits:**

| Benefit | Description |
|---|---|
| Unified Platform | Combines financial, procurement, project management, and supply chain in a single integrated system |
| Cloud-Based | Eliminates on-premises infrastructure; access from anywhere enhancing business continuity |
| Real-Time Insights | Real-time data and analytics for faster, more informed decision-making |
| Scalability | Adapts to business growth, from small enterprises to large multinational corporations |
| Automation | Automates routine tasks and processes, reducing manual effort and risk of error |
| Compliance | Supports regulatory and audit requirements, reducing non-compliance risk |

*Source: BankServAfrica ERP Proposal (August 2024) lines 391–399*

##### 4.1 Financial Management Modules

APPSolve has delivered Oracle Fusion Financials implementations across multiple clients in Southern Africa and internationally.

| Module | Description | Delivery Evidence |
|---|---|---|
| General Ledger | Centralised accounting hub supporting complex financial structures, multi-entity accounting, and real-time financial reporting | Investec (SA, UK, USA — July 2024); Nala Renewables (8-country footprint — April 2025); Cape Union Mart (Feb 2022); DFA (June 2019) |
| Accounts Payable | Automates invoice processing, vendor payments, and compliance with global tax regulations | Investec; Cape Union Mart; DFA |
| Accounts Receivable | Manages customer billing, collections, and cash application processes | Investec; Cape Union Mart; DFA |
| Fixed Assets Management | Tracks and manages the lifecycle of fixed assets, including depreciation and asset transfers | Investec; DFA |
| Cash Management | Provides visibility into cash positions, cash forecasting, and bank reconciliation | Investec; Cape Union Mart |
| iExpenses (Expense Reports) | Employee self-service expense capture, approval workflow, and integration with Accounts Payable | Investec (confirmed) |

*Source: BankServAfrica ERP Proposal lines 402–420 (module descriptions); Mpact ERP Proposal lines 500–583 (client reference cards with go-live dates and modules)*

##### 4.2 Financial Reporting

Oracle Financials Cloud provides predefined analyses, dashboards, and reports supporting financial and business intelligence requirements. The Financial Reporting Center serves as the primary interface for all seven Oracle report types:

| Report Type | Description |
|---|---|
| Financial Reporting Web Studio Reports | Custom financial statement layouts |
| Account Groups and Sunburst | Visual account balance analysis |
| Smart View Reports | Excel-based Oracle data extraction and reporting |
| Oracle Transactional Business Intelligence (OTBI) | Ad-hoc, real-time analytics |
| OTBI Dashboards | Role-based performance dashboards |
| Oracle Analytics Publisher Reports | Formatted business document output |
| Business Intelligence Mobile Apps | Mobile access to financial reporting |

*Source: BankServAfrica ERP Proposal lines 930–932*

##### 4.3 Oracle Fusion ERP — Referenceable Client Evidence

| Client | Industry | Modules | Countries | Go-Live | Reference |
|---|---|---|---|---|---|
| Investec | Banking | Financials, Procurement, iExpenses | SA, UK, USA (3 countries) | July 2024 | Available |
| Nala Renewables | Renewable Energy | Financials, Projects | 8-country footprint (APPSolve implemented 4: SA, Lithuania, Romania, Finland) | April 2025 | Available |
| Cape Union Mart | Retail | Financials, Procurement | South Africa | February 2022 | Available |
| DFA (Dark Fibre Africa) | Telecom / Infrastructure | Financials Cloud, SCM Cloud, Projects, EPM, HCM, OIC | South Africa | June 2019 | **Not available** |

> **Note to BU Lead:** Finance module descriptions are now sourced from APPSolve's BankServAfrica ERP Proposal (August 2024). Client reference data is from Mpact ERP Proposal reference cards (August 2025), which are the most detailed and recent reference data found. DFA has the broadest scope but is explicitly not available for reference (confirmed Mpact proposal). Investec (>1,000 users, 3 countries, July 2024 go-live) is the flagship Finance reference.

*Source: BankServAfrica ERP Proposal (August 2024) lines 389–495; Mpact ERP Proposal (August 2025) reference cards lines 470–643*

---

#### Section 5 — Oracle Fusion Procurement

Oracle Fusion Procurement is a comprehensive suite of cloud-based applications designed to streamline and enhance the procurement process. It integrates procurement activities — from supplier sourcing through contract management, purchase order execution, and invoice processing — enabling organisations to manage procurement efficiently with full policy compliance and spend visibility.

**Oracle Fusion Procurement benefits:**
- Cost Reduction: Centralising and streamlining procurement processes reduces costs and eliminates inefficiencies
- Improved Supplier Relationships: Enhanced collaboration tools foster better relationships with suppliers
- Increased Visibility: Real-time insights and analytics provide visibility into all procurement activities
- Compliance and Risk Management: Built-in contract and policy compliance reduces non-compliance and procurement risk

##### 5.1 Core Procurement Capabilities

| Capability | Description |
|---|---|
| Procurement Contracts | Manages the entire lifecycle of procurement contracts — creation, negotiation, approval, and management. Ensures compliance with organisational policies and legal requirements |
| Self-Service Procurement | Allows employees to request goods and services through a user-friendly, catalog-based interface. Reduces maverick spending by guiding employees towards approved suppliers and negotiated pricing |
| Sourcing | Facilitates strategic sourcing — supplier identification, bid collection, and bid evaluation. Supports RFQs (Request for Quotation) and reverse auctions. Enables collaboration with suppliers and internal stakeholders |
| Supplier Qualification Management | Assesses and manages supplier risk and performance. Automates the qualification process, ensuring only qualified suppliers participate in procurement activities |
| Supplier Portal | Platform for suppliers to manage profiles, view purchase orders, submit invoices, and track payments — reducing invoice processing friction for both parties |
| Spend Analysis | Analyses procurement spending to identify cost-saving opportunities. Provides insights into supplier performance, spend categories, and trends |
| Purchase Order Management | Manages creation, approval, and tracking of purchase orders. Ensures that all purchases align with contracts and organisational policies |

*Source: BankServAfrica ERP Proposal (August 2024) lines 561–604*

##### 5.2 Self-Service Procurement

Oracle Fusion Self-Service Procurement provides a consumer-like purchasing experience that empowers employees to manage their own purchasing needs while maintaining full policy compliance:

- **Consumer-like interface:** Employees search, compare, and order goods from curated catalogs of approved suppliers and products
- **Guided buying:** System routes users towards preferred suppliers and negotiated pricing, reducing off-contract spend
- **Automated approval workflows:** Requisitions automatically route for approval based on configured business rules — spending limits, departmental approvals, project-based controls
- **Real-time budget checks:** Integrates with Oracle Financials to validate budget availability before purchase commitment, preventing overspend
- **Self-service receiving:** Users confirm receipt directly in the system, automatically updating inventory and procurement records
- **Spend reporting:** Tools for managers to analyse spend patterns, supplier performance, and policy compliance

*Source: BankServAfrica ERP Proposal lines 717–805*

##### 5.3 Procurement Client Evidence

| Client | Modules | Countries | Go-Live | Reference |
|---|---|---|---|---|
| Investec | Oracle Fusion Procurement, iExpenses | SA, UK, USA (3 countries) | July 2024 | Available |
| Cape Union Mart | Oracle Fusion Procurement | South Africa | February 2022 | Available |
| DFA (Dark Fibre Africa) | Oracle SCM (iSupplier Portal, Sourcing, Contracts) | South Africa | June 2019 | **Not available** |

*Source: Mpact ERP Proposal reference cards (August 2025) lines 500–583*

---

#### Section 6 — Oracle Fusion Supply Chain Management (SCM)

> **SCM CAPABILITY REFERENCE ONLY — RESTRICTED USE.** APPSolve currently has no referenceable Oracle Fusion SCM client available for external tender reference. This section may be used for capability descriptions and methodology responses where delivery references are not scored criteria. Dark Fibre Africa (DFA) remains internal-use-only and may not be cited without specific BU Lead approval. BU Lead ruling applied 2026-06-11 (FR-004 — Option A).

Oracle Fusion Supply Chain Execution (SCE) is a suite of cloud-based applications managing and optimising supply chain processes — covering inventory management, order fulfilment, logistics, procurement, supply chain planning, global trade, and quality management.

**Oracle Fusion SCM benefits:**
- Improved Efficiency: Automating and optimising supply chain processes reduces costs, minimises waste, and improves throughput
- Enhanced Customer Satisfaction: On-time, accurate delivery of goods and services
- Better Decision-Making: Real-time visibility and analytics for responsive supply chain management
- Reduced Risk: Manages supplier disruptions, regulatory compliance issues, and quality problems
- Scalable Growth: Scales as supply chain operations grow without system constraints

##### 6.1 SCM Core Capabilities

| Capability | Description |
|---|---|
| Inventory Management | Real-time visibility into inventory across multiple locations — warehouses, distribution centres, retail stores. Supports multi-channel fulfilment, lot and serial tracking, inventory valuation, and accurate inventory planning |
| Order Management | Manages the entire order-to-cash process — order capture through fulfilment and invoicing. Supports drop shipping, backorders, and split shipments. Integrates with financial modules for seamless processing |
| Logistics Management | Optimises transportation and logistics; supports transportation planning, freight management, carrier integration, and real-time shipment tracking |
| Warehouse Management | Manages receiving, storage, picking, packing, and shipping. Supports advanced processes including cross-docking, wave picking, and task interleaving |
| Supply Chain Planning | Demand forecasting, supply planning, and inventory optimisation. Supports S&OP processes and scenario / what-if planning |
| Global Trade Management | Import/export compliance, customs documentation, and trade finance. Reduces risk of international trade penalties and delays |
| Quality Management | Quality standards enforcement throughout the supply chain — inspections, non-conformance management, and corrective action management |
| Maintenance | Asset and equipment maintenance management — preventive, corrective, and predictive maintenance strategies |

*Source: BankServAfrica ERP Proposal (August 2024) lines 658–715*

##### 6.2 Order Management

Oracle Fusion Order Management provides a centralised order hub for multi-channel order management — e-commerce, call centres, and partner networks. Key capabilities:

- **Order Promising:** Advanced order promising with global inventory visibility to provide accurate delivery dates
- **Configurable Workflows:** Configurable order management workflows supporting split shipments, backorders, and drop shipments
- **Pricing and Discount Management:** Tiered pricing, volume discounts, and contract-based pricing across all channels
- **Analytics and Reporting:** Real-time dashboards for order status, fulfilment performance, and customer satisfaction
- **Integration with Oracle Financials:** Invoicing, payment processing, and revenue recognition seamlessly linked to order data

*Source: BankServAfrica ERP Proposal lines 605–657*

##### 6.3 SCM Client Evidence and Scope Note

> **IMPORTANT — READ BEFORE USE:** Cape Union Mart is confirmed as Oracle Fusion **Financials and Procurement** only — NOT an SCM client. This corrects an error in the original W2S1-001 extraction. Dark Fibre Africa (DFA) is the only confirmed Oracle Fusion SCM client (Oracle SCM Cloud including iSupplier Portal, Sourcing, and Contracts — confirmed June 2019 go-live). DFA is **not available for reference** (explicitly confirmed in Mpact ERP Proposal line 641–642).
>
> SCM feature descriptions above are sourced from the BankServAfrica ERP Proposal (August 2024), which is an APPSolve-authored client proposal, not a delivered-project artefact. These descriptions are accurate for the Oracle product. However, the only referenceable SCM delivery evidence is absent from current sources.
>
> **Resolved — FR-004 closed by BU Lead on 2026-06-11.** Section 6 remains subject to the restricted-use notice at the beginning of the SCM section.

| Client | SCM Modules | Countries | Go-Live | Reference |
|---|---|---|---|---|
| Dark Fibre Africa (DFA) | Oracle SCM Cloud (iSupplier Portal, Sourcing, Contracts), Inventory | South Africa | June 2019 | **Not available** |

*Source: BankServAfrica ERP Proposal (August 2024) — feature descriptions; Mpact ERP Proposal (August 2025) lines 617–643 — DFA reference card*

---

#### Section 7 — Oracle Fusion Projects / PPM

Oracle Fusion Projects provides integrated project costing, billing, portfolio management, and project financials — supporting project-based organisations that need to track costs, recognise revenue, and manage capital expenditure across complex project portfolios.
...
| Cost Management | Track and control project costs — labour, materials, and overhead — ensuring projects stay within budget |
| Capital Projects | Manage capital project expenditures and asset capitalisation processes |
| Financial Reporting | Comprehensive financial reports including profit and loss, cash flow analysis, and project profitability |
| Integration with General Ledger | Seamless integration with Oracle Fusion GL for consistent and accurate financial reporting across the organisation |

*Source: BankServAfrica ERP Proposal (August 2024) lines 479–495*

##### 7.2 Project Contract Billing

| Capability | Description |
|---|---|
| Contract Management | Create and manage complex contracts — terms, conditions, and billing arrangements |
| Billing Rules | Flexible billing methods — fixed-price, time and materials, milestone-based billing |
| Revenue Recognition | Automated revenue recognition in compliance with accounting standards |
| Invoice Processing | Automated invoice creation and processing based on contract terms and project progress |
| Customer Collaboration | Customer portals for contract approval, invoice tracking, and dispute resolution |

*Source: BankServAfrica ERP Proposal lines 460–477*

##### 7.3 Project Management

| Capability | Description |
|---|---|
| Project Planning | Define project scope, objectives, timelines, and resources using structured planning tools |
| Task Management | Break down projects into tasks, assign responsibilities, track progress to completion |
| Resource Management | Allocate and manage resources — personnel, equipment, materials — to optimise project efficiency |
| Collaboration | Integrated collaboration tools — document sharing and discussion forums across project teams |
| Project Monitoring and Control | Real-time dashboards and analytics for proactive management and risk mitigation |
| Issue and Risk Management | Identify and manage project risks and issues to avoid delays |

*Source: BankServAfrica ERP Proposal lines 496–516*

##### 7.4 Projects Client Evidence

> **Nala Renewables — scope and referenceability confirmed by BU Lead 2026-06-11:** Nala Renewables is a confirmed Oracle Fusion Financials and Projects client. The production environment spans 8 implemented countries. Four countries were implemented by APPSolve (SA, Lithuania, Romania, Finland — confirmed via Mpact reference card August 2025); four further countries were already implemented before APPSolve's involvement. APPSolve supports the complete 8-country Oracle Fusion environment. Nala is referenceable for both Financials and Projects. When citing, distinguish between countries implemented by APPSolve (4) and the full production footprint supported by APPSolve (8).

| Client | Modules | Countries | Go-Live | Reference |
|---|---|---|---|---|
| Dark Fibre Africa (DFA) | Oracle Fusion Projects (confirmed; also Financials, SCM, HCM, EPM, OIC) | South Africa | June 2019 | **Not available** |
| Nala Renewables | Oracle Fusion Financials, Oracle Fusion Projects | 8-country footprint (APPSolve implemented 4: SA, Lithuania, Romania, Finland) | April 2025 | **Available** |

*Source: Mpact ERP Proposal (August 2025) reference cards lines 470–643; BankServAfrica ERP Proposal (August 2024)*

---

#### Section 8 — Oracle Analytics

APPSolve's Oracle Analytics capability spans both embedded and standalone analytics platforms:

**Oracle Transactional Business Intelligence (OTBI):**
Real-time, self-service reporting embedded within every Oracle Fusion module. Business users access on-demand dashboards, ad-hoc reports, and KPI views without IT dependency. Role-based security ensures data access aligns with Oracle Fusion user roles.

**Oracle Fusion HCM Analytics:**
Pre-built, cloud-based analytics extending HCM reporting capability with dedicated KPI libraries for workforce composition, talent acquisition, diversity and inclusion, and employee retention. Supports cross-domain analytics linking HCM with Finance and other Fusion modules.

**Oracle Business Intelligence (OBI):**
Where clients require enterprise-grade BI beyond embedded analytics, APPSolve deploys Oracle Business Intelligence solutions including dashboards, scorecards, and data warehouse integration.

*Source: SAA HCM RFP (OTBI and HCM Analytics modules); PayInc HCM lines 344–377; ORACLE_FACT_BASELINE.md Section 9*

---

#### Section 9 — Oracle Integration Cloud (OIC)

Oracle Integration Cloud (OIC) is Oracle's strategic Integration Platform as a Service (iPaaS) solution, specifically designed for integrating Oracle Cloud applications with other cloud and on-premises systems.

##### OIC as APPSolve Standard

Oracle Integration Cloud is a mandatory component in every APPSolve Oracle Fusion implementation. OIC is deployed in all Oracle Fusion projects for all inbound and outbound interfaces between Oracle SaaS and third-party systems.

> "All our Fusion implementation we have also implemented Oracle Integration Cloud. We have used OIC for all inbound and out bound interfaces between Oracle SaaS and 3rd party systems."

*Source: RedPath Mining RFI line 195*

##### OIC Core Capabilities

| Capability | Description |
|---|---|
| Pre-built Adapters | Oracle HCM, ERP, SCM, CX; SAP, Salesforce, Workday, and 400+ third-party adaptors |
| Visual Designer | Low-code / no-code visual designer for integrations, transformations, and orchestrations |
| Process Automation | Automates business processes spanning multiple applications |
| REST API / SOAP Support | Full API integration capability for custom and legacy system connectivity |
| HDL / HSDL / FBDI | Oracle-native bulk data load integrations for HCM and Financials |

*Source: PayInc HCM lines 379–384 (OIC description and adaptor capability); RedPath Mining RFI line 195*

##### Integration Patterns Delivered

**HCM integrations:**
- Oracle HCM ↔ SAP Payroll (confirmed: SAA June 2025, "many times")
- Oracle HCM ↔ Deel Local Payroll (PayInc)
- Oracle HCM ↔ Moodle (WSP/ATR SETA reporting, Hollywood Bets)
- Oracle HCM ↔ Third-party payroll via full payroll interface field set

**Financials and Procurement integrations:**
- Oracle Fusion Finance ↔ third-party banking (HDL/FBDI patterns)
- Oracle Fusion Finance ↔ external reporting systems

**Multi-client OIC deployments confirmed:**
DFA, Cape Union Mart, Hollywood Bets, Mr Price, Investec, Nala — all confirmed OIC via RedPath Mining RFI

*Source: SAA HCM RFP line 890 (SAP Payroll); Hollywood Bets V5.0 (Moodle integration via OIC); RedPath Mining RFI line 195 and client list lines 243–249; PayInc HCM*

---

#### Section 10 — Security and Compliance

APPSolve implements Oracle Cloud's full security stack as part of every Fusion deployment, ensuring clients meet data protection, access control, and regulatory compliance requirements.

**Oracle Cloud Security controls deployed:**

| Control | Description |
|---|---|
| Oracle Cloud Guard | Continuous cloud security posture monitoring and automated remediation |
| Web Application Firewall (WAF) | Layer 7 protection against web-based attacks |
| Identity and Access Management (IAM) | Role-based access control with Oracle Fusion module-level security |
| Transparent Data Encryption (TDE) | At-rest encryption for all sensitive HR and financial data |
| Multi-Factor Authentication (MFA) | Mandatory MFA for all Oracle Cloud user access |

**Regulatory and compliance alignment:**
- GDPR compliance tooling embedded in Oracle Fusion
- POPIA data subject management via Oracle HCM privacy controls
- SOC 1 and SOC 2 certifications (Oracle Cloud Infrastructure)

*Source: SAA HCM RFP lines 1096–1109 (OCI security controls — Cloud Guard, WAF, IAM, TDE, MFA); PayInc HCM lines 177–179 (TDE)*

> **Exclusion note:** OCI platform infrastructure capabilities (compute, storage, networking) are excluded from this statement per W2S1-001 scope. Security controls listed are those deployed at the application and data layer within Oracle Fusion implementations.

---

#### Section 11 — Mobile Experience

Oracle Fusion provides a responsive, mobile-first user experience across all modules, enabling employees, managers, and administrators to complete HR, finance, and operational tasks from any device.

**Mobile capabilities:**

| Capability | Access |
|---|---|
| Employee Self-Service (ESS) | Leave requests, payslip access, profile updates, absence capture |
| Manager Self-Service (MSS) | Approval workflows, team dashboards, performance reviews |
| Oracle Digital Assistant | AI-powered chatbot accessible via mobile for HR query resolution |
| Oracle Workforce Scheduling | Mobile shift management and schedule visibility |
| Mobile Recruiting | Candidate review, interview scheduling, and offer approvals on mobile |

*Source: TMPL-001 line 119 (mobile access emphasis); SAA HCM RFP (Workforce Scheduling module); PayInc HCM line 87 (mobile access statement); Hollywood Bets V5.0 (HR Help Desk chatbot)*

---

#### Section 12 — Referenceable Client Experience

> **Version note:** Client table updated 2026-06-11. Client data now sourced from Mpact ERP Proposal reference cards (August 2025) — the most detailed and specific client reference data found across all sources. Corrections from prior version: Cape Union Mart is Financials + Procurement (NOT SCM); Mr Price is HCM Learning Cloud only (NOT full HCM). Nala: 8-country Oracle Fusion footprint confirmed. APPSolve implemented 4 countries (South Africa, Lithuania, Romania and Finland) and supports the full 8-country production environment. Nala is referenceable for Oracle Fusion Financials and Oracle Fusion Projects. (Confirmed by Hein Blignaut 2026-06-11.)

##### Available for Reference

| Client | Industry | Modules Confirmed | Countries | Go-Live | Users | Integration | Source |
|---|---|---|---|---|---|---|---|
| Investec | Banking | Oracle Fusion Financials, Oracle Fusion Procurement, iExpenses | SA, UK, USA (3 countries) | July 2024 | >1,000 | Payroll, JDE GL, Banking, EBS HCM on-premise | Mpact references lines 500–526 |
| Hollywood Bets | Betting / Gaming | Oracle Fusion HCM, Help Desk, Recruiting Cloud, Talent Management | South Africa | July 2025 | 7,000 | OIC — PaySpace payroll, Moodle (WSP/ATR) | Mpact references lines 589–614; Hollywood Bets V5.0 (April 2023) |
| Nala Renewables | Renewable Energy | Oracle Fusion Financials, Oracle Fusion Projects | 8-country footprint (APPSolve implemented 4: SA, Lithuania, Romania, Finland) | April 2025 | 25 | Banking | Mpact references lines 472–498; confirmed by Hein Blignaut 2026-06-11 |
| Cape Union Mart | Retail | Oracle Fusion Financials, Oracle Fusion Procurement | South Africa | February 2022 | 25 | Bank Statement, Payment file, Trade Management, TM1 Reporting, Manufacturing | Mpact references lines 557–583 |
| Mr Price Group | Retail | Oracle HCM Learning Cloud | South Africa | June 2023 | 2,300 | Oracle HCM ↔ 3rd party systems | Mpact references lines 528–554 |

##### NOT Available for Reference

| Client | Industry | Modules Confirmed | Countries | Go-Live | Notes |
|---|---|---|---|---|---|
| Dark Fibre Africa (DFA) | Telecommunications / Infrastructure | Oracle Financials Cloud, Oracle SCM Cloud (iSupplier, Sourcing, Contracts), Inventory, Oracle Projects, Oracle EPM, Oracle HCM Cloud, Oracle Learning, Oracle Time & Labour, Oracle Payroll | South Africa | June 2019 | Explicitly not available for reference or site visit (Mpact proposal). Older engagement (2019). Broadest Fusion scope in portfolio. Do NOT cite without BU Lead authorisation. |

##### Additional EBS Sector Capability (Not Oracle Fusion)

- **Mining sector (Oracle EBS):** Assore, African Rainbow Minerals (ARM), Harmony Gold — RedPath Mining RFI (EBS, not Fusion; confirm product before use in Fusion tenders)
- **KPMG SADC (Oracle EBS):** 6-country ERP rollout across Botswana, Mauritius, Mozambique, Zambia, Zimbabwe, Namibia (EBS, not Fusion)

> **Note to BU Lead:**
> - **Investec** is the flagship Finance reference: >1,000 users, 3 countries, July 2024 go-live, available for reference.
> - **Hollywood Bets** is the richest HCM reference with a full project proposal plus confirmed July 2025 go-live at 7,000 users. (A-003 closed 2026-06-11 — Mpact reference card accepted as confirmation.)
> - **Nala Renewables** is a confirmed Financials and Projects reference — 8-country implemented footprint, APPSolve implemented 4 countries (SA, Lithuania, Romania, Finland), April 2025 go-live. Referenceable for both Financials and Projects. When citing, distinguish between APPSolve-implemented countries (4) and full supported footprint (8). (Confirmed by Hein Blignaut 2026-06-11.)
> - **DFA** has the broadest overall Fusion scope (Financials, SCM, Projects, EPM, HCM, OIC) but cannot be cited.
> - See ORACLE_REFERENCE_GAP_REPORT.md for reference letter register.

*Source: Mpact ERP Proposal (August 2025) reference cards lines 470–643; BankServAfrica ERP Proposal (August 2024) lines 239–262; Hollywood Bets V5.0 (April 2023)*
...
> The sections below are internal extraction records. They do not form part of the capability statement content and must be removed before any tender use.

---

#### Source Mapping Table

| Claim / Section | Primary Source | Supporting Source(s) | Sourced / AI-Authored |
|---|---|---|---|
| Section 1 — Platform Overview narrative | TMPL-001 lines 112–141 | PayInc HCM lines 80–89 (identical) | Sourced — stable template text |
| Section 1 — Core Components table | TMPL-001 lines 124–141 | PayInc HCM lines 91–107 | Sourced |
| Section 2 — Level 1 Partner claim | RedPath Mining RFI line 253 | ORACLE_FACT_BASELINE.md Section 1 | Sourced |
| Section 2 — Oracle Cloud Excellence Implementer | TMPL-001 line 267 | — | Sourced |
| Section 2 — Awards table | W1S1-003 (approved) | TMPL-001 lines 248–252; RedPath Mining RFI (2024 awards) | Sourced (W1S1-003 is approved source) |
| Section 2 — OIC as standard | RedPath Mining RFI line 195 | — | Sourced — verbatim quote used |
| Section 2 — 50+ consultants | RedPath Mining RFI (approved wording) | ORACLE_FACT_BASELINE.md Section 6 | Sourced |
| Section 3.1 — Global HR features | SAA HCM RFP Section 2 | PayInc HCM lines 127–130 | Sourced (condensed) |
| Section 3.2 — AI Skills | SAA HCM RFP | PayInc HCM lines 130–134 | Sourced (condensed) |
| Section 3.3 — Absence Management | SAA HCM RFP | PayInc HCM lines 135–139 | Sourced (condensed) |
| Section 3.4 — Benefits | SAA HCM RFP | PayInc HCM lines 140–144 | Sourced (condensed) |
| Section 3.5 — Journeys | SAA HCM RFP | PayInc HCM lines 145–149 | Sourced (condensed) |
| Section 3.6 — Payroll Interface field list | Hollywood Bets V5.0 (scope section) | SAA HCM RFP line 890 (SAP claim) | Sourced (Hollywood Bets confirmed field list) |
| Section 3.7 — Workforce Directory | SAA HCM RFP | PayInc HCM lines 155–159 | Sourced |
| Section 3.8 — Workforce Modelling | SAA HCM RFP | PayInc HCM lines 160–164 | Sourced |
| Section 3.9 — Work Life | SAA HCM RFP | PayInc HCM lines 165–168 | Sourced |
| Section 3.10 — OTBI | SAA HCM RFP | PayInc HCM lines 172–177 | Sourced |
| Section 3.11 — TDE | SAA HCM RFP | PayInc HCM lines 177–179 | Sourced |
| Section 3.12 — Workforce Compensation | SAA HCM RFP | — | Sourced |
| Section 3.13 — Recruiting Cloud (Hollywood Bets) | Hollywood Bets V5.0 (Recruiting in scope) | SAA HCM RFP; PayInc HCM lines 184–229 | Sourced |
| Section 3.14 — Talent Management (Hollywood Bets) | Hollywood Bets V5.0 (confirmed full scope) | SAA HCM RFP; PayInc HCM lines 242–282 | Sourced |
| Section 3.15 — Learning Cloud | SAA HCM RFP | Hollywood Bets V5.0 Annexure 1 (Moodle/OIC); PayInc HCM lines 297–341 | Sourced |
| Section 3.16 — HCM Analytics | SAA HCM RFP | PayInc HCM lines 344–377 | Sourced |
| Section 3.17 — Time and Labor | SAA HCM RFP | — | Sourced |
| Section 3.18 — HR Help Desk | Hollywood Bets V5.0 Annexure 2 | — | Sourced |
| Section 4 — Financials (ERP benefits, module descriptions) | BankServAfrica ERP Proposal (Aug 2024) lines 391–420 | Mpact ERP Proposal (Aug 2025) reference cards | **Sourced** — APPSolve-authored client proposal content |
| Section 4 — Financials (reporting types) | BankServAfrica ERP Proposal lines 930–932 | — | **Sourced** |
| Section 4 — Client evidence table (corrected) | Mpact ERP Proposal reference cards lines 470–583 | BankServAfrica ERP Proposal lines 239–262 | **Sourced** — corrections applied: DFA not available; go-live dates confirmed |
| Section 5 — Procurement (overview, benefits, 7 capabilities) | BankServAfrica ERP Proposal lines 561–604 | — | **Sourced** — APPSolve-authored client proposal content |
| Section 5 — Self-Service Procurement | BankServAfrica ERP Proposal lines 717–805 | — | **Sourced** |
| Section 5 — Procurement client evidence | Mpact ERP Proposal reference cards lines 500–583 | — | **Sourced** |
| Section 6 — SCM (9 capabilities) | BankServAfrica ERP Proposal lines 658–715 | — | **Sourced** — APPSolve-authored proposal content; no referenceable SCM delivery client |
| Section 6 — Order Management | BankServAfrica ERP Proposal lines 605–657 | — | **Sourced** |
| Section 6 — CORRECTION: Cape Union Mart removed from SCM | Mpact ERP Proposal reference cards lines 557–583 | — | **Material error corrected** — Cape Union Mart is Financials+Procurement only |
| Section 7 — Project Financials | BankServAfrica ERP Proposal lines 479–495 | — | **Sourced** — APPSolve-authored proposal content |
| Section 7 — Project Contract Billing | BankServAfrica ERP Proposal lines 460–477 | — | **Sourced** |
| Section 7 — Project Management | BankServAfrica ERP Proposal lines 496–516 | — | **Sourced** |
| Section 7 — Projects client evidence | Mpact ERP Proposal reference cards | — | Sourced; DFA confirmed but not referenceable; Nala Financials and Projects confirmed — referenceable; 8-country footprint confirmed by Hein Blignaut 2026-06-11; APPSolve implemented 4 countries and supports the complete 8-country environment |
| Section 8 — Analytics | SAA HCM RFP; PayInc HCM lines 344–377 | ORACLE_FACT_BASELINE.md Section 9 | Sourced |
| Section 9 — OIC (standard claim) | RedPath Mining RFI line 195 | PayInc HCM lines 379–384 | Sourced |
| Section 9 — OIC capabilities table | PayInc HCM lines 379–384 | — | Sourced |
| Section 9 — Integration patterns | SAA HCM RFP line 890; Hollywood Bets V5.0; RedPath Mining RFI client list | — | Sourced |
| Section 10 — Security controls table | SAA HCM RFP lines 1096–1109 | PayInc HCM lines 177–179 | Sourced |
| Section 11 — Mobile experience | TMPL-001 line 119; SAA HCM RFP; PayInc HCM line 87 | — | Sourced (features); table structure AI-authored |
| Section 12 — Referenceable client table | RedPath Mining RFI lines 243–249; Hollywood Bets V5.0 | — | Sourced |
...
|---|---|---|---|---|
| A-001 | All Fusion clients in RedPath Mining RFI client list (DFA, Cape Union Mart, Investec, Mr Price, Nala) are current and accurate as at March 2026 | Section 12 | Incorrect client claims in tender = serious credibility risk | Confirm with account managers before first tender use |
| A-002 | "Finance" in RedPath Mining client list = Oracle Fusion Financials (GL, AP, AR) unless otherwise specified | Sections 4, 5, 7, 12 | May overstate Financials module scope | Confirm exact module breakdown per client with delivery team |
| A-003 | Hollywood Bets go-live status | Section 3, 12 | — | **CLOSED 2026-06-11.** Mpact ERP Proposal reference card (August 2025) accepted by BU Lead as confirmation of July 2025 go-live at 7,000 users. No further action required. |
| A-004 | SAP Payroll integration claim ("many times" — SAA June 2025) covers at least 3 separate client engagements | Section 3.6 | Overstates experience if fewer instances | Confirm client count with delivery team |
| A-005 | OIC was the integration platform for all 6 Fusion clients in RedPath Mining RFI list | Section 9, 12 | Overstates OIC deployment if any client used different integration tool | Sourced claim (RedPath Mining line 195) — low risk |
| A-006 | Nala Renewables scope, referenceability, and geography | Section 7, 12 | — | **CLOSED 2026-06-11.** Confirmed by Hein Blignaut: Oracle Fusion Financials and Projects client. Production environment spans 8 implemented countries. Four countries implemented by APPSolve (SA, Lithuania, Romania, Finland — confirmed via Mpact reference card August 2025); four further countries were previously deployed. APPSolve supports the complete 8-country Oracle Fusion environment. Referenceable for both Financials and Projects. |
| A-007 | KPMG SADC rollout (6 countries) was an Oracle EBS engagement, not Oracle Fusion | Section 12 (footnote) | Would need separate handling if it was Fusion | Confirmed EBS from KPMG SADC source document |
| A-008 | Mining sector clients (Assore, ARM, Harmony) are Oracle EBS not Fusion | Section 12 (footnote) | Incorrect product citation | Confirmed EBS from RedPath Mining RFI line 193 |
| A-009 | OUM (Oracle Unified Methodology) underpins APPSolve implementation methodology — referenced in Hollywood Bets and PayInc | Section 9 (indirect) | No impact on Fusion capability statement | For W2S1-005 use |
| A-010 | Hein Blignaut has approximately 30 years of experience in the IT industry (Oracle Applications since 1996) | Section 2 (if biographical content required) | Overstates experience | ORACLE_FACT_BASELINE.md Section 14 — "~30 years"; confirmed |
...
|---|---|---|---|---|
| FR-001 | **Gold Partner claim** — All source documents (TMPL-001, KPMG SADC, SAA, RedPath Mining) contain "Gold Partner" or "Gold Level" references | ALL | CRITICAL | Resolved: all occurrences replaced with "Level 1 Partner" per ORACLE_FACT_BASELINE.md Section 1. No Gold references in this file. |
| FR-002 | **Consultant count** — TMPL-001 and SAA contain "110 Senior Consultants"; TMPL-001 line 380 contains "over 100" | Section 2 | CRITICAL | Resolved: "50+" used throughout per ORACLE_FACT_BASELINE.md Section 6. |
| FR-003 | **Finance/ERP feature sourcing** — Sections 4–7 feature descriptions previously AI-authored; now sourced from BankServAfrica ERP Proposal (August 2024 — APPSolve-authored). Residual caveat: these are product-description sections from a client proposal, not delivered-project artefacts. Client reference cards confirm actual delivery. | Sections 4, 5, 6, 7 | ~~MEDIUM~~ **RESOLVED** | **Resolved 2026-06-11.** Feature descriptions sourced. Client evidence confirmed via Mpact reference cards. See ORACLE_FINANCE_SOURCE_NOTES.md for detail. |
| FR-004 | **SCM — no referenceable client.** Cape Union Mart was incorrectly cited as SCM (MATERIAL ERROR — corrected in Section 6). DFA is the only confirmed Fusion SCM client but is NOT available for reference | Section 6 | ~~HIGH~~ **RESOLVED** | **Resolved 2026-06-11 — Option A applied by BU Lead.** Restricted-use notice added at top of Section 6: "SCM capability reference only — no referenceable Fusion SCM delivery client. Use for capability descriptions only where client references are not scored criteria. DFA internal-use-only." |
| FR-005 | **Client module scope corrections applied.** Mpact ERP Proposal reference cards (August 2025) provided definitive client-level module, country, and go-live data, superseding RedPath Mining RFI inferences | Sections 4–7, 12 | ~~MEDIUM~~ **RESOLVED** | **Resolved 2026-06-11:** Material correction applied: Cape Union Mart = Financials+Procurement only (not SCM). Nala Renewables country count and scope resolved by BU Lead clarification 2026-06-11: 8-country footprint confirmed; Oracle Fusion Financials and Projects both confirmed; referenceable. |
| FR-006 | **DFA full scope confirmed.** Both Mpact and BankServAfrica reference lists confirm: Financials, SCM, Projects, EPM, HCM, OIC. Go-live June 2019. NOT available for reference | Section 12 | ~~MEDIUM~~ **RESOLVED (with constraint)** | **Resolved:** DFA scope confirmed. NOT available for reference or site visit (Mpact proposal line 641–642). Do not cite DFA without BU Lead authorisation. Removed from "available for reference" client list. |
| FR-007 | **Year count** — TMPL-001 and KPMG SADC contain "22 years" (company age); KPMG contains "19 years" for Hein | Section 2 | HIGH | Resolved: "over two decades" used for company tenure; no Hein year count in this file. ORACLE_FACT_BASELINE.md Section 5 applied. |
| FR-008 | **BEE Level** — Current BEE Level is 3 (RS-19451, expires 2026-07-31). Level 2 references in older sources are PROHIBITED | (BEE not referenced in this file) | HIGH | Not applicable to this file. BEE not in Fusion capability scope. |
| FR-009 | **"Largest DBA" claim** — TMPL-001 line 321 contains "APPSolve has the largest number of locally based Oracle Applications DBAs" | (DBA excluded from this file) | MEDIUM | Not applicable — DBA is excluded from W2S1-001 scope. Will apply to W2S1-003. |
| FR-010 | **OIC SAA hedge** — SAA HCM RFP contains client-specific language hedging OIC use ("we can confirm if OIC is required") | Section 9 | LOW | Resolved: SAA hedge discarded. RedPath Mining line 195 used as authoritative OIC standard claim. |
...
|---|---|---|
| HCM Coverage | **STRONG** | 18 HCM modules covered with sourced feature content. SAA + Hollywood Bets + PayInc provide overlapping, high-quality evidence. |
| Finance / ERP Coverage | **GOOD** | Full module descriptions now sourced from BankServAfrica ERP Proposal (August 2024 — APPSolve authored). Investec (>1,000 users, 3 countries, July 2024) and Nala Renewables (8-country footprint — APPSolve implemented 4 countries, April 2025) are strong referenceable delivery evidence. Feature descriptions + client evidence now in alignment. |
| Procurement Coverage | **GOOD** | Full 7-capability Procurement description sourced from BankServAfrica ERP Proposal. Investec and Cape Union Mart confirm delivery. Self-Service Procurement also sourced. |
| SCM Coverage | **MODERATE (feature-sourced; reference-thin)** | Full SCM feature descriptions sourced from BankServAfrica ERP Proposal. DFA is the only confirmed Fusion SCM delivery client — but not available for reference. Cape Union Mart error corrected. Use SCM section in tenders with caution when a referenceable SCM client is required. |
| Projects / PPM Coverage | **GOOD** | Project Financials, Contract Billing, and Project Management sourced from BankServAfrica ERP Proposal. Nala Renewables confirmed as referenceable Projects client — 8-country footprint, APPSolve implemented 4 countries (SA, Lithuania, Romania, Finland), April 2025 go-live. DFA also confirmed Projects client but not available for reference. |
| OIC Coverage | **STRONG** | RedPath Mining authoritative claim. PayInc confirms adaptor capability. Hollywood Bets and all Fusion clients confirm OIC deployment. |
| Security / Compliance Coverage | **MODERATE** | OCI security stack sourced from SAA. TDE from PayInc. No APPSolve-specific security case studies. |
| Analytics Coverage | **MODERATE** | OTBI and HCM Analytics covered with sourced feature content. No standalone BI project evidence cited. |
| Client Evidence Quality | **GOOD for HCM** / **ADEQUATE for ERP** | Hollywood Bets is the richest single-client source. RedPath Mining provides the broadest multi-client evidence base. DFA full scope is the most impressive single reference if confirmed. |
| Prohibited Wording Compliance | **FULL** | Gold Partner, 110 consultants, 100 consultants, 22 years, 19 years Hein — all excluded. Zero occurrences in this file. |
| Source Attribution | **FULL** | Every claim attributed to source document and line number where available. |

**Overall quality: GOOD for HCM; GOOD for Finance/Procurement; GOOD for Projects; MODERATE for SCM**

This file is strong enough to support Oracle HCM-focused, Oracle Finance/Procurement-focused, and Oracle Projects-focused tenders. Finance and Procurement have sourced feature descriptions plus confirmed referenceable delivery evidence (Investec flagship reference). Projects now has a confirmed referenceable client — Nala Renewables (8-country footprint, APPSolve implemented 4 countries, April 2025, confirmed by BU Lead 2026-06-11). For SCM-heavy tenders, feature descriptions are sourced but no referenceable SCM delivery client is available — restricted-use notice applied (FR-004 Option A).

*Updated: 2026-06-11 — Sections 4–7 and Section 12 strengthened using Mpact ERP Proposal (August 2025) and BankServAfrica ERP Proposal (August 2024). Two material errors corrected: Cape Union Mart SCM attribution and Nala country count.*

---

#### Review Record: Review_Required

**Status: REVIEW_REQUIRED — Promoted 2026-06-11**
**Reviewed by: Hein Blignaut**

**BU Lead decisions applied on 2026-06-11:**
1. Cape Union Mart = Financials + Procurement only (not SCM) — noted and confirmed.
2. Nala Renewables scope, referenceability, and geography confirmed: Oracle Fusion Financials and Projects; 8-country implemented footprint; APPSolve implemented 4 countries (SA, Lithuania, Romania, Finland); APPSolve supports the complete 8-country environment. Referenceable for both Financials and Projects.
3. A-003 (Hollywood Bets go-live) closed: Mpact ERP Proposal reference card (August 2025) accepted as confirmation of July 2025 go-live at 7,000 users.
4. FR-004 (SCM — no referenceable client) resolved via Option A: restricted-use notice applied at top of Section 6.
5. Pre-tender checks A-001, A-002, A-004 remain open — confirm with account managers and delivery team before first tender use.

**Section readiness:**
- HCM (Section 3): Ready for Approved — A-004 pre-tender check only
- Finance/ERP (Section 4): Ready for Approved — A-001, A-002 pre-tender checks only
- Procurement (Section 5): Ready for Approved — A-001 pre-tender check only
- SCM (Section 6): Restricted use only — FR-004 Option A applied; no referenceable SCM client
- Projects/PPM (Section 7): Ready for Approved — Nala confirmed referenceable; DFA internal-use-only
...
<!-- GOVERNANCE -->
<!-- GOV: HIST-018 billing (R825,170) MUST NEVER appear in external submissions. Section 13.2 (W3S1-009) NEVER external. -->
...
<!-- PLACEHOLDER: Scope of Work — Inclusions — EXTRACT with no source assets -->

> **Action Required:** Review extracted scope inclusions before submission

## 16. Scope of Work — Exclusions

<!-- PLACEHOLDER: Scope of Work — Exclusions — EXTRACT with no source assets -->

> **Action Required:** Review extracted scope exclusions before submission

## 17. Deliverables

<!-- PLACEHOLDER: Deliverables — EXTRACT with no source assets -->

> **Action Required:** Review deliverables list for completeness

## 18. Dependencies

<!-- PLACEHOLDER: Dependencies — EXTRACT with no source assets -->

> **Action Required:** Review client dependencies extracted from assumption packs

## 19. Implementation Methodology


<!-- GOVERNANCE -->
<!-- GOV: SI-001: EXCLUDED for Pattern 13 AMS; W2S1-005 for Oracle; W5-METH-001 for Acumatica/BeBanking -->
<!-- SI-RULE: SI-001 -->
...
> **Human Review Required:** Tailor phases to tender-specific timeline; AMS: EXCLUDED (use S-73 instead)

## 20. Project Plan / Timeline


<!-- GOVERNANCE -->
<!-- GOV: EXCLUDED for Pattern 13 AMS -->
<!-- SI-RULE: SI-001 -->

*Template section — complete placeholders before submission.*
...
> **Note:** Insert project dates and resource assignments; EXCLUDED for AMS

> **Human Review Required:** Insert project dates and resource assignments; EXCLUDED for AMS
...
<!-- AUDIT NOTE: EXTRACT method — full asset body included; sub-section extraction not yet automated -->

## 22. RAID Framework

<!-- PLACEHOLDER: RAID Framework — MERGE with no source assets -->

> **Action Required:** Risk register populated from Risk Library; review before submission

## 23. Change Control Framework


<!-- GOVERNANCE -->
<!-- GOV: SI-001: EXCLUDED for Pattern 13 AMS; S-73 is the single AMS change management section -->
<!-- SI-RULE: SI-001 -->

<!-- PLACEHOLDER: Change Control Framework — no governed source asset declared -->

> **Action Required:** Do not expose CR thresholds or rates; EXCLUDED for AMS — use S-73
...
<!-- PLACEHOLDER: Cutover / Go-Live Plan — EXTRACT with no source assets -->

> **Action Required:** EXCLUDED for AMS (no cutover in ongoing AMS)
...
> **Note:** BU Lead selects named consultants; EXCLUDED for AMS

> **Human Review Required:** BU Lead selects named consultants; EXCLUDED for AMS

## 26. Key Assumptions (Body Section)


<!-- GOVERNANCE -->
<!-- GOV: SI-006: S-49 Key Assumptions assembled BEFORE S-52 Pricing in all proposals -->
<!-- SI-RULE: SI-006 -->
...
> **Human Review Required:** Governance sign-off required; SI-006: must appear BEFORE S-52 Pricing

## 27. Risk Register

<!-- AI-DRAFT REQUIRED: Risk Register -->
<!-- Instruction: Mandatory human review; Risk Library standard defined (WP18B) -->

> **AI-Draft Required:** This section requires AI-assisted drafting with mandatory human review.
>
> *Mandatory human review; Risk Library standard defined (WP18B)*
...
<!-- GOVERNANCE -->
<!-- GOV: Never assemble a fixed-price proposal without the commercial file -->
...
> **Human Review Required:** Governance sign-off required; extracted from selected assumption packs

## 29. Commercials / Pricing


<!-- GOVERNANCE -->
<!-- GOV: SI-006: S-49 Key Assumptions BEFORE S-52 Pricing in all proposals -->
<!-- SI-RULE: SI-006 -->

<!-- PLACEHOLDER: Commercials / Pricing -->

> **Action Required:** Commercial Director authority; never expose rates; SI-006: S-49 must precede this
...
<!-- GOVERNANCE -->
<!-- GOV: Never submit a proposal with expired compliance documents -->

<!-- PLACEHOLDER: Compliance Schedule — EXTRACT with no source assets -->

> **Action Required:** Verify all expiry dates > submission date; expired items flagged

## 31. Company Registration

<!-- PLACEHOLDER: Company Registration — no governed source asset declared -->

> **Action Required:** Verify CIPC registration current

## 32. Tax Clearance

<!-- PLACEHOLDER: Tax Clearance — no governed source asset declared -->

> **Action Required:** Verify expiry date > submission date (current valid to 2027-02-23)

## 33. Directors' Resolution

<!-- PLACEHOLDER: Directors' Resolution — no governed source asset declared -->

> **Action Required:** Renewed 2026-06-15; confirm still valid at submission date

## 34. B-BBEE Certificate


<!-- GOVERNANCE -->
<!-- GOV: OAR-C01/C02/A01: B-BBEE cert expires 2026-07-31; never cite BEE status after that date without renewal -->

<!-- PLACEHOLDER: B-BBEE Certificate — no governed source asset declared -->

> **Action Required:** Expires 2026-07-31 — do not submit after that date without renewal cert

## 35. Public Liability Insurance

<!-- PLACEHOLDER: Public Liability Insurance — no governed source asset declared -->

> **Action Required:** Obtained 2026-06-15; confirm exact expiry from policy (OAR pending confirmation)

## 36. Oracle OPN Certificate


<!-- GOVERNANCE -->
<!-- GOV: Never cite 'Oracle Gold Partner' — expired August 2021 -->
...
> **Human Review Required:** Level 1 Partner only; annual OPN revalidation; never cite Gold Partner

## 37. Client References


<!-- GOVERNANCE -->
<!-- GOV: Never cite DFA, CCBA, SAA. Never cite Redpath Mining until Rule 21.5 waived. Never name Hollywood Bets without AM approval. Never name KPMG in PPM/ERP until AM-W4E3-001 cleared. -->
<!-- SI-RULE: SI-005 -->

*Template section — complete placeholders before submission.*

**Required fields:**
- `{{client_references_table}}`

> **Note:** AM approval mandatory at each tender; only signed letters; vintage >5 years flagged

> **Human Review Required:** AM approval mandatory at each tender; only signed letters; vintage >5 years flagged
...
> **Human Review Required:** Governance sign-off; all WP17D-1 validation checks must pass; counts match body sections
...
<!-- PLACEHOLDER: Certifications and Compliance — no governed source asset declared -->

> **Action Required:** All expiry dates must be > submission date

## Appendix E — B-BBEE Certificate


<!-- GOVERNANCE -->
<!-- GOV: B-BBEE cert expires 2026-07-31; never cite BEE status after that date without renewal cert -->

<!-- PLACEHOLDER: B-BBEE Certificate — no governed source asset declared -->

> **Action Required:** Expiry 2026-07-31; OAR-C01/C02/A01 BEE blocker


---

<!-- RENDER SUMMARY -->
<!-- Rendered: 2026-06-30T07:23:43.155972+00:00 | Renderer v1.0 -->
<!-- RENDERED=21 | PLACEHOLDER=18 | AI-DRAFT=3 | NOT_FOUND=0 | SKIPPED=0 -->
