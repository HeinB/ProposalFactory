...
> **SUPERSEDED — Promoted to Review_Required 2026-06-12. Authoritative version: `07_Approved_Content/Review_Required/Oracle/W3S1-001-ORA-HCMCore.md`. Do not use this file.**
...
APPSolve implements Oracle HCM Journeys to guide employees and managers through multi-step HR processes as structured, checklist-driven workflows. A Journey is a personalised, role-based digital guide that ensures every step of an HR process is completed, by the right person, in the right sequence.

**Journeys APPSolve implements:**
...
- Oracle HCM to SAP Payroll — "APPSolve has implemented an Integration between Oracle HCM and SAP Payroll many times" *(HIST-006)*
...
Additionally, APPSolve has delivered Oracle HCM implementations that include multi-country organisational models, multi-legal-entity configurations, and integration to diverse payroll systems — including SAP Payroll (multiple implementations), PaySpace, and Oracle Payroll Cloud.
...
|---|---|---|
| SAP Payroll | OIC-managed interface | "APPSolve has implemented an Integration between Oracle HCM and SAP Payroll many times" *(ORACLE_FACT_BASELINE)* |
...
| SAP Payroll integration — multiple implementations | ORACLE_FACT_BASELINE Section 14 (approved phrase) | HIST-006 | Approved claim |
...
| "80 Senior Consultants" (Afrocentric) | No | Suppressed — used "50+ Senior Consultants" from ORACLE_FACT_BASELINE |
...
| "110 senior consultants" | No | "50+ Senior Consultants" used |
...
| All approved ORACLE_FACT_BASELINE phrases used verbatim where applicable | ✅ SAP Payroll phrase used verbatim; Level 1 Partner phrase used verbatim |
...
### Status
**W3S1-001 Final Candidate v1.2 — Complete. All open items and BU corrections CLOSED 2026-06-12.**

### Deliverables Produced

| Deliverable | Status | Location |
|---|---|---|
| W3S1-001 Candidate Draft | ✅ Complete | This document — Sections 1–12 |
...
2. Register HIST-006, HIST-007, HIST-014, HIST-015, HIST-016, HIST-017 in DOCUMENT_REGISTER.csv
3. On approval: set `approved_for_reuse: Yes` and copy to KB destination `06_Capabilities/Oracle/Oracle_HCM/`
...
| Title | Oracle HCM Core — Global HR and Employee Lifecycle Capability Statement |
| Version | 1.2 Final Candidate |
| Status | Candidate — Final Review; all open items CLOSED; BU corrections C-W3-001 and C-W3-002 applied 2026-06-12 |
...
*W3S1-001-ORA-HCMCore v1.2 Final Candidate — 2026-06-12 — Claude (AI) — approved_for_reuse: No — All open items CLOSED; C-W3-001 and C-W3-002 applied — Ready for promotion to Review_Required*
