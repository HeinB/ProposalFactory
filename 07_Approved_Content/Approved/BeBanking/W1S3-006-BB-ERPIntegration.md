...
kb_destination: "06_Capabilities/BeBanking/Integrations/"
---
...
- Local payments (ZAR domestic EFT using bank-specific payment formats)
...
BeBanking integrates with SAP environments. Integration follows the same BeBanking middleware model — bank payment files are transmitted via the BeBanking H2H layer. Specific configuration and version details are available from the BeBanking BU lead.
